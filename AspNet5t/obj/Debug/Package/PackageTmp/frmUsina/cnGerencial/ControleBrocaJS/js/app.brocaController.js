...
(function () {
    ...
    angular.module('app4T')
        .controller("controleBrocasCtrl", ['$scope', '$document', 'ApiGetService', 'ApiGetServiceMOCK', controleBrocasCtrl])
    
    function controleBrocasCtrl($scope, $document, ApiGetService, ApiGetServiceMOCK) {
