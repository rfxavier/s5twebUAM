...
<asp:Content ID="HeaderContent" ContentPlaceHolderID="HeadContentPlaceHolderMain" runat="server">
    ...
    <%--<%: Scripts.Render("~/bundles/app4TindustriamoagemMOCK") %>--%>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <span data-ng-show="!visaoGeralButtonVisible" style="float: right; margin-top: 10px; font-weight: bold">Dia Referência:&nbsp;</span>
                    <span data-ng-show="visaoGeralButtonVisible" style="float: right; margin-top: 10px; font-weight: bold">Dia Referência:&nbsp;{{visaoGeralDiaDisplay}}&nbsp;&nbsp;</span>
