<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.master" CodeBehind="cnIndDesempIndAgricolas.aspx.vb" Inherits="AspNet5t.cnIndDesempIndAgricolas" %>
...
<asp:Content ID="HeaderContent" ContentPlaceHolderID="HeadContentPlaceHolderMain" runat="server">
    ...
    <script type="text/javascript">
        function OnSelectionChanged(s, e) {
            if (e.visibleIndex > -1) {
                grid.GetRowValues(e.visibleIndex, "FRENTETIPOAUX;DS_FRENTETIPO", onGetValues);
            };
        };
        function onGetValues(data) {
            if (data[0] != null && data[0] !== hf.Get("hfFrenteTipoAtual")) {
                hf.Set("hfFrenteTipoAtual", data[0]);
                hf.Set("hfFrenteTipoAtualDs", data[1]);
                hf.Set("hfDataRefAtual", cbDataRef.GetValue());
                gridequip.PerformCallback();
                //gridequip.ApplyFilter("[DS_FRENTETIPO] = '" + data + "'");
            };
        };
    </script>
</asp:Content>
        ...
        <PanelCollection>
            <dx:PanelContent runat="server">
                ...
                <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" ColCount="3">
                    <Items>
                        <dx:LayoutItem Caption="Grupo" CaptionStyle-Font-Bold="false" CaptionStyle-Font-Size="1.2em" Width="500px" HorizontalAlign="Left" ShowCaption="True">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    <asp:DropDownList ID="ASPxComboGrupo" runat="server" AutoPostBack="True"></asp:DropDownList>
                                    <%--<dx:ASPxComboBox runat="server" ID="ASPxComboGrupo" IncrementalFilteringMode="None" ClientVisible="true" Width="200px" Native="True" AutoPostBack="True" TextField="GRUPO" ValueField="GRUPO">
                                        <ClientSideEvents SelectedIndexChanged="function(s, e) { cbPanel.PerformCallback(); }"></ClientSideEvents>
                                    </dx:ASPxComboBox>--%>

                                    <dx:ASPxButton ID="btnPdfExport" runat="server" Text="Exportar PDF" UseSubmitBehavior="False" OnClick="btnPdfExport_Click" Visible="true">
                                    </dx:ASPxButton>
                        ...
                        <dx:LayoutItem Caption="Data Fechamento" CaptionStyle-Font-Bold="false" CaptionStyle-Font-Size="1.2em" Width="100px">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                        ...
                        <dx:LayoutItem Caption="Tempo Aproveit. Industrial" CaptionStyle-Font-Bold="false" CaptionStyle-Font-Size="1.2em" Width="100px" HorizontalAlign="Center">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
