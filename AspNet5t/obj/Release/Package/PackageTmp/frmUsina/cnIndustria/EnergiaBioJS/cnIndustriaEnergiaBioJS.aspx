<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.master" CodeBehind="cnIndustriaEnergiaBioJS.aspx.vb" Inherits="AspNet5t.cnIndustriaEnergiaBioJS" %>
<asp:Content ID="HeaderContent" ContentPlaceHolderID="HeadContentPlaceHolderMain" runat="server">
    <%: Styles.Render("~/Content/dxcss4Tcenindustriaenergiabio")%>

    <%: Styles.Render("~/Content/csspageindustriaenergiabio")%>
    ...
    <%: Scripts.Render("~/bundles/dx4Tcenindustriaenergiabio")%>
    
    <%: Scripts.Render("~/bundles/app4Tindustriaenergiabio") %>
</asp:Content>
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContentPlaceHolderMain" runat="server">
    <div ng-app="app4T" ng-controller="industriaenergiabioCtrl as ctrl" ng-cloak>
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <div class="row">
                    <h3 style="float: left; margin-top: 10px;" class="panel-title">Indústria - Exportação BIO</h3>
