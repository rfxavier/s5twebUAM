<%@ Page Title="" Language="vb" AutoEventWireup="false" CodeBehind="cnIndDesempIndAgricolasPrintPDF.aspx.vb" Inherits="AspNet5t.cnIndDesempIndAgricolasPrintPDF" %>
<!DOCTYPE html>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form id="form1" runat="server">
                ...
                <PanelCollection>
                    <dx:PanelContent runat="server">
                        ...
                        <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" ColCount="4">
                            <Items>
                                <dx:LayoutItem Width="100px" HorizontalAlign="Left" ShowCaption="False">
                                ...
                                <dx:LayoutItem Caption="Grupo" Width="500px" HorizontalAlign="Left" ShowCaption="True">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <asp:Label runat="server" ID="txtGrupo" Width="200px" class="parametros"></asp:Label>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                ...
                                <dx:LayoutItem Caption="Data Fechamento" Width="100px">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <asp:Label runat="server" ID="txtDataFechamento" Width="100px" class="parametros"></asp:Label>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
                                    ...
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <div style="width: 100px; text-align: center;">
                                                <asp:Label runat="server" ID="txtTempoAprov" class="parametros"></asp:Label>
                                            </div>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
                        ...
                        <div id="IndicadoresPorEquip" runat="server" style="padding-left: 8px; width:920px; page-break-before:always;">
                            <table class="dxflGroup dxflGroupSys dxflAGSys" cellspacing="0" cellpadding="0" style="border-collapse: collapse; border-collapse: separate;">
                                <tbody>
                                    <tr>
                                        <td id="ASPxCbPanel_ASPxFormLayout1_0" class="dxflHALSys dxflGroupCell">
                                            <div class="dxflCLTSys dxflItemSys dxflTextItemSys dxflItem" style="width: 100px;">
                                                <img src="<%= ResolveUrl("~/Content/Images/LogoUAMpequeno.png")%>" />
                                            </div>
                                        </td>
                                        <td id="ASPxCbPanel_ASPxFormLayout1_1" class="dxflHALSys dxflGroupCell">
                                            <table class="dxflCLTSys dxflItemSys dxflCustomItemSys dxflItem" cellspacing="0" cellpadding="0" style="width: 500px; border-collapse: collapse; border-collapse: separate;">
                                                <tbody>
                                                    <tr>
                                                        <td class="dxflHALSys dxflVATSys dxflCaptionCell dxflCaptionCellSys" style="width: 1px;"><span class="dxflCaption">Grupo:</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="dxflNestedControlCell"><asp:Label runat="server" ID="txtGrupoEquip" Width="200px" class="parametros"></asp:Label></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </td>
                                        <td id="ASPxCbPanel_ASPxFormLayout1_2" class="dxflGroupCell">
                                            <table class="dxflCLTSys dxflItemSys dxflCustomItemSys dxflItem" cellspacing="0" cellpadding="0" style="width: 100px; border-collapse: collapse; border-collapse: separate;">
                                                <tbody>
                                                    <tr>
                                                        <td class="dxflHACSys dxflVATSys dxflCaptionCell dxflCaptionCellSys"><span class="dxflCaption">Data Fechamento:</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="dxflNestedControlCell"><asp:Label runat="server" ID="txtDataFechamentoEquip" Width="100px" class="parametros"></asp:Label></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </td>
                                        <td id="ASPxCbPanel_ASPxFormLayout1_3" class="dxflHACSys dxflGroupCell">
                                            <table class="dxflCLTSys dxflItemSys dxflCustomItemSys dxflItem" cellspacing="0" cellpadding="0" style="width: 100px; border-collapse: collapse; border-collapse: separate;">
                                                <tbody>
                                                    <tr>
                                                        <td class="dxflHACSys dxflVATSys dxflCaptionCell dxflCaptionCellSys" style="width: 1px;"><span class="dxflCaption">Tempo Aproveit. Industrial:</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="dxflNestedControlCell">
                                                            <div style="width: 100px; text-align: center;"><asp:Label runat="server" ID="txtTempoAprovEquip" class="parametros"></asp:Label></div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
         ...
         <script src="<%= Page.ResolveUrl("~/frmUsinaPub/cnIndDesemp/IndAgricolas/indagricolasprintpdf.js")%>"></script>
