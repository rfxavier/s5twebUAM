...
Public Class cnOficinaResumoDualGeralFrentePub
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If (Session("OfResDashboardID") <> Nothing) Then
            If Session("OfResDashboardID") = 1 Then
                ...
                Dim dash As New Win_Dashboards.dashCnOficinaResumoGeralPub
                ASPxDashboardViewer1.DashboardSource = dash
                ASPxDashboardViewer1.DataBind()
            Else
                ASPxButton2.Checked = True

                Dim dash As New Win_Dashboards.dashCnOficinaDetalhamentoTratoresColhedoras
                ASPxDashboardViewer1.DashboardSource = dash
                ASPxDashboardViewer1.DataBind()
            End If
        Else
