<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.master" CodeBehind="cnEntCanaEntradasCana.aspx.vb" Inherits="AspNet5t.cnEntCanaEntradasCana" %>
...
<asp:Content ID="HeaderContent" ContentPlaceHolderID="HeadContentPlaceHolderMain" runat="server">
    <script>
        ...
        function OnLoaded() {
            cbAutoRef.SetVisible(true);
            cbAutoRef.ValueChanged.AddHandler(OnValueChanged);
        }
        function OnValueChanged(s, e) {
            var checked = cbAutoRef.GetChecked();
            timerAutoRef.SetEnabled(checked);
        }
    </script>
</asp:Content>
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContentPlaceHolderMain" runat="server">
    ...
    <div class="botao-popcapivara-dash">
        <dx:ASPxCheckBox ID="ASPxCheckBoxAutoRefresh" runat="server" Text="Atualizar Automaticamente" ClientVisible="false" ClientInstanceName="cbAutoRef" CheckState="Unchecked" Theme="Office2003Silver">
            <%--<ClientSideEvents ValueChanged="OnValueChanged" />--%>
        </dx:ASPxCheckBox>
    </div>
    <div>
        <dx:ASPxDashboardViewer ID="ASPxDashboardViewer1" runat="server" DashboardSource="AspNet5t.Win_Dashboards.dashCnEntCanaEntradasCana" Width="98%" Height="370px" UseDataAccessApi="True" ClientInstanceName="dv">
    ...
    <dx:ASPxTimer ID="ASPxTimer1" runat="server" Interval="60000" Enabled="false" ClientInstanceName="timerAutoRef">
