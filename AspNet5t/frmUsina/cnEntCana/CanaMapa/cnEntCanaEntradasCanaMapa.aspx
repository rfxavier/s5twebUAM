<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.master" CodeBehind="cnEntCanaEntradasCanaMapa.aspx.vb" Inherits="AspNet5t.cnEntCanaEntradasCanaMapa" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContentPlaceHolderMain" runat="server">
    ...
    <div>
        <dx:ASPxDashboardViewer ID="ASPxDashboardViewer1" runat="server" DashboardSource="~/dashXmls/dashCnEntCanaEntradasCanaMapa.xml" Width="98%" Height="370px" UseDataAccessApi="True" ClientInstanceName="dv">
