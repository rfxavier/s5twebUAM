<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.master" CodeBehind="cnIndustriaEtanolJS.aspx.vb" Inherits="AspNet5t.cnIndustriaEtanolJS" %>
<asp:Content ID="HeaderContent" ContentPlaceHolderID="HeadContentPlaceHolderMain" runat="server">
    <%: Styles.Render("~/Content/dxcss4Tcenindustriaetanol")%>

    <%: Styles.Render("~/Content/csspageindustriaetanol")%>
    ...
    <%: Scripts.Render("~/bundles/dx4Tcenindustriaetanol")%>
    
    <%: Scripts.Render("~/bundles/app4Tindustriaetanol") %>
</asp:Content>
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContentPlaceHolderMain" runat="server">
    <div ng-app="app4T" ng-controller="industriaetanolCtrl as ctrl" ng-cloak>
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <div class="row">
                    <h3 style="float: left; margin-top: 10px;" class="panel-title">Indústria - Produção de Etanol</h3>
            ...
            <div class="panel-body">
                ...
                <div data-ng-show="filtroPeriodoDia()">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4 text-center">
                            <div data-dx-button="buttonDiaTipoGeralOptions"></div>
                            <div data-dx-button="buttonDiaTipoAOptions"></div>
                            <div data-dx-button="buttonDiaTipoBOptions"></div>
                        </div>
                    </div>
                ...
                <div data-ng-show="filtroPeriodoSemana()">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 text-center">
                            <div data-dx-button="buttonSemanaTipoGeralOptions"></div>
                            <div data-dx-button="buttonSemanaTipoAOptions"></div>
                            <div data-dx-button="buttonSemanaTipoBOptions"></div>
                        </div>
                    </div>
                ...
                <div data-ng-show="filtroPeriodoMes()">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 text-center">
                            <div data-dx-button="buttonMesTipoGeralOptions"></div>
                            <div data-dx-button="buttonMesTipoAOptions"></div>
                            <div data-dx-button="buttonMesTipoBOptions"></div>
                        </div>
                    </div>
                ...
                <div data-ng-show="filtroPeriodoSafra()">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 text-center">
                            <div data-dx-button="buttonSafraTipoGeralOptions"></div>
                            <div data-dx-button="buttonSafraTipoAOptions"></div>
                            <div data-dx-button="buttonSafraTipoBOptions"></div>
                        </div>
                    </div>
