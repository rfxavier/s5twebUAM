...
(function() {
    ...
    angular.module('app4T')
        .controller("industriaenergiabioCtrl", ['$scope', '$document', 'ApiGetService', industriaenergiabioCtrl]);

    function industriaenergiabioCtrl($scope, $document, ApiGetService) {
        ...
        function refreshAll(semLatest) {
            ...
            ApiGetService
                ...
                .then(function (data) {
                    ...
                    if ($scope.visaoGeral()) {
                        ApiGetService
                            .getindustriaEnergiaBioVisaoGeralCorteDiaPromise(1, $scope.visaoGeralSafra, new Date($scope.visaoGeralDiaDate).yyyymmdd())
                            .then(function(data) {
                                //Dia
        ...
        var resolvetitleChartDia = function () {
            var titleBase = "Controle de Exportação BIO Diário";
        ...
        var resolvetitleChartSemana = function () {
            var titleBase = "Controle de Exportação BIO Semanal";
        ...
        var resolvetitleChartMes = function () {
            var titleBase = "Controle de Exportação BIO Mensal";
        ...
        var resolvetitleChartSafra = function () {
            var titleBase = "Controle de Exportação BIO Safra";
        ...
        $scope.autoRefreshButtonType = !window.localStorage.getItem("bi4tInd02ar") || window.localStorage.getItem("bi4tInd02ar") == 0 ? 'success' : 'normal';
        ...
        angular.element(document).ready(function() {
            ...
            if (!window.localStorage.getItem("bi4tInd02ar")) {
                window.localStorage.setItem("bi4tInd02ar", 0);
                window.localStorage.setItem("bi4tInd02arsec", 60);
            };

            $scope.autoRefresh = (window.localStorage.getItem("bi4tInd02ar") == 0);
            $scope.autoRefreshSeconds = window.localStorage.getItem("bi4tInd02arsec");
        ...
        $scope.buttonOkAutoRefreshOptions = {
            ...
            onClick: function () {
                ...
                window.localStorage.setItem("bi4tInd02ar", $scope.autoRefresh ? 0 : 1);
                window.localStorage.setItem("bi4tInd02arsec", $scope.autoRefreshSeconds);
        ...
        function diaClick() {
            ...
            ApiGetService
                .getindustriaEnergiaBioPorDiaPromise(1, $scope.visaoGeralSafra, $scope.visaoGeralDia)
                .then(function (data) {
                    ...
                    $scope.mediaHoraAnterior = parseFloat($scope.dadosGeral.MediaHoraAnterior).toLocaleString() + " MWh";
        ...
        function semanaClick() {
            ...
            ApiGetService
                .getindustriaEnergiaBioPorSemanaPromise(1, $scope.visaoGeralSafra, $scope.visaoGeralSemana)
                .then(function (data) {
        ...
        function mesClick() {
            ...
            ApiGetService
                .getindustriaEnergiaBioPorMesPromise(1, $scope.visaoGeralSafra, $scope.visaoGeralMes)
                .then(function (data) {
        ...
        function safraClick() {
            ...
            ApiGetService
                .getindustriaEnergiaBioPorSafraCorteDiaPromise(1, $scope.visaoGeralSafra, $scope.visaoGeralDia)
                .then(function (data) {
                    for (var i = 0; i < data.oGrid.length; i++) {
                        $.extend(data.oGrid[i],
                            {
