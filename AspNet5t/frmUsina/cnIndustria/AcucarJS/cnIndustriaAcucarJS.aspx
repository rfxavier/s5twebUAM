<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.master" CodeBehind="cnIndustriaAcucarJS.aspx.vb" Inherits="AspNet5t.cnIndustriaAcucarJS" %>
<asp:Content ID="HeaderContent" ContentPlaceHolderID="HeadContentPlaceHolderMain" runat="server">
    <%: Styles.Render("~/Content/dxcss4Tcenindustriaacucar")%>

    <%: Styles.Render("~/Content/csspageindustriaacucar")%>
    ...
    <%: Scripts.Render("~/bundles/dx4Tcenindustriaacucar")%>
    
    <%: Scripts.Render("~/bundles/app4Tindustriaacucar") %>
</asp:Content>
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContentPlaceHolderMain" runat="server">
    <div ng-app="app4T" ng-controller="industriaacucarCtrl as ctrl" ng-cloak>
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <div class="row">
                    <h3 style="float: left; margin-top: 10px;" class="panel-title">Indústria - Produção de Açúcar</h3>
