...
(function() {
    ...
    angular.module('app4T')
        .controller("industriaacucarCtrl", ['$scope', '$document', 'ApiGetService', industriaacucarCtrl]);

    function industriaacucarCtrl($scope, $document, ApiGetService) {
        ...
        function refreshAll(semLatest) {
            ...
            ApiGetService
                ...
                .then(function (data) {
                    ...
                    if ($scope.visaoGeral()) {
                        ApiGetService
                            .getindustriaAcucarVisaoGeralCorteDiaPromise(1, $scope.visaoGeralSafra, new Date($scope.visaoGeralDiaDate).yyyymmdd())
                            .then(function(data) {
                                //Dia
        ...
        var resolvetitleChartDia = function () {
            var titleBase = "Controle de Produção Acúcar";
        ...
        var resolvetitleChartSemana = function () {
            var titleBase = "Controle de Produção Açúcar Semanal";
        ...
        var resolvetitleChartMes = function () {
            var titleBase = "Controle de Produção Açúcar Mensal";
        ...
        var resolvetitleChartSafra = function () {
            var titleBase = "Controle de Produção Açúcar Safra";
        ...
        $scope.autoRefreshButtonType = !window.localStorage.getItem("bi4tInd04ar") || window.localStorage.getItem("bi4tInd04ar") == 0 ? 'success' : 'normal';
        ...
        angular.element(document).ready(function() {
            ...
            if (!window.localStorage.getItem("bi4tInd04ar")) {
                window.localStorage.setItem("bi4tInd04ar", 0);
                window.localStorage.setItem("bi4tInd04arsec", 60);
            };

            $scope.autoRefresh = (window.localStorage.getItem("bi4tInd04ar") == 0);
            $scope.autoRefreshSeconds = window.localStorage.getItem("bi4tInd04arsec");
        ...
        $scope.buttonOkAutoRefreshOptions = {
            ...
            onClick: function () {
                ...
                window.localStorage.setItem("bi4tInd04ar", $scope.autoRefresh ? 0 : 1);
                window.localStorage.setItem("bi4tInd04arsec", $scope.autoRefreshSeconds);
        ...
        function diaClick() {
            ...
            ApiGetService
                .getindustriaAcucarPorDiaPromise(1, $scope.visaoGeralSafra, $scope.visaoGeralDia)
                .then(function (data) {
                    ...
                    $scope.mediaHoraAnterior = parseFloat($scope.dadosGeral.MediaHoraAnterior).toLocaleString() + " scs";
        ...
        function semanaClick() {
            ...
            ApiGetService
                .getindustriaAcucarPorSemanaPromise(1, $scope.visaoGeralSafra, $scope.visaoGeralSemana)
                .then(function (data) {
        ...
        function mesClick() {
            ...
            ApiGetService
                .getindustriaAcucarPorMesPromise(1, $scope.visaoGeralSafra, $scope.visaoGeralMes)
                .then(function (data) {
        ...
        function safraClick() {
            ...
            ApiGetService
                .getindustriaAcucarPorSafraCorteDiaPromise(1, $scope.visaoGeralSafra, $scope.visaoGeralDia)
                .then(function (data) {
                    for (var i = 0; i < data.oGrid.length; i++) {
                        $.extend(data.oGrid[i],
                            {
