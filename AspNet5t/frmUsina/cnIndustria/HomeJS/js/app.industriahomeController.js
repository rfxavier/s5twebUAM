                ...
                .then(function (data) {
                    ...
                    ApiGetService
                        ...
                        .then(function (data) {
                            ...
                            $scope.homeEficienciaCiValueDisplay = parseFloat(data.ConsumoInternoPorTonCana).toLocaleString() + " MWh/Ton";
        ...
        $scope.dateBoxOptions = {
            ...
            onValueChanged: function (e) {
                if (!$scope.loadingVisible) {
                    $scope.homeVisaoGeralDiaDate = $scope.moagemVisaoGeralDiaDate > $scope.homeVisaoGeralDiaMaxDate ? $scope.homeVisaoGeralDiaMaxDate : $scope.moagemVisaoGeralDiaDate;
