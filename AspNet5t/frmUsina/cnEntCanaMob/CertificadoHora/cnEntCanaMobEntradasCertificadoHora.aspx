    ...
    <dx:ASPxCallbackPanel ID="ASPxCallbackPanel2" runat="server" Width="100%" ClientInstanceName="cbPanelTop">
        ...
        <PanelCollection>
            <dx:PanelContent runat="server">
                ...
                <div id="divCertHoraMedia" style="float: left; text-align: center; margin-left: 10px; margin-top: 8px;">
                    <dx:ASPxLabel ID="ASPxLabelCertificadosHoraMedia" runat="server" Text=" " ClientVisible="true" ClientInstanceName="lbCertHoraMedia" EncodeHtml="False" Style="font-size: 18px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;" Width="260px">
                    </dx:ASPxLabel>
                </div>
            </dx:PanelContent>
        </PanelCollection>
