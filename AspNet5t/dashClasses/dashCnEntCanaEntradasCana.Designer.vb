Namespace Win_Dashboards
    Partial Public Class dashCnEntCanaEntradasCana
        ''' <summary> 
...
#Region "Component Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(dashCnEntCanaEntradasCana))
            ...
            Dimension1.Name = "Mês / Ano"
            GridDimensionColumn1.Name = "Mês / Ano"
            ...
            Me.gridDashboardItem1.Name = "Período"
            Me.gridDashboardItem1.ShowCaption = True
            '
            'pieDashboardItem1
            '
            Dimension2.DataMember = "FC"
            Dimension2.Name = "Frente de Colheita"
            ...
            Me.pieDashboardItem1.Name = "Frentes de Colheita"
            ...
            GridDimensionColumn2.Weight = 93.348668640202064R
            ...
            Dimension4.DataMember = "propDESCCODcalc"
            Dimension4.Name = "Propriedade"
            Dimension4.SortByMeasure = Measure3
            Dimension4.SortOrder = DevExpress.DashboardCommon.DimensionSortOrder.Descending
            GridDimensionColumn3.Weight = 73.65623388043916R
            ...
            GridMeasureColumn2.Weight = 53.963799120676256R
            ...
            Me.gridDashboardItem2.Columns.AddRange(New DevExpress.DashboardCommon.GridColumnBase() {GridDimensionColumn2, GridDimensionColumn3, GridMeasureColumn2})
            Me.gridDashboardItem2.ComponentName = "gridDashboardItem2"
            Dimension5.DataMember = "DT_MOAGEM"
            ...
            Me.gridDashboardItem2.DataItemRepository.Add(Dimension4, "DataItem2")
            Me.gridDashboardItem2.DataItemRepository.Add(Measure3, "DataItem1")
            Me.gridDashboardItem2.DataItemRepository.Add(Dimension3, "DataItem3")
            Me.gridDashboardItem2.DataItemRepository.Add(Dimension5, "DataItem5")
            Me.gridDashboardItem2.DataMember = "dsUAMOraXE"
            ...
            Me.gridDashboardItem2.Name = "Municípios e Propriedades"
            Me.gridDashboardItem2.ShowCaption = True
            Me.gridDashboardItem2.SparklineArgument = Dimension5
            '
            ...
            Me.rangeFilterDashboardItem1.DataItemRepository.Add(Measure4, "DataItem0")
            Me.rangeFilterDashboardItem1.DataItemRepository.Add(Dimension6, "DataItem1")
            ...
            Me.rangeFilterDashboardItem1.Name = "Filtro de Faixa 1"
            ...
            Measure5.Name = "Total Toneladas"
            Measure5.NumericFormat.FormatType = DevExpress.DashboardCommon.DataItemNumericFormatType.Number
            Card1.SparklineOptions.ViewType = DevExpress.DashboardCommon.SparklineViewType.Bar
            ...
            Me.cardDashboardItem1.DataItemRepository.Add(Dimension7, "DataItem2")
            ...
            Me.cardDashboardItem1.SparklineArgument = Dimension7
            '
            'dataSource1
            '
            CalculatedField1.DataMember = "dsUAMOraXE"
            CalculatedField1.DataType = DevExpress.DashboardCommon.CalculatedFieldType.[Object]
            CalculatedField1.Expression = "Concat('FC ',PadLeft([FRENTE_COLHEITA], 2, '0'))"
            CalculatedField1.Name = "FC"
            CalculatedField2.DataMember = "dsUAMOraXE"
            CalculatedField2.Expression = "Concat([DS_NOME_PROPRIEDADE], ' ( ', ToStr([PROP_CODIGO]), ' )')"
            CalculatedField2.Name = "propDESCCODcalc"
            ...
            Me.Items.AddRange(New DevExpress.DashboardCommon.DashboardItem() {Me.gridDashboardItem1, Me.pieDashboardItem1, Me.gridDashboardItem2, Me.rangeFilterDashboardItem1, Me.cardDashboardItem1})
            DashboardLayoutItem1.DashboardItem = Me.gridDashboardItem1
            DashboardLayoutItem1.Weight = 27.058823529411764R
            DashboardLayoutItem2.DashboardItem = Me.pieDashboardItem1
            DashboardLayoutItem2.Weight = 43.529411764705884R
            DashboardLayoutItem3.DashboardItem = Me.cardDashboardItem1
            DashboardLayoutItem3.Weight = 29.411764705882351R
            ...
            DashboardLayoutGroup2.Weight = 44.4007858546169R
            DashboardLayoutItem4.DashboardItem = Me.gridDashboardItem2
            DashboardLayoutItem4.Weight = 64.664310954063609R
            DashboardLayoutItem5.DashboardItem = Me.rangeFilterDashboardItem1
            DashboardLayoutItem5.Weight = 35.3356890459364R
            ...
            DashboardLayoutGroup3.Weight = 55.5992141453831R
