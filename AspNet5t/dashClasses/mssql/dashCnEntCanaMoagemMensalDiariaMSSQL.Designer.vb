Namespace Win_Dashboards
    Partial Public Class dashCnEntCanaMoagemMensalDiariaMSSQL
        ''' <summary> 
...
#Region "Component Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(dashCnEntCanaMoagemMensalDiariaMSSQL))
            ...
            Me.chartDashboardItem1.AxisX.Title = "Dias"
            ...
            ColorSchemeEntry1.MeasureKey = New DevExpress.DashboardCommon.ColorSchemeMeasureKey(New DevExpress.DashboardCommon.MeasureDefinition() {New DevExpress.DashboardCommon.MeasureDefinition("TONELADA_REAL")})
            ColorSchemeEntry2.ColorDefinition = New DevExpress.DashboardCommon.ColorDefinition(1)
            ColorSchemeEntry2.MeasureKey = New DevExpress.DashboardCommon.ColorSchemeMeasureKey(New DevExpress.DashboardCommon.MeasureDefinition() {New DevExpress.DashboardCommon.MeasureDefinition("TONELADA_PLAN", DevExpress.DashboardCommon.SummaryType.Average)})
            ...
            Measure1.DataMember = "TONELADA_REAL"
            Measure1.Name = "Realizado"
            ...
            Measure2.DataMember = "TONELADA_PLAN"
            Measure2.Name = "Planejado"
            ...
            Me.chartDashboardItem1.Legend.OutsidePosition = DevExpress.DashboardCommon.ChartLegendOutsidePosition.TopLeftHorizontal
            Me.chartDashboardItem1.Name = "Diário"
            ...
            SimpleSeries1.PointLabelOptions.OverlappingMode = DevExpress.DashboardCommon.PointLabelOverlappingMode.None
            ...
            CustomSqlQuery1.Sql = "SELECT  ID_NEGOCIOS" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "     , NRO_ANO_SAFRA" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "     , MES" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "     , DIA" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "     , TONELAD" & _
        "A_PLAN" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "     , TONELADA_REAL" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "FROM" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "  dbo.RES_MENSAL_DIARIA"
            ...
            '
            'dashCnEntCanaMoagemMensalDiariaMSSQL
            '
            ColorSchemeEntry3.ColorDefinition = New DevExpress.DashboardCommon.ColorDefinition(12)
            ColorSchemeEntry3.DataMember = "dsBI4T"
            ColorSchemeEntry3.DataSource = Me.dataSource1
            ColorSchemeEntry3.MeasureKey = New DevExpress.DashboardCommon.ColorSchemeMeasureKey(New DevExpress.DashboardCommon.MeasureDefinition() {New DevExpress.DashboardCommon.MeasureDefinition("TONELADA_REAL")})
            ColorSchemeEntry4.ColorDefinition = New DevExpress.DashboardCommon.ColorDefinition(1)
            ColorSchemeEntry4.DataMember = "dsBI4T"
            ColorSchemeEntry4.DataSource = Me.dataSource1
            ColorSchemeEntry4.MeasureKey = New DevExpress.DashboardCommon.ColorSchemeMeasureKey(New DevExpress.DashboardCommon.MeasureDefinition() {New DevExpress.DashboardCommon.MeasureDefinition("TONELADA_PLAN", DevExpress.DashboardCommon.SummaryType.Average)})
