Namespace Win_Dashboards
    Partial Public Class dashCnEntCanaEntradasCanaTonPorViagemPorFrente
        ''' <summary> 
...
#Region "Component Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(dashCnEntCanaEntradasCanaTonPorViagemPorFrente))
            ...
            DashboardParameter1.Value = New Date(Today.Year, 1, 1, 0, 0, 0, 0)
            DashboardParameter2.Description = "Data Final"
            DashboardParameter2.Name = "parDataFim"
            DashboardParameter2.Type = GetType(Date)
            DashboardParameter2.Value = New Date(Today.Year, 12, 31, 0, 0, 0, 0)
