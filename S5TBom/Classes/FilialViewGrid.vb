...
Namespace S5T
    ...
    Partial Public Class FilialViewGrid
        ...
        Private _pCodEmpresa As Integer = CodeFluentPersistence.DefaultInt32Value
        
        Private _pNomEmpresa As String = CType(Nothing, String)
        
        Private _pCNPJ As String = CType(Nothing, String)
        ...
        <System.ComponentModel.DefaultValueAttribute(CodeFluentPersistence.DefaultInt32Value),  _
         System.Xml.Serialization.XmlElementAttribute(IsNullable:=false, Type:=GetType(Integer))>  _
        Public Property pCodEmpresa() As Integer
            Get
                Return Me._pCodEmpresa
            End Get
            Set
                Me._pCodEmpresa = value
            End Set
        End Property
        
        <System.ComponentModel.DefaultValueAttribute(CType(Nothing, String)),  _
         System.Xml.Serialization.XmlElementAttribute(IsNullable:=true, Type:=GetType(String))>  _
        Public Property pNomEmpresa() As String
            Get
                Return Me._pNomEmpresa
            End Get
            Set
                Me._pNomEmpresa = value
            End Set
        End Property
        ...
        Protected Overridable Sub ReadRecord(ByVal reader As System.Data.IDataReader, ByVal options As CodeFluent.Runtime.CodeFluentReloadOptions)
            ...
            If (((options And CodeFluent.Runtime.CodeFluentReloadOptions.Properties)  _
                ...
                Me._pCodEmpresa = CodeFluentPersistence.GetReaderValue(reader, "pCodEmpresa", CType(CodeFluentPersistence.DefaultInt32Value,Integer))
                Me._pNomEmpresa = CodeFluentPersistence.GetReaderValue(reader, "pNomEmpresa", CType(CType(Nothing, String),String))
                Me._pCNPJ = CodeFluentPersistence.GetReaderValue(reader, "pCNPJ", CType(CType(Nothing, String),String))
            End If
        End Sub
