...
Namespace S5T
    ...
    Partial Public Class Pais
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.Pais), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Integer), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.Pais)
        ...
        Private _oUFs As S5T.UFCollection
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Public ReadOnly Property oUFs() As S5T.UFCollection
            Get
                If (Me._oUFs Is Nothing) Then
                    If ((Me.pId = -1)  _
                                OrElse (Me.EntityState.Equals(CodeFluent.Runtime.CodeFluentEntityState.Created) = true)) Then
                        Me._oUFs = New S5T.UFCollection(Me)
                        Return Me._oUFs
                    End If
                    Me._oUFs = S5T.UFCollection.LoadByoPais(Me)
                End If
                Return Me._oUFs
            End Get
        End Property
        ...
        Public Overloads Overridable Function Equals(ByVal pais As S5T.Pais) As Boolean Implements System.IEquatable(Of S5T.Pais).Equals
            If (pais Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(pais)
            End If
            Return (Me.pId.Equals(pais.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                pais = CType(obj,S5T.Pais)
            Catch icex As System.InvalidCastException
                pais = Nothing
            End Try
            Return Me.Equals(pais)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(pais)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal pais As S5T.Pais) As Integer Implements System.IComparable(Of S5T.Pais).CompareTo
            If (pais Is Nothing) Then
                Throw New System.ArgumentNullException("pais")
            End If
            Dim localCompareTo As Integer = Me.pCodigo.CompareTo(pais.pCodigo)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.Pais.ExternalValidate", "Type 'S5T.Pais' cannot be validated.", Nothing)
                End If
            ...
            If (Me.pCodigo = CodeFluentPersistence.DefaultInt32Value) Then
                Dim localValidate As String = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.Pais.pCodigo.NullException", "'pCodigo' property cannot be set to '0' for type 'S5T.Pais'", Nothing)
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "pais", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.Pais
            If (pId = -1) Then
                Return Nothing
            End If
            Dim pais As S5T.Pais = New S5T.Pais()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "pais", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    pais.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypCodigo(ByVal pCodigo As Integer) As S5T.Pais
            If (pCodigo = CodeFluentPersistence.DefaultInt32Value) Then
                Return Nothing
            End If
            Dim pais As S5T.Pais = New S5T.Pais()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "pais", "LoadBypCodigo")
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Shared Function LoadMaxCodigo() As S5T.Pais
            Dim pais As S5T.Pais = New S5T.Pais()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "pais", "LoadMaxCodigo")
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "pais", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal pais As S5T.Pais) As Boolean
            If (pais Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal pais As S5T.Pais) As Boolean
            Dim ret As Boolean = S5T.Pais.Save(pais)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal pais As S5T.Pais) As Boolean
            If (pais Is Nothing) Then
                Return false
            End If
        ...
        Protected Overridable Sub BaseTrace(ByVal writer As System.CodeDom.Compiler.IndentedTextWriter)
            ...
            writer.Write(",")
            writer.Write("oUFs=")
            If (Not (Me._oUFs) Is Nothing) Then
                CType(Me._oUFs,CodeFluent.Runtime.ICodeFluentObject).Trace(writer)
            Else
                writer.Write("<null>")
            End If
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.Pais
            Dim pais As S5T.Pais = New S5T.Pais()
            Me.CopyTo(pais, deep)
            Return pais
        End Function
        
        Public Overloads Function Clone() As S5T.Pais
            Dim localClone As S5T.Pais = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal pais As S5T.Pais, ByVal deep As Boolean)
            If (pais Is Nothing) Then
                Throw New System.ArgumentNullException("pais")
            End If
            pais.pId = Me.pId
            pais.pCodigo = Me.pCodigo
            pais.xDataHoraReg = Me.xDataHoraReg
            pais.xLoginReg = Me.xLoginReg
            pais.pCodigoIbge = Me.pCodigoIbge
            pais.pNome = Me.pNome
            pais.pSigla = Me.pSigla
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, pais))
        End Sub
