...
Namespace S5T
    ...
    Partial Public Class IdUserClaim
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.IdUserClaim), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.IdUserClaim)
        ...
        Private _issuer As String = CType(Nothing, String)
        
        Private _originalIssuer As String = CType(Nothing, String)
        ...
        Public Property Issuer() As String
            ...
            Set
                Me._issuer = value
                Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Modified
                Me.OnPropertyChanged(New System.ComponentModel.PropertyChangedEventArgs("Issuer"))
            End Set
        End Property
        ...
        Public Property OriginalIssuer() As String
            Get
                Return Me._originalIssuer
            End Get
            Set
                Me._originalIssuer = value
                Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Modified
                Me.OnPropertyChanged(New System.ComponentModel.PropertyChangedEventArgs("OriginalIssuer"))
            End Set
        End Property
        ...
        Public Overloads Overridable Function Equals(ByVal idUserClaim As S5T.IdUserClaim) As Boolean Implements System.IEquatable(Of S5T.IdUserClaim).Equals
            If (idUserClaim Is Nothing) Then
                Return false
            End If
            If (Me.Id = -1) Then
                Return MyBase.Equals(idUserClaim)
            End If
            Return (Me.Id.Equals(idUserClaim.Id) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                idUserClaim = CType(obj,S5T.IdUserClaim)
            Catch icex As System.InvalidCastException
                idUserClaim = Nothing
            End Try
            Return Me.Equals(idUserClaim)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(idUserClaim)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal idUserClaim As S5T.IdUserClaim) As Integer Implements System.IComparable(Of S5T.IdUserClaim).CompareTo
            If (idUserClaim Is Nothing) Then
                Throw New System.ArgumentNullException("idUserClaim")
            End If
            Dim localCompareTo As Integer = Me.Id.CompareTo(idUserClaim.Id)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.IdUserClaim.ExternalValidate", "Type 'S5T.IdUserClaim' cannot be validated.", Nothing)
                End If
                CodeFluentPersistence.AddValidationError(results, externalValidate)
            End If
            CodeFluentPersistence.ValidateMember(culture, results, Me, Nothing)
            If (Me.Type Is CType(Nothing, String)) Then
                Dim localValidate As String = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.IdUserClaim.Type.NullException", "'Type' property cannot be set to '' for type 'S5T.IdUserClaim'", Nothing)
                CodeFluentPersistence.AddValidationError(results, localValidate)
            End If
            If (Me.User Is Nothing) Then
                Dim localValidate1 As String = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.IdUserClaim.User.NullException", "'User' property cannot be set to '' for type 'S5T.IdUserClaim'", Nothing)
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "IdUserClaim", "Delete")
        ...
        Protected Overridable Sub ReadRecord(ByVal reader As System.Data.IDataReader, ByVal options As CodeFluent.Runtime.CodeFluentReloadOptions)
            ...
            If (((options And CodeFluent.Runtime.CodeFluentReloadOptions.Properties)  _
                ...
                Me._issuer = CodeFluentPersistence.GetReaderValue(reader, "Issuer", CType(CType(Nothing, String),String))
                Me._originalIssuer = CodeFluentPersistence.GetReaderValue(reader, "OriginalIssuer", CType(CType(Nothing, String),String))
        ...
        Public Shared Function Load(ByVal id As Long) As S5T.IdUserClaim
            If (id = -1) Then
                Return Nothing
            End If
            Dim idUserClaim As S5T.IdUserClaim = New S5T.IdUserClaim()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "IdUserClaim", "Load")
            persistence.AddParameter("@Id", id, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    idUserClaim.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadById(ByVal id As Long) As S5T.IdUserClaim
            If (id = -1) Then
                Return Nothing
            End If
            Dim idUserClaim As S5T.IdUserClaim = New S5T.IdUserClaim()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "IdUserClaim", "LoadById")
            persistence.AddParameter("@Id", id, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "IdUserClaim", "Save")
            persistence.AddParameter("@Id", Me.Id, CType(-1,Long))
            ...
            persistence.AddParameter("@Issuer", Me.Issuer, CType(Nothing, String))
            persistence.AddParameter("@OriginalIssuer", Me.OriginalIssuer, CType(Nothing, String))
        ...
        Public Overloads Shared Function Save(ByVal idUserClaim As S5T.IdUserClaim) As Boolean
            If (idUserClaim Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal idUserClaim As S5T.IdUserClaim) As Boolean
            Dim ret As Boolean = S5T.IdUserClaim.Save(idUserClaim)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal idUserClaim As S5T.IdUserClaim) As Boolean
            If (idUserClaim Is Nothing) Then
                Return false
            End If
        ...
        Protected Overridable Sub BaseTrace(ByVal writer As System.CodeDom.Compiler.IndentedTextWriter)
            ...
            writer.Write(",")
            writer.Write("Issuer=")
            writer.Write(Me.Issuer)
            writer.Write(",")
            writer.Write("OriginalIssuer=")
            writer.Write(Me.OriginalIssuer)
            writer.Write(",")
            writer.Write("User=")
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.IdUserClaim
            ...
            idUserClaim = S5T.IdUserClaim.Load(var)
            Return idUserClaim
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.IdUserClaim
            Dim idUserClaim As S5T.IdUserClaim = New S5T.IdUserClaim()
            Me.CopyTo(idUserClaim, deep)
            Return idUserClaim
        End Function
        
        Public Overloads Function Clone() As S5T.IdUserClaim
            Dim localClone As S5T.IdUserClaim = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overridable Sub CopyFrom(ByVal dict As System.Collections.IDictionary, ByVal deep As Boolean)
            ...
            End If
            If (dict.Contains("Issuer") = true) Then
                Me.Issuer = CType(ConvertUtilities.ChangeType(dict("Issuer"), GetType(String), CType(Nothing, String)),String)
            End If
            If (dict.Contains("OriginalIssuer") = true) Then
                Me.OriginalIssuer = CType(ConvertUtilities.ChangeType(dict("OriginalIssuer"), GetType(String), CType(Nothing, String)),String)
            End If
        ...
        Public Overloads Overridable Sub CopyTo(ByVal idUserClaim As S5T.IdUserClaim, ByVal deep As Boolean)
            If (idUserClaim Is Nothing) Then
                Throw New System.ArgumentNullException("idUserClaim")
            End If
            idUserClaim.Id = Me.Id
            idUserClaim.Issuer = Me.Issuer
            idUserClaim.OriginalIssuer = Me.OriginalIssuer
            idUserClaim.ValueType = Me.ValueType
            idUserClaim.Type = Me.Type
            idUserClaim.Value = Me.Value
            idUserClaim.UserId = Me.UserId
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, idUserClaim))
        End Sub
        ...
        Public Overloads Overridable Sub CopyTo(ByVal dict As System.Collections.IDictionary, ByVal deep As Boolean)
            ...
            End If
            dict("Id") = Me.Id
            dict("Issuer") = Me.Issuer
            dict("OriginalIssuer") = Me.OriginalIssuer
