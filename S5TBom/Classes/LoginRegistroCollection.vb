...
Namespace S5T
    ...
    Partial Public Class LoginRegistroCollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of S5T.LoginRegistro), System.Collections.Generic.ICollection(Of S5T.LoginRegistro), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of S5T.LoginRegistro) = New System.Collections.Generic.List(Of S5T.LoginRegistro)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of Long, S5T.LoginRegistro) = New System.Collections.Generic.Dictionary(Of Long, S5T.LoginRegistro)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _blm2624683743 As CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.LoginRegistro)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm2624683743 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.LoginRegistro)(Me)
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of S5T.LoginRegistro)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of Long, S5T.LoginRegistro)
            Get
        ...
        Public Overloads Default Property Item(ByVal index As Integer) As S5T.LoginRegistro Implements System.Collections.Generic.IList(Of S5T.LoginRegistro).Item
            Get
                Return CType(Me.BaseList(index),S5T.LoginRegistro)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,S5T.LoginRegistro)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal pId As Long) As S5T.LoginRegistro
            Get
                If (pId = -1) Then
                    Throw New System.ArgumentNullException("pId")
                End If
                Dim i As S5T.LoginRegistro = Me.TryGetValue(pId)
                Return i
            End Get
            Set
                If (pId = -1) Then
                ...
                If (value Is Nothing) Then
                    Dim loginRegistro As S5T.LoginRegistro = Me.TryGetValue(pId)
                    If (Not (loginRegistro) Is Nothing) Then
                        Me.Remove(loginRegistro)
                    End If
                    Return
                End If
                Dim existing As S5T.LoginRegistro = Me.TryGetValue(value.pId)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of S5T.LoginRegistro).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of S5T.LoginRegistro).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm2624683743.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm2624683743.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As S5T.LoginRegistro, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal loginRegistro As S5T.LoginRegistro) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(loginRegistro)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal loginRegistro As S5T.LoginRegistro) As Integer
            If (loginRegistro Is Nothing) Then
                Throw New System.ArgumentNullException("loginRegistro")
            End If
            If (loginRegistro.pId = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "pId", "loginRegistro", "S5T.LoginRegistro")
            End If
            Try 
                Me.BaseTable.Add(loginRegistro.pId, loginRegistro)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.LoginRegistroCollection", loginRegistro.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.LoginRegistroCollection", loginRegistro.pId), ae)
            End Try
            AddHandler loginRegistro.KeyChanged, AddressOf Me.OnItemKeyChanged
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(loginRegistro)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, loginRegistro, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            ...
            If (loginRegistro Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(loginRegistro)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_S5T_LoginRegistro__Add(ByVal loginRegistro As S5T.LoginRegistro) Implements System.Collections.Generic.ICollection(Of S5T.LoginRegistro).Add
            Me.BaseAdd(loginRegistro)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As S5T.LoginRegistro
            Dim loginRegistro As S5T.LoginRegistro = S5T.LoginRegistro.LoadByEntityKey(key)
            If ((Not (loginRegistro) Is Nothing)  _
                        AndAlso (Me.Contains(loginRegistro) = false)) Then
                Me.Add(loginRegistro)
            End If
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of S5T.LoginRegistro))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As S5T.LoginRegistro, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of S5T.LoginRegistro).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As S5T.LoginRegistro, ByVal index As Integer)
        ...
        Public Function Contains(ByVal loginRegistro As S5T.LoginRegistro) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.LoginRegistro).Contains
            Dim localContains As Boolean = Me.BaseContains(loginRegistro)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal loginRegistro As S5T.LoginRegistro) As Boolean
            If (loginRegistro Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(loginRegistro.pId)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            ...
            Catch icex As System.InvalidCastException
                loginRegistro = Nothing
            End Try
            Return Me.Contains(loginRegistro)
        End Function
        
        Public Function IndexOf(ByVal loginRegistro As S5T.LoginRegistro) As Integer Implements System.Collections.Generic.IList(Of S5T.LoginRegistro).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(loginRegistro)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal loginRegistro As S5T.LoginRegistro) As Integer
            If (loginRegistro Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(loginRegistro)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                loginRegistro = Nothing
            End Try
            Return Me.IndexOf(loginRegistro)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal loginRegistro As S5T.LoginRegistro) Implements System.Collections.Generic.IList(Of S5T.LoginRegistro).Insert
            Me.BaseInsert(index, loginRegistro)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal loginRegistro As S5T.LoginRegistro)
            If (loginRegistro Is Nothing) Then
                Throw New System.ArgumentNullException("loginRegistro")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.LoginRegistroCollection", loginRegistro.pId), ae)
            End Try
            Me.BaseList.Insert(index, loginRegistro)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, loginRegistro, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                loginRegistro = Nothing
            End Try
            Me.Insert(index, loginRegistro)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of S5T.LoginRegistro).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim LoginRegistro As S5T.LoginRegistro = Me(0)
                Me.BaseRemove(LoginRegistro)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal loginRegistro As S5T.LoginRegistro) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.LoginRegistro).Remove
            Return Me.BaseRemove(loginRegistro)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal loginRegistro As S5T.LoginRegistro) As Boolean
            If (loginRegistro Is Nothing) Then
                Throw New System.ArgumentNullException("loginRegistro")
            End If
            Dim index As Integer = Me.IndexOf(loginRegistro)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.LoginRegistro).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(loginRegistro)
            RemoveHandler loginRegistro.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(loginRegistro.pId)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, loginRegistro, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of S5T.LoginRegistro).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.LoginRegistro).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim loginRegistro As S5T.LoginRegistro = Me.BaseList(index)
            If (Not (loginRegistro) Is Nothing) Then
                RemoveHandler loginRegistro.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(loginRegistro.pId)
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of S5T.LoginRegistro) Implements System.Collections.Generic.IEnumerable(Of S5T.LoginRegistro).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of S5T.LoginRegistro) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As Long) As S5T.LoginRegistro
            Dim loginRegistro As S5T.LoginRegistro = Nothing
            If (Me.BaseTable.TryGetValue(key, loginRegistro) = true) Then
                Return loginRegistro
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim loginRegistro As S5T.LoginRegistro = Me(index)
                loginRegistro.Save
                If (loginRegistro.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(loginRegistro)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    ...
                    CType(loginRegistro,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(loginRegistro) = false) Then
                        Me.BaseAdd(loginRegistro)
                        count = (count + 1)
                    End If
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As S5T.LoginRegistroCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As S5T.LoginRegistroCollection = New S5T.LoginRegistroCollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5T.LoginRegistroCollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As S5T.LoginRegistroCollection
            Dim ret As S5T.LoginRegistroCollection = S5T.LoginRegistroCollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "loginregistro", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5T.LoginRegistroCollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As S5T.LoginRegistroCollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(S5T.LoginRegistro)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of S5T.LoginRegistro) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,S5T.LoginRegistro))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As S5T.LoginRegistroCollection
            Dim ret As S5T.LoginRegistroCollection = New S5T.LoginRegistroCollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm2624683743.AddIndex([property])
        End Sub
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm2624683743.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm2624683743.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of S5T.LoginRegistro))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of Long))
            If (e Is Nothing) Then
                Throw New System.ArgumentNullException("e")
            End If
            Dim existing As S5T.LoginRegistro = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.LoginRegistroCollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.LoginRegistroCollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As S5T.LoginRegistroCollection
            Return S5T.LoginRegistroCollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal loginRegistro As S5T.LoginRegistro) As Boolean
            If (loginRegistro Is Nothing) Then
                Return false
            End If
        ...
        Public Overloads Shared Function Insert(ByVal loginRegistro As S5T.LoginRegistro) As Boolean
            Dim ret As Boolean = S5T.LoginRegistro.Save(loginRegistro)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal loginRegistro As S5T.LoginRegistro) As Boolean
            If (loginRegistro Is Nothing) Then
                Return false
            End If
