...
Namespace S5T
    ...
    Partial Public Class IdUserLoginCollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of S5T.IdUserLogin), System.Collections.Generic.ICollection(Of S5T.IdUserLogin), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of S5T.IdUserLogin) = New System.Collections.Generic.List(Of S5T.IdUserLogin)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of Long, S5T.IdUserLogin) = New System.Collections.Generic.Dictionary(Of Long, S5T.IdUserLogin)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _loginsIdUserUser As S5T.IdUser
        
        <System.NonSerializedAttribute()>  _
        Private _addNewPos As Integer = -1
        
        <System.NonSerializedAttribute()>  _
        Private _blm1801890790 As CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.IdUserLogin)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm1801890790 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.IdUserLogin)(Me)
        End Sub
        
        Public Sub New(ByVal loginsIdUserUser As S5T.IdUser)
            MyBase.New
            Me._blm1801890790 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.IdUserLogin)(Me)
            Me._loginsIdUserUser = loginsIdUserUser
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of S5T.IdUserLogin)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of Long, S5T.IdUserLogin)
            Get
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Public ReadOnly Property LoginsIdUserUser() As S5T.IdUser
            Get
                Return Me._loginsIdUserUser
            End Get
        End Property
        
        Public Overloads Default Property Item(ByVal index As Integer) As S5T.IdUserLogin Implements System.Collections.Generic.IList(Of S5T.IdUserLogin).Item
            Get
                Return CType(Me.BaseList(index),S5T.IdUserLogin)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,S5T.IdUserLogin)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal id As Long) As S5T.IdUserLogin
            Get
                If (id = -1) Then
                    Throw New System.ArgumentNullException("id")
                End If
                Dim i As S5T.IdUserLogin = Me.TryGetValue(id)
                Return i
            End Get
            Set
                If (id = -1) Then
                ...
                If (value Is Nothing) Then
                    Dim idUserLogin As S5T.IdUserLogin = Me.TryGetValue(id)
                    If (Not (idUserLogin) Is Nothing) Then
                        Me.Remove(idUserLogin)
                    End If
                    Return
                End If
                Dim existing As S5T.IdUserLogin = Me.TryGetValue(value.Id)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of S5T.IdUserLogin).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of S5T.IdUserLogin).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm1801890790.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm1801890790.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As S5T.IdUserLogin, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal idUserLogin As S5T.IdUserLogin) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(idUserLogin)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal idUserLogin As S5T.IdUserLogin) As Integer
            If (idUserLogin Is Nothing) Then
                Throw New System.ArgumentNullException("idUserLogin")
            End If
            If (idUserLogin.Id = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "Id", "idUserLogin", "S5T.IdUserLogin")
            End If
            Try 
                Me.BaseTable.Add(idUserLogin.Id, idUserLogin)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.IdUserLoginCollection", idUserLogin.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.IdUserLoginCollection", idUserLogin.Id), ae)
            End Try
            AddHandler idUserLogin.KeyChanged, AddressOf Me.OnItemKeyChanged
            If (Not (Me._loginsIdUserUser) Is Nothing) Then
                idUserLogin.User = Me._loginsIdUserUser
            End If
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(idUserLogin)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, idUserLogin, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            ...
            If (idUserLogin Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(idUserLogin)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_S5T_IdUserLogin__Add(ByVal idUserLogin As S5T.IdUserLogin) Implements System.Collections.Generic.ICollection(Of S5T.IdUserLogin).Add
            Me.BaseAdd(idUserLogin)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As S5T.IdUserLogin
            Dim idUserLogin As S5T.IdUserLogin = S5T.IdUserLogin.LoadByEntityKey(key)
            If ((Not (idUserLogin) Is Nothing)  _
                        AndAlso (Me.Contains(idUserLogin) = false)) Then
                Me.Add(idUserLogin)
            End If
            Return idUserLogin
        End Function
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of S5T.IdUserLogin))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As S5T.IdUserLogin, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of S5T.IdUserLogin).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As S5T.IdUserLogin, ByVal index As Integer)
        ...
        Public Function Contains(ByVal idUserLogin As S5T.IdUserLogin) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.IdUserLogin).Contains
            Dim localContains As Boolean = Me.BaseContains(idUserLogin)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal idUserLogin As S5T.IdUserLogin) As Boolean
            If (idUserLogin Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(idUserLogin.Id)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            ...
            Catch icex As System.InvalidCastException
                idUserLogin = Nothing
            End Try
            Return Me.Contains(idUserLogin)
        End Function
        
        Public Function IndexOf(ByVal idUserLogin As S5T.IdUserLogin) As Integer Implements System.Collections.Generic.IList(Of S5T.IdUserLogin).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(idUserLogin)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal idUserLogin As S5T.IdUserLogin) As Integer
            If (idUserLogin Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(idUserLogin)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                idUserLogin = Nothing
            End Try
            Return Me.IndexOf(idUserLogin)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal idUserLogin As S5T.IdUserLogin) Implements System.Collections.Generic.IList(Of S5T.IdUserLogin).Insert
            Me.BaseInsert(index, idUserLogin)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal idUserLogin As S5T.IdUserLogin)
            If (idUserLogin Is Nothing) Then
                Throw New System.ArgumentNullException("idUserLogin")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.IdUserLoginCollection", idUserLogin.Id), ae)
            End Try
            Me.BaseList.Insert(index, idUserLogin)
            If (Not (Me._loginsIdUserUser) Is Nothing) Then
                idUserLogin.User = Me._loginsIdUserUser
            End If
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, idUserLogin, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                idUserLogin = Nothing
            End Try
            Me.Insert(index, idUserLogin)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of S5T.IdUserLogin).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim IdUserLogin As S5T.IdUserLogin = Me(0)
                Me.BaseRemove(IdUserLogin)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal idUserLogin As S5T.IdUserLogin) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.IdUserLogin).Remove
            Return Me.BaseRemove(idUserLogin)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal idUserLogin As S5T.IdUserLogin) As Boolean
            If (idUserLogin Is Nothing) Then
                Throw New System.ArgumentNullException("idUserLogin")
            End If
            Dim index As Integer = Me.IndexOf(idUserLogin)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.IdUserLogin).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(idUserLogin)
            RemoveHandler idUserLogin.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(idUserLogin.Id)
            If (Not (Me._loginsIdUserUser) Is Nothing) Then
                idUserLogin.User = Nothing
            End If
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, idUserLogin, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of S5T.IdUserLogin).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.IdUserLogin).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim idUserLogin As S5T.IdUserLogin = Me.BaseList(index)
            If (Not (idUserLogin) Is Nothing) Then
                RemoveHandler idUserLogin.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(idUserLogin.Id)
            End If
            If (Not (Me._loginsIdUserUser) Is Nothing) Then
                idUserLogin.User = Nothing
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of S5T.IdUserLogin) Implements System.Collections.Generic.IEnumerable(Of S5T.IdUserLogin).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of S5T.IdUserLogin) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As Long) As S5T.IdUserLogin
            Dim idUserLogin As S5T.IdUserLogin = Nothing
            If (Me.BaseTable.TryGetValue(key, idUserLogin) = true) Then
                Return idUserLogin
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim idUserLogin As S5T.IdUserLogin = Me(index)
                idUserLogin.Save
                If (idUserLogin.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(idUserLogin)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    ...
                    CType(idUserLogin,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(idUserLogin) = false) Then
                        Me.BaseAdd(idUserLogin)
                        count = (count + 1)
                    End If
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As S5T.IdUserLoginCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As S5T.IdUserLoginCollection = New S5T.IdUserLoginCollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5T.IdUserLoginCollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As S5T.IdUserLoginCollection
            Dim ret As S5T.IdUserLoginCollection = S5T.IdUserLoginCollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "IdUserLogin", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5T.IdUserLoginCollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadByUser(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal user As S5T.IdUser) As S5T.IdUserLoginCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
            ...
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5T.IdUserLoginCollection.PageDataLoadByUser(pageOptions, user)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadByUser(ByVal user As S5T.IdUser) As S5T.IdUserLoginCollection
            Dim ret As S5T.IdUserLoginCollection = S5T.IdUserLoginCollection.PageLoadByUser(Integer.MinValue, Integer.MaxValue, Nothing, user)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadByUser(ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal user As S5T.IdUser) As System.Data.IDataReader
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "IdUserLogin", "LoadByUser")
        ...
        Public Shared Function DataLoadByUser(ByVal user As S5T.IdUser) As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5T.IdUserLoginCollection.PageDataLoadByUser(Nothing, user)
            Return reader
        End Function
        
        Public Shared Function DeleteByUserLoginInfo(ByVal user As S5T.IdUser, ByVal providerKey As String, ByVal providerName As String) As Integer
            If (user Is Nothing) Then
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "IdUserLogin", "DeleteByUserLoginInfo")
            persistence.AddParameter("@UserId", user.Id, CType(-1,Long))
            persistence.AddParameter("@ProviderKey", providerKey, CType(Nothing, String))
            persistence.AddParameter("@ProviderName", providerName, CType(Nothing, String))
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As S5T.IdUserLoginCollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(S5T.IdUserLogin)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of S5T.IdUserLogin) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,S5T.IdUserLogin))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As S5T.IdUserLoginCollection
            Dim ret As S5T.IdUserLoginCollection = New S5T.IdUserLoginCollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm1801890790.AddIndex([property])
        End Sub
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm1801890790.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm1801890790.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of S5T.IdUserLogin))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of Long))
            If (e Is Nothing) Then
                Throw New System.ArgumentNullException("e")
            End If
            Dim existing As S5T.IdUserLogin = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.IdUserLoginCollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.IdUserLoginCollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As S5T.IdUserLoginCollection
            Return S5T.IdUserLoginCollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadByUser(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal userId As Long) As S5T.IdUserLoginCollection
            Dim idUser As S5T.IdUser = S5T.IdUser.Load(userId)
            If (idUser Is Nothing) Then
                Return New S5T.IdUserLoginCollection()
            End If
            Return S5T.IdUserLoginCollection.PageLoadByUser(pageIndex, pageSize, Nothing, idUser)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal idUserLogin As S5T.IdUserLogin) As Boolean
            If (idUserLogin Is Nothing) Then
                Return false
            End If
        ...
        Public Overloads Shared Function Insert(ByVal idUserLogin As S5T.IdUserLogin) As Boolean
            Dim ret As Boolean = S5T.IdUserLogin.Save(idUserLogin)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal idUserLogin As S5T.IdUserLogin) As Boolean
            If (idUserLogin Is Nothing) Then
                Return false
            End If
