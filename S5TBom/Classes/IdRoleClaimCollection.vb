...
Namespace S5T
    ...
    Partial Public Class IdRoleClaimCollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of S5T.IdRoleClaim), System.Collections.Generic.ICollection(Of S5T.IdRoleClaim), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of S5T.IdRoleClaim) = New System.Collections.Generic.List(Of S5T.IdRoleClaim)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of Long, S5T.IdRoleClaim) = New System.Collections.Generic.Dictionary(Of Long, S5T.IdRoleClaim)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _claimsIdRoleRole As S5T.IdRole
        
        <System.NonSerializedAttribute()>  _
        Private _addNewPos As Integer = -1
        
        <System.NonSerializedAttribute()>  _
        Private _blm826572097 As CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.IdRoleClaim)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm826572097 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.IdRoleClaim)(Me)
        End Sub
        
        Public Sub New(ByVal claimsIdRoleRole As S5T.IdRole)
            MyBase.New
            Me._blm826572097 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.IdRoleClaim)(Me)
            Me._claimsIdRoleRole = claimsIdRoleRole
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of S5T.IdRoleClaim)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of Long, S5T.IdRoleClaim)
            Get
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Public ReadOnly Property ClaimsIdRoleRole() As S5T.IdRole
            Get
                Return Me._claimsIdRoleRole
            End Get
        End Property
        
        Public Overloads Default Property Item(ByVal index As Integer) As S5T.IdRoleClaim Implements System.Collections.Generic.IList(Of S5T.IdRoleClaim).Item
            Get
                Return CType(Me.BaseList(index),S5T.IdRoleClaim)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,S5T.IdRoleClaim)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal id As Long) As S5T.IdRoleClaim
            Get
                If (id = -1) Then
                    Throw New System.ArgumentNullException("id")
                End If
                Dim i As S5T.IdRoleClaim = Me.TryGetValue(id)
                Return i
            End Get
            Set
                If (id = -1) Then
                ...
                If (value Is Nothing) Then
                    Dim idRoleClaim As S5T.IdRoleClaim = Me.TryGetValue(id)
                    If (Not (idRoleClaim) Is Nothing) Then
                        Me.Remove(idRoleClaim)
                    End If
                    Return
                End If
                Dim existing As S5T.IdRoleClaim = Me.TryGetValue(value.Id)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of S5T.IdRoleClaim).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of S5T.IdRoleClaim).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm826572097.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm826572097.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As S5T.IdRoleClaim, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal idRoleClaim As S5T.IdRoleClaim) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(idRoleClaim)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal idRoleClaim As S5T.IdRoleClaim) As Integer
            If (idRoleClaim Is Nothing) Then
                Throw New System.ArgumentNullException("idRoleClaim")
            End If
            If (idRoleClaim.Id = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "Id", "idRoleClaim", "S5T.IdRoleClaim")
            End If
            Try 
                Me.BaseTable.Add(idRoleClaim.Id, idRoleClaim)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.IdRoleClaimCollection", idRoleClaim.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.IdRoleClaimCollection", idRoleClaim.Id), ae)
            End Try
            AddHandler idRoleClaim.KeyChanged, AddressOf Me.OnItemKeyChanged
            If (Not (Me._claimsIdRoleRole) Is Nothing) Then
                idRoleClaim.Role = Me._claimsIdRoleRole
            End If
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(idRoleClaim)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, idRoleClaim, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            ...
            If (idRoleClaim Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(idRoleClaim)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_S5T_IdRoleClaim__Add(ByVal idRoleClaim As S5T.IdRoleClaim) Implements System.Collections.Generic.ICollection(Of S5T.IdRoleClaim).Add
            Me.BaseAdd(idRoleClaim)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As S5T.IdRoleClaim
            Dim idRoleClaim As S5T.IdRoleClaim = S5T.IdRoleClaim.LoadByEntityKey(key)
            If ((Not (idRoleClaim) Is Nothing)  _
                        AndAlso (Me.Contains(idRoleClaim) = false)) Then
                Me.Add(idRoleClaim)
            End If
            Return idRoleClaim
        End Function
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of S5T.IdRoleClaim))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As S5T.IdRoleClaim, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of S5T.IdRoleClaim).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As S5T.IdRoleClaim, ByVal index As Integer)
        ...
        Public Function Contains(ByVal idRoleClaim As S5T.IdRoleClaim) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.IdRoleClaim).Contains
            Dim localContains As Boolean = Me.BaseContains(idRoleClaim)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal idRoleClaim As S5T.IdRoleClaim) As Boolean
            If (idRoleClaim Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(idRoleClaim.Id)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            ...
            Catch icex As System.InvalidCastException
                idRoleClaim = Nothing
            End Try
            Return Me.Contains(idRoleClaim)
        End Function
        
        Public Function IndexOf(ByVal idRoleClaim As S5T.IdRoleClaim) As Integer Implements System.Collections.Generic.IList(Of S5T.IdRoleClaim).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(idRoleClaim)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal idRoleClaim As S5T.IdRoleClaim) As Integer
            If (idRoleClaim Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(idRoleClaim)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                idRoleClaim = Nothing
            End Try
            Return Me.IndexOf(idRoleClaim)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal idRoleClaim As S5T.IdRoleClaim) Implements System.Collections.Generic.IList(Of S5T.IdRoleClaim).Insert
            Me.BaseInsert(index, idRoleClaim)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal idRoleClaim As S5T.IdRoleClaim)
            If (idRoleClaim Is Nothing) Then
                Throw New System.ArgumentNullException("idRoleClaim")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.IdRoleClaimCollection", idRoleClaim.Id), ae)
            End Try
            Me.BaseList.Insert(index, idRoleClaim)
            If (Not (Me._claimsIdRoleRole) Is Nothing) Then
                idRoleClaim.Role = Me._claimsIdRoleRole
            End If
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, idRoleClaim, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                idRoleClaim = Nothing
            End Try
            Me.Insert(index, idRoleClaim)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of S5T.IdRoleClaim).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim IdRoleClaim As S5T.IdRoleClaim = Me(0)
                Me.BaseRemove(IdRoleClaim)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal idRoleClaim As S5T.IdRoleClaim) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.IdRoleClaim).Remove
            Return Me.BaseRemove(idRoleClaim)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal idRoleClaim As S5T.IdRoleClaim) As Boolean
            If (idRoleClaim Is Nothing) Then
                Throw New System.ArgumentNullException("idRoleClaim")
            End If
            Dim index As Integer = Me.IndexOf(idRoleClaim)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.IdRoleClaim).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(idRoleClaim)
            RemoveHandler idRoleClaim.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(idRoleClaim.Id)
            If (Not (Me._claimsIdRoleRole) Is Nothing) Then
                idRoleClaim.Role = Nothing
            End If
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, idRoleClaim, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of S5T.IdRoleClaim).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.IdRoleClaim).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim idRoleClaim As S5T.IdRoleClaim = Me.BaseList(index)
            If (Not (idRoleClaim) Is Nothing) Then
                RemoveHandler idRoleClaim.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(idRoleClaim.Id)
            End If
            If (Not (Me._claimsIdRoleRole) Is Nothing) Then
                idRoleClaim.Role = Nothing
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of S5T.IdRoleClaim) Implements System.Collections.Generic.IEnumerable(Of S5T.IdRoleClaim).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of S5T.IdRoleClaim) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As Long) As S5T.IdRoleClaim
            Dim idRoleClaim As S5T.IdRoleClaim = Nothing
            If (Me.BaseTable.TryGetValue(key, idRoleClaim) = true) Then
                Return idRoleClaim
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim idRoleClaim As S5T.IdRoleClaim = Me(index)
                idRoleClaim.Save
                If (idRoleClaim.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(idRoleClaim)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    ...
                    CType(idRoleClaim,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(idRoleClaim) = false) Then
                        Me.BaseAdd(idRoleClaim)
                        count = (count + 1)
                    End If
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As S5T.IdRoleClaimCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As S5T.IdRoleClaimCollection = New S5T.IdRoleClaimCollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5T.IdRoleClaimCollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As S5T.IdRoleClaimCollection
            Dim ret As S5T.IdRoleClaimCollection = S5T.IdRoleClaimCollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "IdRoleClaim", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5T.IdRoleClaimCollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        
        Private Overloads Sub LoadByRole(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader, ByVal role As S5T.IdRole)
            If (reader Is Nothing) Then
                Throw New System.ArgumentNullException("reader")
            End If
            If (pageIndex < 0) Then
            ...
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim idRoleState As CodeFluent.Runtime.CodeFluentEntityState = CodeFluent.Runtime.CodeFluentEntityState.Unchanged
            If (Not (role) Is Nothing) Then
                idRoleState = role.EntityState
            End If
            Me._claimsIdRoleRole = role
            Me.BaseList.Clear
            Me.BaseTable.Clear
            Dim count As Integer = 0
            Dim readCount As Integer = 0
            ...
            Loop
            If (Not (role) Is Nothing) Then
                role.EntityState = idRoleState
            End If
        End Sub
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadByRole(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal role As S5T.IdRole) As S5T.IdRoleClaimCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
            ...
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5T.IdRoleClaimCollection.PageDataLoadByRole(pageOptions, role)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadByRole(ByVal role As S5T.IdRole) As S5T.IdRoleClaimCollection
            Dim ret As S5T.IdRoleClaimCollection = S5T.IdRoleClaimCollection.PageLoadByRole(Integer.MinValue, Integer.MaxValue, Nothing, role)
            Return ret
        End Function
        
        Public Shared Function PageDataLoadByRole(ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal role As S5T.IdRole) As System.Data.IDataReader
            If (role Is Nothing) Then
                Return Nothing
            End If
            If (role.Id = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "Id", "role", "S5T.IdRole")
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "IdRoleClaim", "LoadByRole")
            persistence.AddParameter("@RoleId", role.Id, CType(-1,Long))
            If (Not (pageOptions) Is Nothing) Then
                Dim enumerator As System.Collections.IEnumerator = pageOptions.OrderByArguments.GetEnumerator
                Dim b As Boolean
                Dim index As Integer = 0
        ...
        Public Shared Function DataLoadByRole(ByVal role As S5T.IdRole) As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5T.IdRoleClaimCollection.PageDataLoadByRole(Nothing, role)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As S5T.IdRoleClaimCollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(S5T.IdRoleClaim)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of S5T.IdRoleClaim) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,S5T.IdRoleClaim))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As S5T.IdRoleClaimCollection
            Dim ret As S5T.IdRoleClaimCollection = New S5T.IdRoleClaimCollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm826572097.AddIndex([property])
        End Sub
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm826572097.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm826572097.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of S5T.IdRoleClaim))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of Long))
            If (e Is Nothing) Then
                Throw New System.ArgumentNullException("e")
            End If
            Dim existing As S5T.IdRoleClaim = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.IdRoleClaimCollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.IdRoleClaimCollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As S5T.IdRoleClaimCollection
            Return S5T.IdRoleClaimCollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadByRole(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal roleId As Long) As S5T.IdRoleClaimCollection
            Dim idRole As S5T.IdRole = S5T.IdRole.Load(roleId)
            If (idRole Is Nothing) Then
                Return New S5T.IdRoleClaimCollection()
            End If
            Return S5T.IdRoleClaimCollection.PageLoadByRole(pageIndex, pageSize, Nothing, idRole)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal idRoleClaim As S5T.IdRoleClaim) As Boolean
            If (idRoleClaim Is Nothing) Then
                Return false
            End If
        ...
        Public Overloads Shared Function Insert(ByVal idRoleClaim As S5T.IdRoleClaim) As Boolean
            Dim ret As Boolean = S5T.IdRoleClaim.Save(idRoleClaim)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal idRoleClaim As S5T.IdRoleClaim) As Boolean
            If (idRoleClaim Is Nothing) Then
                Return false
            End If
