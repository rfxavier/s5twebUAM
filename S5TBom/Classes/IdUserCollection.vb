...
Namespace S5T
    ...
    Partial Public Class IdUserCollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of S5T.IdUser), System.Collections.Generic.ICollection(Of S5T.IdUser), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of S5T.IdUser) = New System.Collections.Generic.List(Of S5T.IdUser)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of String, S5T.IdUser) = New System.Collections.Generic.Dictionary(Of String, S5T.IdUser)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _usersIdRoleRoles As S5T.IdRole
        
        <System.NonSerializedAttribute()>  _
        Private _addNewPos As Integer = -1
        
        <System.NonSerializedAttribute()>  _
        Private _blm3010368585 As CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.IdUser)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm3010368585 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.IdUser)(Me)
        End Sub
        
        Public Sub New(ByVal usersIdRoleRoles As S5T.IdRole)
            MyBase.New
            Me._blm3010368585 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.IdUser)(Me)
            Me._usersIdRoleRoles = usersIdRoleRoles
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of S5T.IdUser)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of String, S5T.IdUser)
            Get
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Public ReadOnly Property UsersIdRoleRoles() As S5T.IdRole
            Get
                Return Me._usersIdRoleRoles
            End Get
        End Property
        
        Public Overloads Default Property Item(ByVal index As Integer) As S5T.IdUser Implements System.Collections.Generic.IList(Of S5T.IdUser).Item
            Get
                Return CType(Me.BaseList(index),S5T.IdUser)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,S5T.IdUser)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal userName As String) As S5T.IdUser
            Get
                If (userName Is CType(Nothing, String)) Then
                    Throw New System.ArgumentNullException("userName")
                End If
                Dim i As S5T.IdUser = Me.TryGetValue(userName)
                Return i
            End Get
            Set
                If (userName Is CType(Nothing, String)) Then
                ...
                If (value Is Nothing) Then
                    Dim idUser As S5T.IdUser = Me.TryGetValue(userName)
                    If (Not (idUser) Is Nothing) Then
                        Me.Remove(idUser)
                    End If
                    Return
                End If
                Dim existing As S5T.IdUser = Me.TryGetValue(value.UserName)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of S5T.IdUser).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of S5T.IdUser).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm3010368585.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm3010368585.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As S5T.IdUser, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal idUser As S5T.IdUser) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(idUser)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal idUser As S5T.IdUser) As Integer
            ...
            End If
            Try 
                Me.BaseTable.Add(idUser.UserName, idUser)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.IdUserCollection", idUser.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.IdUserCollection", idUser.UserName), ae)
            End Try
            AddHandler idUser.KeyChanged, AddressOf Me.OnItemKeyChanged
            Me.Relate(idUser, CodeFluent.Runtime.CodeFluentRelationType.Added)
            If (Not (Me._usersIdRoleRoles) Is Nothing) Then
                Me._usersIdRoleRoles.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Modified
            End If
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(idUser)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, idUser, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            ...
            If (idUser Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(idUser)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_S5T_IdUser__Add(ByVal idUser As S5T.IdUser) Implements System.Collections.Generic.ICollection(Of S5T.IdUser).Add
            Me.BaseAdd(idUser)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As S5T.IdUser
            Dim idUser As S5T.IdUser = S5T.IdUser.LoadByEntityKey(key)
            If ((Not (idUser) Is Nothing)  _
                        AndAlso (Me.Contains(idUser) = false)) Then
                Me.Add(idUser)
            End If
            Return idUser
        End Function
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of S5T.IdUser))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As S5T.IdUser, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of S5T.IdUser).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As S5T.IdUser, ByVal index As Integer)
        ...
        Public Function Contains(ByVal idUser As S5T.IdUser) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.IdUser).Contains
            Dim localContains As Boolean = Me.BaseContains(idUser)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal idUser As S5T.IdUser) As Boolean
            If (idUser Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(idUser.UserName)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            ...
            Catch icex As System.InvalidCastException
                idUser = Nothing
            End Try
            Return Me.Contains(idUser)
        End Function
        
        Public Function IndexOf(ByVal idUser As S5T.IdUser) As Integer Implements System.Collections.Generic.IList(Of S5T.IdUser).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(idUser)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal idUser As S5T.IdUser) As Integer
            If (idUser Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(idUser)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                idUser = Nothing
            End Try
            Return Me.IndexOf(idUser)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal idUser As S5T.IdUser) Implements System.Collections.Generic.IList(Of S5T.IdUser).Insert
            Me.BaseInsert(index, idUser)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal idUser As S5T.IdUser)
            If (idUser Is Nothing) Then
                Throw New System.ArgumentNullException("idUser")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.IdUserCollection", idUser.UserName), ae)
            End Try
            Me.BaseList.Insert(index, idUser)
            Me.Relate(idUser, CodeFluent.Runtime.CodeFluentRelationType.Added)
            If (Not (Me._usersIdRoleRoles) Is Nothing) Then
                Me._usersIdRoleRoles.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Modified
            End If
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, idUser, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                idUser = Nothing
            End Try
            Me.Insert(index, idUser)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of S5T.IdUser).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim IdUser As S5T.IdUser = Me(0)
                Me.BaseRemove(IdUser)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal idUser As S5T.IdUser) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.IdUser).Remove
            Return Me.BaseRemove(idUser)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal idUser As S5T.IdUser) As Boolean
            If (idUser Is Nothing) Then
                Throw New System.ArgumentNullException("idUser")
            End If
            Dim index As Integer = Me.IndexOf(idUser)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.IdUser).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(idUser)
            RemoveHandler idUser.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(idUser.UserName)
            Me.Relate(idUser, CodeFluent.Runtime.CodeFluentRelationType.Removed)
            If (Not (Me._usersIdRoleRoles) Is Nothing) Then
                Me._usersIdRoleRoles.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Modified
            End If
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, idUser, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of S5T.IdUser).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.IdUser).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim idUser As S5T.IdUser = Me.BaseList(index)
            If (Not (idUser) Is Nothing) Then
                RemoveHandler idUser.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(idUser.UserName)
                Me.Relate(idUser, CodeFluent.Runtime.CodeFluentRelationType.Removed)
            End If
            If (Not (Me._usersIdRoleRoles) Is Nothing) Then
                Me._usersIdRoleRoles.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Modified
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of S5T.IdUser) Implements System.Collections.Generic.IEnumerable(Of S5T.IdUser).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of S5T.IdUser) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As String) As S5T.IdUser
            Dim idUser As S5T.IdUser = Nothing
            If (Me.BaseTable.TryGetValue(key, idUser) = true) Then
                Return idUser
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim idUser As S5T.IdUser = Me(index)
                idUser.Save
                If (idUser.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(idUser)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    ...
                    CType(idUser,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(idUser) = false) Then
                        Me.BaseAdd(idUser)
                        count = (count + 1)
                    End If
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As S5T.IdUserCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As S5T.IdUserCollection = New S5T.IdUserCollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5T.IdUserCollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As S5T.IdUserCollection
            Dim ret As S5T.IdUserCollection = S5T.IdUserCollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "IdUser", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5T.IdUserCollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        
        Private Overloads Sub LoadUsersRolesByIdRole(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader, ByVal idRole As S5T.IdRole)
            If (reader Is Nothing) Then
                Throw New System.ArgumentNullException("reader")
            End If
            If (pageIndex < 0) Then
            ...
            If (Not (idRole) Is Nothing) Then
                idRoleState = idRole.EntityState
            End If
            Me._usersIdRoleRoles = idRole
            Me.BaseList.Clear
            Me.BaseTable.Clear
            Dim count As Integer = 0
            Dim readCount As Integer = 0
            ...
            Loop
            If (Not (idRole) Is Nothing) Then
                idRole.EntityState = idRoleState
            End If
        End Sub
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadUsersRolesByIdRole(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal idRole As S5T.IdRole) As S5T.IdUserCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
            ...
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5T.IdUserCollection.PageDataLoadUsersRolesByIdRole(pageOptions, idRole)
                If (reader Is Nothing) Then
                    Return ret
                End If
                ret.LoadUsersRolesByIdRole(pageIndex, pageSize, pageOptions, reader, idRole)
            Finally
                If (Not (reader) Is Nothing) Then
                    reader.Dispose
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadUsersRolesByIdRole(ByVal idRole As S5T.IdRole) As S5T.IdUserCollection
            Dim ret As S5T.IdUserCollection = S5T.IdUserCollection.PageLoadUsersRolesByIdRole(Integer.MinValue, Integer.MaxValue, Nothing, idRole)
            Return ret
        End Function
        
        Public Shared Function PageDataLoadUsersRolesByIdRole(ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal idRole As S5T.IdRole) As System.Data.IDataReader
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "IdUser", "LoadUsersRolesByIdRole")
            persistence.AddParameter("@IdRoleId", idRole.Id, CType(-1,Long))
            If (Not (pageOptions) Is Nothing) Then
                Dim enumerator As System.Collections.IEnumerator = pageOptions.OrderByArguments.GetEnumerator
                Dim b As Boolean
                Dim index As Integer = 0
        ...
        Public Shared Function DataLoadUsersRolesByIdRole(ByVal idRole As S5T.IdRole) As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5T.IdUserCollection.PageDataLoadUsersRolesByIdRole(Nothing, idRole)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As S5T.IdUserCollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(S5T.IdUser)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of S5T.IdUser) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,S5T.IdUser))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As S5T.IdUserCollection
            Dim ret As S5T.IdUserCollection = New S5T.IdUserCollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm3010368585.AddIndex([property])
        End Sub
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm3010368585.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm3010368585.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of S5T.IdUser))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of String))
            ...
            If (e.OldKey Is Nothing) Then
                Return
            End If
            Dim existing As S5T.IdUser = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.IdUserCollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.IdUserCollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As S5T.IdUserCollection
            Return S5T.IdUserCollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadUsersRolesByIdRole(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal idRoleId As Long) As S5T.IdUserCollection
            Dim idRole As S5T.IdRole = S5T.IdRole.Load(idRoleId)
            If (idRole Is Nothing) Then
                Return New S5T.IdUserCollection()
            End If
            Return S5T.IdUserCollection.PageLoadUsersRolesByIdRole(pageIndex, pageSize, Nothing, idRole)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal idUser As S5T.IdUser) As Boolean
            If (idUser Is Nothing) Then
                Return false
            End If
        ...
        Public Overloads Shared Function Insert(ByVal idUser As S5T.IdUser) As Boolean
            Dim ret As Boolean = S5T.IdUser.Save(idUser)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal idUser As S5T.IdUser) As Boolean
            If (idUser Is Nothing) Then
                Return false
            End If
