...
Namespace S5T
    ...
    Partial Public Class CidadeViewGrid
        ...
        Private _uF As String = CType(Nothing, String)
        
        Private _sigla As String = CType(Nothing, String)
        
        Private _pCodigoStr As String = CType(Nothing, String)
        ...
        <System.ComponentModel.DefaultValueAttribute(CType(Nothing, String)),  _
         System.Xml.Serialization.XmlElementAttribute(IsNullable:=true, Type:=GetType(String))>  _
        Public Property pCodigoStr() As String
            Get
                Return Me._pCodigoStr
            End Get
            Set
                Me._pCodigoStr = value
            End Set
        End Property
        ...
        Protected Overridable Sub ReadRecord(ByVal reader As System.Data.IDataReader, ByVal options As CodeFluent.Runtime.CodeFluentReloadOptions)
            ...
            If (((options And CodeFluent.Runtime.CodeFluentReloadOptions.Properties)  _
                ...
                Me._uF = CodeFluentPersistence.GetReaderValue(reader, "UF", CType(CType(Nothing, String),String))
                Me._sigla = CodeFluentPersistence.GetReaderValue(reader, "Sigla", CType(CType(Nothing, String),String))
                Me._pCodigoStr = CodeFluentPersistence.GetReaderValue(reader, "pCodigoStr", CType(CType(Nothing, String),String))
            End If
        End Sub
