...
Namespace S5TUam
    ...
    Partial Public Class SAFRA_ANO
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5TUam.SAFRA_ANO), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5TUam.SAFRA_ANO)
        ...
        Public Overloads Overridable Function Equals(ByVal sAFRA_ANO As S5TUam.SAFRA_ANO) As Boolean Implements System.IEquatable(Of S5TUam.SAFRA_ANO).Equals
            If (sAFRA_ANO Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(sAFRA_ANO)
            End If
            Return (Me.pId.Equals(sAFRA_ANO.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                sAFRA_ANO = CType(obj,S5TUam.SAFRA_ANO)
            Catch icex As System.InvalidCastException
                sAFRA_ANO = Nothing
            End Try
            Return Me.Equals(sAFRA_ANO)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(sAFRA_ANO)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal sAFRA_ANO As S5TUam.SAFRA_ANO) As Integer Implements System.IComparable(Of S5TUam.SAFRA_ANO).CompareTo
            If (sAFRA_ANO Is Nothing) Then
                Throw New System.ArgumentNullException("sAFRA_ANO")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(sAFRA_ANO.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5TUam.SAFRA_ANO.ExternalValidate", "Type 'S5TUam.SAFRA_ANO' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "SAFRA_ANO", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5TUam.SAFRA_ANO
            If (pId = -1) Then
                Return Nothing
            End If
            Dim sAFRA_ANO As S5TUam.SAFRA_ANO = New S5TUam.SAFRA_ANO()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "SAFRA_ANO", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    sAFRA_ANO.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5TUam.SAFRA_ANO
            If (pId = -1) Then
                Return Nothing
            End If
            Dim sAFRA_ANO As S5TUam.SAFRA_ANO = New S5TUam.SAFRA_ANO()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "SAFRA_ANO", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "SAFRA_ANO", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal sAFRA_ANO As S5TUam.SAFRA_ANO) As Boolean
            If (sAFRA_ANO Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal sAFRA_ANO As S5TUam.SAFRA_ANO) As Boolean
            Dim ret As Boolean = S5TUam.SAFRA_ANO.Save(sAFRA_ANO)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal sAFRA_ANO As S5TUam.SAFRA_ANO) As Boolean
            If (sAFRA_ANO Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5TUam.SAFRA_ANO
            ...
            sAFRA_ANO = S5TUam.SAFRA_ANO.Load(var)
            Return sAFRA_ANO
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5TUam.SAFRA_ANO
            Dim sAFRA_ANO As S5TUam.SAFRA_ANO = New S5TUam.SAFRA_ANO()
            Me.CopyTo(sAFRA_ANO, deep)
            Return sAFRA_ANO
        End Function
        
        Public Overloads Function Clone() As S5TUam.SAFRA_ANO
            Dim localClone As S5TUam.SAFRA_ANO = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal sAFRA_ANO As S5TUam.SAFRA_ANO, ByVal deep As Boolean)
            If (sAFRA_ANO Is Nothing) Then
                Throw New System.ArgumentNullException("sAFRA_ANO")
            End If
            sAFRA_ANO.pId = Me.pId
            sAFRA_ANO.SAFRA = Me.SAFRA
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, sAFRA_ANO))
        End Sub
