...
Namespace S5TUam
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("CodeFluent Entities", "1.0.01234.05678"),  _
     ...
     System.Diagnostics.DebuggerDisplayAttribute("EK={EntityKey}, PROPRIEDADE={PROPRIEDADE}, pId={pId}"),  _
     System.ComponentModel.TypeConverterAttribute(GetType(CodeFluent.Runtime.Design.NameTypeConverter))>  _
    Partial Public Class ENT_CAMBAL_FRENTESPROP
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5TUam.ENT_CAMBAL_FRENTESPROP), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5TUam.ENT_CAMBAL_FRENTESPROP)
        ...
        Private _pROPRIEDADE As String = CType(Nothing, String)
        ...
        Public Overloads Overridable Function Equals(ByVal eNT_CAMBAL_FRENTESPROP As S5TUam.ENT_CAMBAL_FRENTESPROP) As Boolean Implements System.IEquatable(Of S5TUam.ENT_CAMBAL_FRENTESPROP).Equals
            If (eNT_CAMBAL_FRENTESPROP Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(eNT_CAMBAL_FRENTESPROP)
            End If
            Return (Me.pId.Equals(eNT_CAMBAL_FRENTESPROP.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                eNT_CAMBAL_FRENTESPROP = CType(obj,S5TUam.ENT_CAMBAL_FRENTESPROP)
            Catch icex As System.InvalidCastException
                eNT_CAMBAL_FRENTESPROP = Nothing
            End Try
            Return Me.Equals(eNT_CAMBAL_FRENTESPROP)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(eNT_CAMBAL_FRENTESPROP)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal eNT_CAMBAL_FRENTESPROP As S5TUam.ENT_CAMBAL_FRENTESPROP) As Integer Implements System.IComparable(Of S5TUam.ENT_CAMBAL_FRENTESPROP).CompareTo
            If (eNT_CAMBAL_FRENTESPROP Is Nothing) Then
                Throw New System.ArgumentNullException("eNT_CAMBAL_FRENTESPROP")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(eNT_CAMBAL_FRENTESPROP.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5TUam.ENT_CAMBAL_FRENTESPROP.ExternalValidate", "Type 'S5TUam.ENT_CAMBAL_FRENTESPROP' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "ENT_CAMBAL_FRENTESPROP", "Delete")
        ...
        Protected Overridable Sub ReadRecord(ByVal reader As System.Data.IDataReader, ByVal options As CodeFluent.Runtime.CodeFluentReloadOptions)
            ...
            If (((options And CodeFluent.Runtime.CodeFluentReloadOptions.Properties)  _
                ...
                Me._pROPRIEDADE = CodeFluentPersistence.GetReaderValue(reader, "PROPRIEDADE", CType(CType(Nothing, String),String))
        ...
        Public Shared Function Load(ByVal pId As Long) As S5TUam.ENT_CAMBAL_FRENTESPROP
            If (pId = -1) Then
                Return Nothing
            End If
            Dim eNT_CAMBAL_FRENTESPROP As S5TUam.ENT_CAMBAL_FRENTESPROP = New S5TUam.ENT_CAMBAL_FRENTESPROP()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "ENT_CAMBAL_FRENTESPROP", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    eNT_CAMBAL_FRENTESPROP.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5TUam.ENT_CAMBAL_FRENTESPROP
            If (pId = -1) Then
                Return Nothing
            End If
            Dim eNT_CAMBAL_FRENTESPROP As S5TUam.ENT_CAMBAL_FRENTESPROP = New S5TUam.ENT_CAMBAL_FRENTESPROP()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "ENT_CAMBAL_FRENTESPROP", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5TUam.ENT_CAMBAL_FRENTESPROP.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "ENT_CAMBAL_FRENTESPROP", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
            ...
            persistence.AddParameter("@PROPRIEDADE", Me.PROPRIEDADE, CType(Nothing, String))
        ...
        Public Overloads Shared Function Save(ByVal eNT_CAMBAL_FRENTESPROP As S5TUam.ENT_CAMBAL_FRENTESPROP) As Boolean
            If (eNT_CAMBAL_FRENTESPROP Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal eNT_CAMBAL_FRENTESPROP As S5TUam.ENT_CAMBAL_FRENTESPROP) As Boolean
            Dim ret As Boolean = S5TUam.ENT_CAMBAL_FRENTESPROP.Save(eNT_CAMBAL_FRENTESPROP)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal eNT_CAMBAL_FRENTESPROP As S5TUam.ENT_CAMBAL_FRENTESPROP) As Boolean
            If (eNT_CAMBAL_FRENTESPROP Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5TUam.ENT_CAMBAL_FRENTESPROP
            ...
            eNT_CAMBAL_FRENTESPROP = S5TUam.ENT_CAMBAL_FRENTESPROP.Load(var)
            Return eNT_CAMBAL_FRENTESPROP
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5TUam.ENT_CAMBAL_FRENTESPROP
            Dim eNT_CAMBAL_FRENTESPROP As S5TUam.ENT_CAMBAL_FRENTESPROP = New S5TUam.ENT_CAMBAL_FRENTESPROP()
            Me.CopyTo(eNT_CAMBAL_FRENTESPROP, deep)
            Return eNT_CAMBAL_FRENTESPROP
        End Function
        
        Public Overloads Function Clone() As S5TUam.ENT_CAMBAL_FRENTESPROP
            Dim localClone As S5TUam.ENT_CAMBAL_FRENTESPROP = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overridable Sub CopyFrom(ByVal dict As System.Collections.IDictionary, ByVal deep As Boolean)
            ...
            If (dict.Contains("PROPRIEDADE") = true) Then
                Me.PROPRIEDADE = CType(ConvertUtilities.ChangeType(dict("PROPRIEDADE"), GetType(String), CType(Nothing, String)),String)
            End If
        ...
        Public Overloads Overridable Sub CopyTo(ByVal eNT_CAMBAL_FRENTESPROP As S5TUam.ENT_CAMBAL_FRENTESPROP, ByVal deep As Boolean)
            If (eNT_CAMBAL_FRENTESPROP Is Nothing) Then
                Throw New System.ArgumentNullException("eNT_CAMBAL_FRENTESPROP")
            End If
            eNT_CAMBAL_FRENTESPROP.pId = Me.pId
            eNT_CAMBAL_FRENTESPROP.PROPRIEDADE = Me.PROPRIEDADE
            eNT_CAMBAL_FRENTESPROP.QTD_VIAGENS = Me.QTD_VIAGENS
            eNT_CAMBAL_FRENTESPROP.COD_PROP = Me.COD_PROP
            eNT_CAMBAL_FRENTESPROP.ROWNUM = Me.ROWNUM
            eNT_CAMBAL_FRENTESPROP.FRENTE = Me.FRENTE
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, eNT_CAMBAL_FRENTESPROP))
        End Sub
