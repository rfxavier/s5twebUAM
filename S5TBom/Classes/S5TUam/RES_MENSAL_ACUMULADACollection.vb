...
Namespace S5TUam
    ...
    Partial Public Class RES_MENSAL_ACUMULADACollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of S5TUam.RES_MENSAL_ACUMULADA), System.Collections.Generic.ICollection(Of S5TUam.RES_MENSAL_ACUMULADA), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of S5TUam.RES_MENSAL_ACUMULADA) = New System.Collections.Generic.List(Of S5TUam.RES_MENSAL_ACUMULADA)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of Long, S5TUam.RES_MENSAL_ACUMULADA) = New System.Collections.Generic.Dictionary(Of Long, S5TUam.RES_MENSAL_ACUMULADA)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _blm3163213606 As CodeFluent.Runtime.Utilities.BindingListManager(Of S5TUam.RES_MENSAL_ACUMULADA)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm3163213606 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5TUam.RES_MENSAL_ACUMULADA)(Me)
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of S5TUam.RES_MENSAL_ACUMULADA)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of Long, S5TUam.RES_MENSAL_ACUMULADA)
            Get
        ...
        Public Overloads Default Property Item(ByVal index As Integer) As S5TUam.RES_MENSAL_ACUMULADA Implements System.Collections.Generic.IList(Of S5TUam.RES_MENSAL_ACUMULADA).Item
            Get
                Return CType(Me.BaseList(index),S5TUam.RES_MENSAL_ACUMULADA)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,S5TUam.RES_MENSAL_ACUMULADA)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal pId As Long) As S5TUam.RES_MENSAL_ACUMULADA
            Get
                If (pId = -1) Then
                    Throw New System.ArgumentNullException("pId")
                End If
                Dim i As S5TUam.RES_MENSAL_ACUMULADA = Me.TryGetValue(pId)
                Return i
            End Get
            Set
                If (pId = -1) Then
                ...
                If (value Is Nothing) Then
                    Dim rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA = Me.TryGetValue(pId)
                    If (Not (rES_MENSAL_ACUMULADA) Is Nothing) Then
                        Me.Remove(rES_MENSAL_ACUMULADA)
                    End If
                    Return
                End If
                Dim existing As S5TUam.RES_MENSAL_ACUMULADA = Me.TryGetValue(value.pId)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of S5TUam.RES_MENSAL_ACUMULADA).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of S5TUam.RES_MENSAL_ACUMULADA).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm3163213606.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm3163213606.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As S5TUam.RES_MENSAL_ACUMULADA, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(rES_MENSAL_ACUMULADA)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA) As Integer
            If (rES_MENSAL_ACUMULADA Is Nothing) Then
                Throw New System.ArgumentNullException("rES_MENSAL_ACUMULADA")
            End If
            If (rES_MENSAL_ACUMULADA.pId = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "pId", "rES_MENSAL_ACUMULADA", "S5TUam.RES_MENSAL_ACUMULADA")
            End If
            Try 
                Me.BaseTable.Add(rES_MENSAL_ACUMULADA.pId, rES_MENSAL_ACUMULADA)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5TUam.RES_MENSAL_ACUMULADACollection", rES_MENSAL_ACUMULADA.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5TUam.RES_MENSAL_ACUMULADACollection", rES_MENSAL_ACUMULADA.pId), ae)
            End Try
            AddHandler rES_MENSAL_ACUMULADA.KeyChanged, AddressOf Me.OnItemKeyChanged
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(rES_MENSAL_ACUMULADA)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, rES_MENSAL_ACUMULADA, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            Dim rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA = Nothing
            Try 
                rES_MENSAL_ACUMULADA = CType(value,S5TUam.RES_MENSAL_ACUMULADA)
            Catch icex As System.InvalidCastException
                rES_MENSAL_ACUMULADA = Nothing
            ...
            If (rES_MENSAL_ACUMULADA Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(rES_MENSAL_ACUMULADA)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_S5TUam_RES_MENSAL_ACUMULADA__Add(ByVal rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA) Implements System.Collections.Generic.ICollection(Of S5TUam.RES_MENSAL_ACUMULADA).Add
            Me.BaseAdd(rES_MENSAL_ACUMULADA)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As S5TUam.RES_MENSAL_ACUMULADA
            Dim rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA = S5TUam.RES_MENSAL_ACUMULADA.LoadByEntityKey(key)
            If ((Not (rES_MENSAL_ACUMULADA) Is Nothing)  _
                        AndAlso (Me.Contains(rES_MENSAL_ACUMULADA) = false)) Then
                Me.Add(rES_MENSAL_ACUMULADA)
            End If
            Return rES_MENSAL_ACUMULADA
        End Function
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of S5TUam.RES_MENSAL_ACUMULADA))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As S5TUam.RES_MENSAL_ACUMULADA, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of S5TUam.RES_MENSAL_ACUMULADA).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As S5TUam.RES_MENSAL_ACUMULADA, ByVal index As Integer)
        ...
        Public Function Contains(ByVal rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA) As Boolean Implements System.Collections.Generic.ICollection(Of S5TUam.RES_MENSAL_ACUMULADA).Contains
            Dim localContains As Boolean = Me.BaseContains(rES_MENSAL_ACUMULADA)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA) As Boolean
            If (rES_MENSAL_ACUMULADA Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(rES_MENSAL_ACUMULADA.pId)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            Dim rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA
            Try 
                rES_MENSAL_ACUMULADA = CType(value,S5TUam.RES_MENSAL_ACUMULADA)
            Catch icex As System.InvalidCastException
                rES_MENSAL_ACUMULADA = Nothing
            End Try
            Return Me.Contains(rES_MENSAL_ACUMULADA)
        End Function
        
        Public Function IndexOf(ByVal rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA) As Integer Implements System.Collections.Generic.IList(Of S5TUam.RES_MENSAL_ACUMULADA).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(rES_MENSAL_ACUMULADA)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA) As Integer
            If (rES_MENSAL_ACUMULADA Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(rES_MENSAL_ACUMULADA)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                rES_MENSAL_ACUMULADA = Nothing
            End Try
            Return Me.IndexOf(rES_MENSAL_ACUMULADA)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA) Implements System.Collections.Generic.IList(Of S5TUam.RES_MENSAL_ACUMULADA).Insert
            Me.BaseInsert(index, rES_MENSAL_ACUMULADA)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA)
            If (rES_MENSAL_ACUMULADA Is Nothing) Then
                Throw New System.ArgumentNullException("rES_MENSAL_ACUMULADA")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5TUam.RES_MENSAL_ACUMULADACollection", rES_MENSAL_ACUMULADA.pId), ae)
            End Try
            Me.BaseList.Insert(index, rES_MENSAL_ACUMULADA)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, rES_MENSAL_ACUMULADA, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                rES_MENSAL_ACUMULADA = Nothing
            End Try
            Me.Insert(index, rES_MENSAL_ACUMULADA)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of S5TUam.RES_MENSAL_ACUMULADA).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim RES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA = Me(0)
                Me.BaseRemove(RES_MENSAL_ACUMULADA)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA) As Boolean Implements System.Collections.Generic.ICollection(Of S5TUam.RES_MENSAL_ACUMULADA).Remove
            Return Me.BaseRemove(rES_MENSAL_ACUMULADA)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA) As Boolean
            If (rES_MENSAL_ACUMULADA Is Nothing) Then
                Throw New System.ArgumentNullException("rES_MENSAL_ACUMULADA")
            End If
            Dim index As Integer = Me.IndexOf(rES_MENSAL_ACUMULADA)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5TUam.RES_MENSAL_ACUMULADA).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(rES_MENSAL_ACUMULADA)
            RemoveHandler rES_MENSAL_ACUMULADA.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(rES_MENSAL_ACUMULADA.pId)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, rES_MENSAL_ACUMULADA, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of S5TUam.RES_MENSAL_ACUMULADA).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5TUam.RES_MENSAL_ACUMULADA).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA = Me.BaseList(index)
            If (Not (rES_MENSAL_ACUMULADA) Is Nothing) Then
                RemoveHandler rES_MENSAL_ACUMULADA.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(rES_MENSAL_ACUMULADA.pId)
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of S5TUam.RES_MENSAL_ACUMULADA) Implements System.Collections.Generic.IEnumerable(Of S5TUam.RES_MENSAL_ACUMULADA).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of S5TUam.RES_MENSAL_ACUMULADA) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As Long) As S5TUam.RES_MENSAL_ACUMULADA
            Dim rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA = Nothing
            If (Me.BaseTable.TryGetValue(key, rES_MENSAL_ACUMULADA) = true) Then
                Return rES_MENSAL_ACUMULADA
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA = Me(index)
                rES_MENSAL_ACUMULADA.Save
                If (rES_MENSAL_ACUMULADA.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(rES_MENSAL_ACUMULADA)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    Dim rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA = New S5TUam.RES_MENSAL_ACUMULADA()
                    CType(rES_MENSAL_ACUMULADA,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(rES_MENSAL_ACUMULADA) = false) Then
                        Me.BaseAdd(rES_MENSAL_ACUMULADA)
                        count = (count + 1)
                    End If
                    rES_MENSAL_ACUMULADA.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Unchanged
                End If
                readerRead = reader.Read
            Loop
        End Sub
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As S5TUam.RES_MENSAL_ACUMULADACollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As S5TUam.RES_MENSAL_ACUMULADACollection = New S5TUam.RES_MENSAL_ACUMULADACollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5TUam.RES_MENSAL_ACUMULADACollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As S5TUam.RES_MENSAL_ACUMULADACollection
            Dim ret As S5TUam.RES_MENSAL_ACUMULADACollection = S5TUam.RES_MENSAL_ACUMULADACollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "RES_MENSAL_ACUMULADA", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5TUam.RES_MENSAL_ACUMULADACollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As S5TUam.RES_MENSAL_ACUMULADACollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(S5TUam.RES_MENSAL_ACUMULADA)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of S5TUam.RES_MENSAL_ACUMULADA) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,S5TUam.RES_MENSAL_ACUMULADA))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As S5TUam.RES_MENSAL_ACUMULADACollection
            Dim ret As S5TUam.RES_MENSAL_ACUMULADACollection = New S5TUam.RES_MENSAL_ACUMULADACollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm3163213606.AddIndex([property])
        End Sub
        ...
        Private Function AddNew() As Object Implements System.ComponentModel.IBindingList.AddNew
            Dim add As S5TUam.RES_MENSAL_ACUMULADA = New S5TUam.RES_MENSAL_ACUMULADA()
            Dim e As System.ComponentModel.AddingNewEventArgs = New System.ComponentModel.AddingNewEventArgs(add)
            Me.OnAddingNew(e)
            add = CType(e.NewObject,S5TUam.RES_MENSAL_ACUMULADA)
            If (add Is Nothing) Then
                add = New S5TUam.RES_MENSAL_ACUMULADA()
            End If
            add.pId = 0
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm3163213606.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm3163213606.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of S5TUam.RES_MENSAL_ACUMULADA))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of Long))
            If (e Is Nothing) Then
                Throw New System.ArgumentNullException("e")
            End If
            Dim existing As S5TUam.RES_MENSAL_ACUMULADA = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5TUam.RES_MENSAL_ACUMULADACollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5TUam.RES_MENSAL_ACUMULADACollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As S5TUam.RES_MENSAL_ACUMULADACollection
            Return S5TUam.RES_MENSAL_ACUMULADACollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA) As Boolean
            If (rES_MENSAL_ACUMULADA Is Nothing) Then
                Return false
            End If
            Dim ret As Boolean = rES_MENSAL_ACUMULADA.Save
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Shared Function Insert(ByVal rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA) As Boolean
            Dim ret As Boolean = S5TUam.RES_MENSAL_ACUMULADA.Save(rES_MENSAL_ACUMULADA)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA) As Boolean
            If (rES_MENSAL_ACUMULADA Is Nothing) Then
                Return false
            End If
            Dim ret As Boolean = rES_MENSAL_ACUMULADA.Delete
            Return ret
        End Function
    End Class
End Namespace
