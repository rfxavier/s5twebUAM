...
Namespace S5TUam
    ...
    Partial Public Class ACOMP_PROD_DCORTE_TALHAO
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5TUam.ACOMP_PROD_DCORTE_TALHAO), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5TUam.ACOMP_PROD_DCORTE_TALHAO)
        ...
        Private _dT_COLHEITA_ATUAL As Date = CodeFluentPersistence.DefaultDateTimeValue
        ...
        Public Property DT_COLHEITA_ATUAL() As Date
            Get
                Return Me._dT_COLHEITA_ATUAL
            End Get
            Set
                Me._dT_COLHEITA_ATUAL = value
                Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Modified
                Me.OnPropertyChanged(New System.ComponentModel.PropertyChangedEventArgs("DT_COLHEITA_ATUAL"))
            End Set
        End Property
        ...
        Public Overloads Overridable Function Equals(ByVal aCOMP_PROD_DCORTE_TALHAO As S5TUam.ACOMP_PROD_DCORTE_TALHAO) As Boolean Implements System.IEquatable(Of S5TUam.ACOMP_PROD_DCORTE_TALHAO).Equals
            If (aCOMP_PROD_DCORTE_TALHAO Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(aCOMP_PROD_DCORTE_TALHAO)
            End If
            Return (Me.pId.Equals(aCOMP_PROD_DCORTE_TALHAO.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                aCOMP_PROD_DCORTE_TALHAO = CType(obj,S5TUam.ACOMP_PROD_DCORTE_TALHAO)
            Catch icex As System.InvalidCastException
                aCOMP_PROD_DCORTE_TALHAO = Nothing
            End Try
            Return Me.Equals(aCOMP_PROD_DCORTE_TALHAO)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(aCOMP_PROD_DCORTE_TALHAO)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal aCOMP_PROD_DCORTE_TALHAO As S5TUam.ACOMP_PROD_DCORTE_TALHAO) As Integer Implements System.IComparable(Of S5TUam.ACOMP_PROD_DCORTE_TALHAO).CompareTo
            If (aCOMP_PROD_DCORTE_TALHAO Is Nothing) Then
                Throw New System.ArgumentNullException("aCOMP_PROD_DCORTE_TALHAO")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(aCOMP_PROD_DCORTE_TALHAO.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5TUam.ACOMP_PROD_DCORTE_TALHAO.ExternalValidate", "Type 'S5TUam.ACOMP_PROD_DCORTE_TALHAO' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "ACOMP_PROD_DCORTE_TALHAO", "Delete")
        ...
        Protected Overridable Sub ReadRecord(ByVal reader As System.Data.IDataReader, ByVal options As CodeFluent.Runtime.CodeFluentReloadOptions)
            ...
            If (((options And CodeFluent.Runtime.CodeFluentReloadOptions.Properties)  _
                ...
                Me._dT_COLHEITA_ATUAL = CodeFluentPersistence.GetReaderValue(reader, "DT_COLHEITA_ATUAL", CType(CodeFluentPersistence.DefaultDateTimeValue,Date))
        ...
        Public Shared Function Load(ByVal pId As Long) As S5TUam.ACOMP_PROD_DCORTE_TALHAO
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aCOMP_PROD_DCORTE_TALHAO As S5TUam.ACOMP_PROD_DCORTE_TALHAO = New S5TUam.ACOMP_PROD_DCORTE_TALHAO()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "ACOMP_PROD_DCORTE_TALHAO", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    aCOMP_PROD_DCORTE_TALHAO.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5TUam.ACOMP_PROD_DCORTE_TALHAO
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aCOMP_PROD_DCORTE_TALHAO As S5TUam.ACOMP_PROD_DCORTE_TALHAO = New S5TUam.ACOMP_PROD_DCORTE_TALHAO()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "ACOMP_PROD_DCORTE_TALHAO", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5TUam.ACOMP_PROD_DCORTE_TALHAO.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "ACOMP_PROD_DCORTE_TALHAO", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
            ...
            persistence.AddParameter("@DT_COLHEITA_ATUAL", Me.DT_COLHEITA_ATUAL, CodeFluentPersistence.DefaultDateTimeValue)
        ...
        Public Overloads Shared Function Save(ByVal aCOMP_PROD_DCORTE_TALHAO As S5TUam.ACOMP_PROD_DCORTE_TALHAO) As Boolean
            If (aCOMP_PROD_DCORTE_TALHAO Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal aCOMP_PROD_DCORTE_TALHAO As S5TUam.ACOMP_PROD_DCORTE_TALHAO) As Boolean
            Dim ret As Boolean = S5TUam.ACOMP_PROD_DCORTE_TALHAO.Save(aCOMP_PROD_DCORTE_TALHAO)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal aCOMP_PROD_DCORTE_TALHAO As S5TUam.ACOMP_PROD_DCORTE_TALHAO) As Boolean
            If (aCOMP_PROD_DCORTE_TALHAO Is Nothing) Then
                Return false
            End If
        ...
        Protected Overridable Sub BaseTrace(ByVal writer As System.CodeDom.Compiler.IndentedTextWriter)
            ...
            writer.Write(",")
            writer.Write("DT_COLHEITA_ATUAL=")
            writer.Write(Me.DT_COLHEITA_ATUAL)
            writer.Write(",")
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5TUam.ACOMP_PROD_DCORTE_TALHAO
            ...
            aCOMP_PROD_DCORTE_TALHAO = S5TUam.ACOMP_PROD_DCORTE_TALHAO.Load(var)
            Return aCOMP_PROD_DCORTE_TALHAO
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5TUam.ACOMP_PROD_DCORTE_TALHAO
            Dim aCOMP_PROD_DCORTE_TALHAO As S5TUam.ACOMP_PROD_DCORTE_TALHAO = New S5TUam.ACOMP_PROD_DCORTE_TALHAO()
            Me.CopyTo(aCOMP_PROD_DCORTE_TALHAO, deep)
            Return aCOMP_PROD_DCORTE_TALHAO
        End Function
        
        Public Overloads Function Clone() As S5TUam.ACOMP_PROD_DCORTE_TALHAO
            Dim localClone As S5TUam.ACOMP_PROD_DCORTE_TALHAO = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overridable Sub CopyFrom(ByVal dict As System.Collections.IDictionary, ByVal deep As Boolean)
            ...
            End If
            If (dict.Contains("DT_COLHEITA_ATUAL") = true) Then
                Me.DT_COLHEITA_ATUAL = CType(ConvertUtilities.ChangeType(dict("DT_COLHEITA_ATUAL"), GetType(Date), CodeFluentPersistence.DefaultDateTimeValue),Date)
            End If
        ...
        Public Overloads Overridable Sub CopyTo(ByVal aCOMP_PROD_DCORTE_TALHAO As S5TUam.ACOMP_PROD_DCORTE_TALHAO, ByVal deep As Boolean)
            If (aCOMP_PROD_DCORTE_TALHAO Is Nothing) Then
                Throw New System.ArgumentNullException("aCOMP_PROD_DCORTE_TALHAO")
            End If
            aCOMP_PROD_DCORTE_TALHAO.pId = Me.pId
            aCOMP_PROD_DCORTE_TALHAO.DT_ADUBACAO = Me.DT_ADUBACAO
            aCOMP_PROD_DCORTE_TALHAO.DIF_DIAS_ADUB = Me.DIF_DIAS_ADUB
            aCOMP_PROD_DCORTE_TALHAO.TIPO_HERBICIDA = Me.TIPO_HERBICIDA
            aCOMP_PROD_DCORTE_TALHAO.PERDAS = Me.PERDAS
            aCOMP_PROD_DCORTE_TALHAO.DT_COLHEITA_ANTERIOR = Me.DT_COLHEITA_ANTERIOR
            aCOMP_PROD_DCORTE_TALHAO.TIPO_ADUBACAO = Me.TIPO_ADUBACAO
            aCOMP_PROD_DCORTE_TALHAO.DT_HERBICIDA = Me.DT_HERBICIDA
            aCOMP_PROD_DCORTE_TALHAO.FERTIRRIGACAO = Me.FERTIRRIGACAO
            aCOMP_PROD_DCORTE_TALHAO.DT_FERTIRRIGACAO = Me.DT_FERTIRRIGACAO
            aCOMP_PROD_DCORTE_TALHAO.SEMANA_ENCERRAMENTO = Me.SEMANA_ENCERRAMENTO
            aCOMP_PROD_DCORTE_TALHAO.DIF_DIAS_HERB = Me.DIF_DIAS_HERB
            aCOMP_PROD_DCORTE_TALHAO.INCENDIO = Me.INCENDIO
            aCOMP_PROD_DCORTE_TALHAO.DATA_INCENDIO = Me.DATA_INCENDIO
            aCOMP_PROD_DCORTE_TALHAO.PORC_BROCA = Me.PORC_BROCA
            aCOMP_PROD_DCORTE_TALHAO.TALHAO = Me.TALHAO
            aCOMP_PROD_DCORTE_TALHAO.NRO_CORTE = Me.NRO_CORTE
            aCOMP_PROD_DCORTE_TALHAO.QT_AREA_COLHIDA = Me.QT_AREA_COLHIDA
            aCOMP_PROD_DCORTE_TALHAO.ROWNUM = Me.ROWNUM
            aCOMP_PROD_DCORTE_TALHAO.PROP_CODIGO = Me.PROP_CODIGO
            aCOMP_PROD_DCORTE_TALHAO.DS_NOME_PROPRIEDADE = Me.DS_NOME_PROPRIEDADE
            aCOMP_PROD_DCORTE_TALHAO.IDADE = Me.IDADE
            aCOMP_PROD_DCORTE_TALHAO.RENDIMENTO_PLAN = Me.RENDIMENTO_PLAN
            aCOMP_PROD_DCORTE_TALHAO.RENDIMENTO_REAL = Me.RENDIMENTO_REAL
            aCOMP_PROD_DCORTE_TALHAO.DESVIO = Me.DESVIO
            aCOMP_PROD_DCORTE_TALHAO.TIPO_PROPRIEDADE = Me.TIPO_PROPRIEDADE
            aCOMP_PROD_DCORTE_TALHAO.DT_COLHEITA_ATUAL = Me.DT_COLHEITA_ATUAL
            aCOMP_PROD_DCORTE_TALHAO.QT_TON_ENTREGUE = Me.QT_TON_ENTREGUE
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, aCOMP_PROD_DCORTE_TALHAO))
        End Sub
        ...
        Public Overloads Overridable Sub CopyTo(ByVal dict As System.Collections.IDictionary, ByVal deep As Boolean)
            ...
            dict("DT_COLHEITA_ATUAL") = Me.DT_COLHEITA_ATUAL
