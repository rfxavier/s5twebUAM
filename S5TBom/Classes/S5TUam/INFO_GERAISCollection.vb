...
Namespace S5TUam
    ...
    Partial Public Class INFO_GERAISCollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of S5TUam.INFO_GERAIS), System.Collections.Generic.ICollection(Of S5TUam.INFO_GERAIS), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of S5TUam.INFO_GERAIS) = New System.Collections.Generic.List(Of S5TUam.INFO_GERAIS)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of Long, S5TUam.INFO_GERAIS) = New System.Collections.Generic.Dictionary(Of Long, S5TUam.INFO_GERAIS)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _blm1767463046 As CodeFluent.Runtime.Utilities.BindingListManager(Of S5TUam.INFO_GERAIS)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm1767463046 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5TUam.INFO_GERAIS)(Me)
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of S5TUam.INFO_GERAIS)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of Long, S5TUam.INFO_GERAIS)
            Get
        ...
        Public Overloads Default Property Item(ByVal index As Integer) As S5TUam.INFO_GERAIS Implements System.Collections.Generic.IList(Of S5TUam.INFO_GERAIS).Item
            Get
                Return CType(Me.BaseList(index),S5TUam.INFO_GERAIS)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,S5TUam.INFO_GERAIS)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal pId As Long) As S5TUam.INFO_GERAIS
            Get
                If (pId = -1) Then
                    Throw New System.ArgumentNullException("pId")
                End If
                Dim i As S5TUam.INFO_GERAIS = Me.TryGetValue(pId)
                Return i
            End Get
            Set
                If (pId = -1) Then
                ...
                If (value Is Nothing) Then
                    Dim iNFO_GERAIS As S5TUam.INFO_GERAIS = Me.TryGetValue(pId)
                    If (Not (iNFO_GERAIS) Is Nothing) Then
                        Me.Remove(iNFO_GERAIS)
                    End If
                    Return
                End If
                Dim existing As S5TUam.INFO_GERAIS = Me.TryGetValue(value.pId)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of S5TUam.INFO_GERAIS).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of S5TUam.INFO_GERAIS).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm1767463046.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm1767463046.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As S5TUam.INFO_GERAIS, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal iNFO_GERAIS As S5TUam.INFO_GERAIS) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(iNFO_GERAIS)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal iNFO_GERAIS As S5TUam.INFO_GERAIS) As Integer
            If (iNFO_GERAIS Is Nothing) Then
                Throw New System.ArgumentNullException("iNFO_GERAIS")
            End If
            If (iNFO_GERAIS.pId = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "pId", "iNFO_GERAIS", "S5TUam.INFO_GERAIS")
            End If
            Try 
                Me.BaseTable.Add(iNFO_GERAIS.pId, iNFO_GERAIS)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5TUam.INFO_GERAISCollection", iNFO_GERAIS.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5TUam.INFO_GERAISCollection", iNFO_GERAIS.pId), ae)
            End Try
            AddHandler iNFO_GERAIS.KeyChanged, AddressOf Me.OnItemKeyChanged
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(iNFO_GERAIS)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, iNFO_GERAIS, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            ...
            If (iNFO_GERAIS Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(iNFO_GERAIS)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_S5TUam_INFO_GERAIS__Add(ByVal iNFO_GERAIS As S5TUam.INFO_GERAIS) Implements System.Collections.Generic.ICollection(Of S5TUam.INFO_GERAIS).Add
            Me.BaseAdd(iNFO_GERAIS)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As S5TUam.INFO_GERAIS
            Dim iNFO_GERAIS As S5TUam.INFO_GERAIS = S5TUam.INFO_GERAIS.LoadByEntityKey(key)
            If ((Not (iNFO_GERAIS) Is Nothing)  _
                        AndAlso (Me.Contains(iNFO_GERAIS) = false)) Then
                Me.Add(iNFO_GERAIS)
            End If
            Return iNFO_GERAIS
        End Function
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of S5TUam.INFO_GERAIS))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As S5TUam.INFO_GERAIS, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of S5TUam.INFO_GERAIS).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As S5TUam.INFO_GERAIS, ByVal index As Integer)
        ...
        Public Function Contains(ByVal iNFO_GERAIS As S5TUam.INFO_GERAIS) As Boolean Implements System.Collections.Generic.ICollection(Of S5TUam.INFO_GERAIS).Contains
            Dim localContains As Boolean = Me.BaseContains(iNFO_GERAIS)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal iNFO_GERAIS As S5TUam.INFO_GERAIS) As Boolean
            If (iNFO_GERAIS Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(iNFO_GERAIS.pId)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            ...
            Catch icex As System.InvalidCastException
                iNFO_GERAIS = Nothing
            End Try
            Return Me.Contains(iNFO_GERAIS)
        End Function
        
        Public Function IndexOf(ByVal iNFO_GERAIS As S5TUam.INFO_GERAIS) As Integer Implements System.Collections.Generic.IList(Of S5TUam.INFO_GERAIS).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(iNFO_GERAIS)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal iNFO_GERAIS As S5TUam.INFO_GERAIS) As Integer
            If (iNFO_GERAIS Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(iNFO_GERAIS)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                iNFO_GERAIS = Nothing
            End Try
            Return Me.IndexOf(iNFO_GERAIS)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal iNFO_GERAIS As S5TUam.INFO_GERAIS) Implements System.Collections.Generic.IList(Of S5TUam.INFO_GERAIS).Insert
            Me.BaseInsert(index, iNFO_GERAIS)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal iNFO_GERAIS As S5TUam.INFO_GERAIS)
            If (iNFO_GERAIS Is Nothing) Then
                Throw New System.ArgumentNullException("iNFO_GERAIS")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5TUam.INFO_GERAISCollection", iNFO_GERAIS.pId), ae)
            End Try
            Me.BaseList.Insert(index, iNFO_GERAIS)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, iNFO_GERAIS, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                iNFO_GERAIS = Nothing
            End Try
            Me.Insert(index, iNFO_GERAIS)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of S5TUam.INFO_GERAIS).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim INFO_GERAIS As S5TUam.INFO_GERAIS = Me(0)
                Me.BaseRemove(INFO_GERAIS)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal iNFO_GERAIS As S5TUam.INFO_GERAIS) As Boolean Implements System.Collections.Generic.ICollection(Of S5TUam.INFO_GERAIS).Remove
            Return Me.BaseRemove(iNFO_GERAIS)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal iNFO_GERAIS As S5TUam.INFO_GERAIS) As Boolean
            If (iNFO_GERAIS Is Nothing) Then
                Throw New System.ArgumentNullException("iNFO_GERAIS")
            End If
            Dim index As Integer = Me.IndexOf(iNFO_GERAIS)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5TUam.INFO_GERAIS).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(iNFO_GERAIS)
            RemoveHandler iNFO_GERAIS.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(iNFO_GERAIS.pId)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, iNFO_GERAIS, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of S5TUam.INFO_GERAIS).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5TUam.INFO_GERAIS).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim iNFO_GERAIS As S5TUam.INFO_GERAIS = Me.BaseList(index)
            If (Not (iNFO_GERAIS) Is Nothing) Then
                RemoveHandler iNFO_GERAIS.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(iNFO_GERAIS.pId)
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of S5TUam.INFO_GERAIS) Implements System.Collections.Generic.IEnumerable(Of S5TUam.INFO_GERAIS).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of S5TUam.INFO_GERAIS) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As Long) As S5TUam.INFO_GERAIS
            Dim iNFO_GERAIS As S5TUam.INFO_GERAIS = Nothing
            If (Me.BaseTable.TryGetValue(key, iNFO_GERAIS) = true) Then
                Return iNFO_GERAIS
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim iNFO_GERAIS As S5TUam.INFO_GERAIS = Me(index)
                iNFO_GERAIS.Save
                If (iNFO_GERAIS.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(iNFO_GERAIS)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    ...
                    CType(iNFO_GERAIS,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(iNFO_GERAIS) = false) Then
                        Me.BaseAdd(iNFO_GERAIS)
                        count = (count + 1)
                    End If
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As S5TUam.INFO_GERAISCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As S5TUam.INFO_GERAISCollection = New S5TUam.INFO_GERAISCollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5TUam.INFO_GERAISCollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As S5TUam.INFO_GERAISCollection
            Dim ret As S5TUam.INFO_GERAISCollection = S5TUam.INFO_GERAISCollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "INFO_GERAIS", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5TUam.INFO_GERAISCollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As S5TUam.INFO_GERAISCollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(S5TUam.INFO_GERAIS)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of S5TUam.INFO_GERAIS) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,S5TUam.INFO_GERAIS))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As S5TUam.INFO_GERAISCollection
            Dim ret As S5TUam.INFO_GERAISCollection = New S5TUam.INFO_GERAISCollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm1767463046.AddIndex([property])
        End Sub
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm1767463046.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm1767463046.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of S5TUam.INFO_GERAIS))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of Long))
            If (e Is Nothing) Then
                Throw New System.ArgumentNullException("e")
            End If
            Dim existing As S5TUam.INFO_GERAIS = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5TUam.INFO_GERAISCollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5TUam.INFO_GERAISCollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As S5TUam.INFO_GERAISCollection
            Return S5TUam.INFO_GERAISCollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal iNFO_GERAIS As S5TUam.INFO_GERAIS) As Boolean
            If (iNFO_GERAIS Is Nothing) Then
                Return false
            End If
        ...
        Public Overloads Shared Function Insert(ByVal iNFO_GERAIS As S5TUam.INFO_GERAIS) As Boolean
            Dim ret As Boolean = S5TUam.INFO_GERAIS.Save(iNFO_GERAIS)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal iNFO_GERAIS As S5TUam.INFO_GERAIS) As Boolean
            If (iNFO_GERAIS Is Nothing) Then
                Return false
            End If
