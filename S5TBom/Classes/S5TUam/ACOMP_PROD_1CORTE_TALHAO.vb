...
Namespace S5TUam
    ...
    Partial Public Class ACOMP_PROD_1CORTE_TALHAO
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5TUam.ACOMP_PROD_1CORTE_TALHAO), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5TUam.ACOMP_PROD_1CORTE_TALHAO)
        ...
        Public Overloads Overridable Function Equals(ByVal aCOMP_PROD_1CORTE_TALHAO As S5TUam.ACOMP_PROD_1CORTE_TALHAO) As Boolean Implements System.IEquatable(Of S5TUam.ACOMP_PROD_1CORTE_TALHAO).Equals
            If (aCOMP_PROD_1CORTE_TALHAO Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(aCOMP_PROD_1CORTE_TALHAO)
            End If
            Return (Me.pId.Equals(aCOMP_PROD_1CORTE_TALHAO.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                aCOMP_PROD_1CORTE_TALHAO = CType(obj,S5TUam.ACOMP_PROD_1CORTE_TALHAO)
            Catch icex As System.InvalidCastException
                aCOMP_PROD_1CORTE_TALHAO = Nothing
            End Try
            Return Me.Equals(aCOMP_PROD_1CORTE_TALHAO)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(aCOMP_PROD_1CORTE_TALHAO)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal aCOMP_PROD_1CORTE_TALHAO As S5TUam.ACOMP_PROD_1CORTE_TALHAO) As Integer Implements System.IComparable(Of S5TUam.ACOMP_PROD_1CORTE_TALHAO).CompareTo
            If (aCOMP_PROD_1CORTE_TALHAO Is Nothing) Then
                Throw New System.ArgumentNullException("aCOMP_PROD_1CORTE_TALHAO")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(aCOMP_PROD_1CORTE_TALHAO.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5TUam.ACOMP_PROD_1CORTE_TALHAO.ExternalValidate", "Type 'S5TUam.ACOMP_PROD_1CORTE_TALHAO' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "ACOMP_PROD_1CORTE_TALHAO", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5TUam.ACOMP_PROD_1CORTE_TALHAO
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aCOMP_PROD_1CORTE_TALHAO As S5TUam.ACOMP_PROD_1CORTE_TALHAO = New S5TUam.ACOMP_PROD_1CORTE_TALHAO()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "ACOMP_PROD_1CORTE_TALHAO", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    aCOMP_PROD_1CORTE_TALHAO.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5TUam.ACOMP_PROD_1CORTE_TALHAO
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aCOMP_PROD_1CORTE_TALHAO As S5TUam.ACOMP_PROD_1CORTE_TALHAO = New S5TUam.ACOMP_PROD_1CORTE_TALHAO()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "ACOMP_PROD_1CORTE_TALHAO", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5TUam.ACOMP_PROD_1CORTE_TALHAO.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "ACOMP_PROD_1CORTE_TALHAO", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal aCOMP_PROD_1CORTE_TALHAO As S5TUam.ACOMP_PROD_1CORTE_TALHAO) As Boolean
            If (aCOMP_PROD_1CORTE_TALHAO Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal aCOMP_PROD_1CORTE_TALHAO As S5TUam.ACOMP_PROD_1CORTE_TALHAO) As Boolean
            Dim ret As Boolean = S5TUam.ACOMP_PROD_1CORTE_TALHAO.Save(aCOMP_PROD_1CORTE_TALHAO)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal aCOMP_PROD_1CORTE_TALHAO As S5TUam.ACOMP_PROD_1CORTE_TALHAO) As Boolean
            If (aCOMP_PROD_1CORTE_TALHAO Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5TUam.ACOMP_PROD_1CORTE_TALHAO
            ...
            aCOMP_PROD_1CORTE_TALHAO = S5TUam.ACOMP_PROD_1CORTE_TALHAO.Load(var)
            Return aCOMP_PROD_1CORTE_TALHAO
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5TUam.ACOMP_PROD_1CORTE_TALHAO
            Dim aCOMP_PROD_1CORTE_TALHAO As S5TUam.ACOMP_PROD_1CORTE_TALHAO = New S5TUam.ACOMP_PROD_1CORTE_TALHAO()
            Me.CopyTo(aCOMP_PROD_1CORTE_TALHAO, deep)
            Return aCOMP_PROD_1CORTE_TALHAO
        End Function
        
        Public Overloads Function Clone() As S5TUam.ACOMP_PROD_1CORTE_TALHAO
            Dim localClone As S5TUam.ACOMP_PROD_1CORTE_TALHAO = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal aCOMP_PROD_1CORTE_TALHAO As S5TUam.ACOMP_PROD_1CORTE_TALHAO, ByVal deep As Boolean)
            If (aCOMP_PROD_1CORTE_TALHAO Is Nothing) Then
                Throw New System.ArgumentNullException("aCOMP_PROD_1CORTE_TALHAO")
            End If
            aCOMP_PROD_1CORTE_TALHAO.pId = Me.pId
            aCOMP_PROD_1CORTE_TALHAO.DT_DESSECACAO = Me.DT_DESSECACAO
            aCOMP_PROD_1CORTE_TALHAO.DT_CALAGEM = Me.DT_CALAGEM
            aCOMP_PROD_1CORTE_TALHAO.DT_PLANTIO = Me.DT_PLANTIO
            aCOMP_PROD_1CORTE_TALHAO.PERDAS = Me.PERDAS
            aCOMP_PROD_1CORTE_TALHAO.INCENDIO = Me.INCENDIO
            aCOMP_PROD_1CORTE_TALHAO.DATA_INCENDIO = Me.DATA_INCENDIO
            aCOMP_PROD_1CORTE_TALHAO.TIPO_PLANTIO = Me.TIPO_PLANTIO
            aCOMP_PROD_1CORTE_TALHAO.TRAT_TOLETES = Me.TRAT_TOLETES
            aCOMP_PROD_1CORTE_TALHAO.DT_HERB_CANA_PLANTA = Me.DT_HERB_CANA_PLANTA
            aCOMP_PROD_1CORTE_TALHAO.SEMANA_ENCERRAMENTO = Me.SEMANA_ENCERRAMENTO
            aCOMP_PROD_1CORTE_TALHAO.EMPRESA_PLANTIO = Me.EMPRESA_PLANTIO
            aCOMP_PROD_1CORTE_TALHAO.STAND = Me.STAND
            aCOMP_PROD_1CORTE_TALHAO.TIPO_ADUBACAO = Me.TIPO_ADUBACAO
            aCOMP_PROD_1CORTE_TALHAO.TALHAO = Me.TALHAO
            aCOMP_PROD_1CORTE_TALHAO.NRO_CORTE = Me.NRO_CORTE
            aCOMP_PROD_1CORTE_TALHAO.QT_AREA_COLHIDA = Me.QT_AREA_COLHIDA
            aCOMP_PROD_1CORTE_TALHAO.ROWNUM = Me.ROWNUM
            aCOMP_PROD_1CORTE_TALHAO.PROP_CODIGO = Me.PROP_CODIGO
            aCOMP_PROD_1CORTE_TALHAO.DS_NOME_PROPRIEDADE = Me.DS_NOME_PROPRIEDADE
            aCOMP_PROD_1CORTE_TALHAO.IDADE = Me.IDADE
            aCOMP_PROD_1CORTE_TALHAO.RENDIMENTO_REAL = Me.RENDIMENTO_REAL
            aCOMP_PROD_1CORTE_TALHAO.DESVIO = Me.DESVIO
            aCOMP_PROD_1CORTE_TALHAO.PORC_BROCA = Me.PORC_BROCA
            aCOMP_PROD_1CORTE_TALHAO.TIPO_PROPRIEDADE = Me.TIPO_PROPRIEDADE
            aCOMP_PROD_1CORTE_TALHAO.QT_TON_ENTREGUE = Me.QT_TON_ENTREGUE
            aCOMP_PROD_1CORTE_TALHAO.RENDIMENTO_PLAN = Me.RENDIMENTO_PLAN
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, aCOMP_PROD_1CORTE_TALHAO))
        End Sub
