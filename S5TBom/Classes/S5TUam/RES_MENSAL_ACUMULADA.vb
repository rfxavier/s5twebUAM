...
Namespace S5TUam
    ...
    Partial Public Class RES_MENSAL_ACUMULADA
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5TUam.RES_MENSAL_ACUMULADA), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5TUam.RES_MENSAL_ACUMULADA)
        ...
        Public Overloads Overridable Function Equals(ByVal rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA) As Boolean Implements System.IEquatable(Of S5TUam.RES_MENSAL_ACUMULADA).Equals
            If (rES_MENSAL_ACUMULADA Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(rES_MENSAL_ACUMULADA)
            End If
            Return (Me.pId.Equals(rES_MENSAL_ACUMULADA.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                rES_MENSAL_ACUMULADA = CType(obj,S5TUam.RES_MENSAL_ACUMULADA)
            Catch icex As System.InvalidCastException
                rES_MENSAL_ACUMULADA = Nothing
            End Try
            Return Me.Equals(rES_MENSAL_ACUMULADA)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(rES_MENSAL_ACUMULADA)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA) As Integer Implements System.IComparable(Of S5TUam.RES_MENSAL_ACUMULADA).CompareTo
            If (rES_MENSAL_ACUMULADA Is Nothing) Then
                Throw New System.ArgumentNullException("rES_MENSAL_ACUMULADA")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(rES_MENSAL_ACUMULADA.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5TUam.RES_MENSAL_ACUMULADA.ExternalValidate", "Type 'S5TUam.RES_MENSAL_ACUMULADA' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "RES_MENSAL_ACUMULADA", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5TUam.RES_MENSAL_ACUMULADA
            If (pId = -1) Then
                Return Nothing
            End If
            Dim rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA = New S5TUam.RES_MENSAL_ACUMULADA()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "RES_MENSAL_ACUMULADA", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    rES_MENSAL_ACUMULADA.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5TUam.RES_MENSAL_ACUMULADA
            If (pId = -1) Then
                Return Nothing
            End If
            Dim rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA = New S5TUam.RES_MENSAL_ACUMULADA()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "RES_MENSAL_ACUMULADA", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5TUam.RES_MENSAL_ACUMULADA.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "RES_MENSAL_ACUMULADA", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA) As Boolean
            If (rES_MENSAL_ACUMULADA Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA) As Boolean
            Dim ret As Boolean = S5TUam.RES_MENSAL_ACUMULADA.Save(rES_MENSAL_ACUMULADA)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA) As Boolean
            If (rES_MENSAL_ACUMULADA Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5TUam.RES_MENSAL_ACUMULADA
            ...
            rES_MENSAL_ACUMULADA = S5TUam.RES_MENSAL_ACUMULADA.Load(var)
            Return rES_MENSAL_ACUMULADA
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5TUam.RES_MENSAL_ACUMULADA
            Dim rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA = New S5TUam.RES_MENSAL_ACUMULADA()
            Me.CopyTo(rES_MENSAL_ACUMULADA, deep)
            Return rES_MENSAL_ACUMULADA
        End Function
        
        Public Overloads Function Clone() As S5TUam.RES_MENSAL_ACUMULADA
            Dim localClone As S5TUam.RES_MENSAL_ACUMULADA = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal rES_MENSAL_ACUMULADA As S5TUam.RES_MENSAL_ACUMULADA, ByVal deep As Boolean)
            If (rES_MENSAL_ACUMULADA Is Nothing) Then
                Throw New System.ArgumentNullException("rES_MENSAL_ACUMULADA")
            End If
            rES_MENSAL_ACUMULADA.pId = Me.pId
            rES_MENSAL_ACUMULADA.TONELADA_PLAN_AC = Me.TONELADA_PLAN_AC
            rES_MENSAL_ACUMULADA.TONELADA_PLAN = Me.TONELADA_PLAN
            rES_MENSAL_ACUMULADA.TONELADA_REAL_AC = Me.TONELADA_REAL_AC
            rES_MENSAL_ACUMULADA.TONELADA_REAL = Me.TONELADA_REAL
            rES_MENSAL_ACUMULADA.NRO_ANO_SAFRA = Me.NRO_ANO_SAFRA
            rES_MENSAL_ACUMULADA.ID_NEGOCIOS = Me.ID_NEGOCIOS
            rES_MENSAL_ACUMULADA.DIA = Me.DIA
            rES_MENSAL_ACUMULADA.MES = Me.MES
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, rES_MENSAL_ACUMULADA))
        End Sub
