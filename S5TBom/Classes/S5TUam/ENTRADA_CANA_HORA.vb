...
Namespace S5TUam
    ...
    Partial Public Class ENTRADA_CANA_HORA
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5TUam.ENTRADA_CANA_HORA), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5TUam.ENTRADA_CANA_HORA)
        ...
        Public Overloads Overridable Function Equals(ByVal eNTRADA_CANA_HORA As S5TUam.ENTRADA_CANA_HORA) As Boolean Implements System.IEquatable(Of S5TUam.ENTRADA_CANA_HORA).Equals
            If (eNTRADA_CANA_HORA Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(eNTRADA_CANA_HORA)
            End If
            Return (Me.pId.Equals(eNTRADA_CANA_HORA.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                eNTRADA_CANA_HORA = CType(obj,S5TUam.ENTRADA_CANA_HORA)
            Catch icex As System.InvalidCastException
                eNTRADA_CANA_HORA = Nothing
            End Try
            Return Me.Equals(eNTRADA_CANA_HORA)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(eNTRADA_CANA_HORA)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal eNTRADA_CANA_HORA As S5TUam.ENTRADA_CANA_HORA) As Integer Implements System.IComparable(Of S5TUam.ENTRADA_CANA_HORA).CompareTo
            If (eNTRADA_CANA_HORA Is Nothing) Then
                Throw New System.ArgumentNullException("eNTRADA_CANA_HORA")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(eNTRADA_CANA_HORA.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5TUam.ENTRADA_CANA_HORA.ExternalValidate", "Type 'S5TUam.ENTRADA_CANA_HORA' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "ENTRADA_CANA_HORA", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5TUam.ENTRADA_CANA_HORA
            If (pId = -1) Then
                Return Nothing
            End If
            Dim eNTRADA_CANA_HORA As S5TUam.ENTRADA_CANA_HORA = New S5TUam.ENTRADA_CANA_HORA()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "ENTRADA_CANA_HORA", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    eNTRADA_CANA_HORA.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5TUam.ENTRADA_CANA_HORA
            If (pId = -1) Then
                Return Nothing
            End If
            Dim eNTRADA_CANA_HORA As S5TUam.ENTRADA_CANA_HORA = New S5TUam.ENTRADA_CANA_HORA()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "ENTRADA_CANA_HORA", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5TUam.ENTRADA_CANA_HORA.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "ENTRADA_CANA_HORA", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal eNTRADA_CANA_HORA As S5TUam.ENTRADA_CANA_HORA) As Boolean
            If (eNTRADA_CANA_HORA Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal eNTRADA_CANA_HORA As S5TUam.ENTRADA_CANA_HORA) As Boolean
            Dim ret As Boolean = S5TUam.ENTRADA_CANA_HORA.Save(eNTRADA_CANA_HORA)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal eNTRADA_CANA_HORA As S5TUam.ENTRADA_CANA_HORA) As Boolean
            If (eNTRADA_CANA_HORA Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5TUam.ENTRADA_CANA_HORA
            ...
            eNTRADA_CANA_HORA = S5TUam.ENTRADA_CANA_HORA.Load(var)
            Return eNTRADA_CANA_HORA
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5TUam.ENTRADA_CANA_HORA
            Dim eNTRADA_CANA_HORA As S5TUam.ENTRADA_CANA_HORA = New S5TUam.ENTRADA_CANA_HORA()
            Me.CopyTo(eNTRADA_CANA_HORA, deep)
            Return eNTRADA_CANA_HORA
        End Function
        
        Public Overloads Function Clone() As S5TUam.ENTRADA_CANA_HORA
            Dim localClone As S5TUam.ENTRADA_CANA_HORA = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal eNTRADA_CANA_HORA As S5TUam.ENTRADA_CANA_HORA, ByVal deep As Boolean)
            If (eNTRADA_CANA_HORA Is Nothing) Then
                Throw New System.ArgumentNullException("eNTRADA_CANA_HORA")
            End If
            eNTRADA_CANA_HORA.pId = Me.pId
            eNTRADA_CANA_HORA.VIAGEM = Me.VIAGEM
            eNTRADA_CANA_HORA.TON_VIAGEM = Me.TON_VIAGEM
            eNTRADA_CANA_HORA.METAFRENTE = Me.METAFRENTE
            eNTRADA_CANA_HORA.TONELADAS = Me.TONELADAS
            eNTRADA_CANA_HORA.ID_NEGOCIOS = Me.ID_NEGOCIOS
            eNTRADA_CANA_HORA.DIA = Me.DIA
            eNTRADA_CANA_HORA.HORA = Me.HORA
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, eNTRADA_CANA_HORA))
        End Sub
