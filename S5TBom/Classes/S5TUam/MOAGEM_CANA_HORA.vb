...
Namespace S5TUam
    ...
    Partial Public Class MOAGEM_CANA_HORA
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5TUam.MOAGEM_CANA_HORA), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5TUam.MOAGEM_CANA_HORA)
        ...
        Public Overloads Overridable Function Equals(ByVal mOAGEM_CANA_HORA As S5TUam.MOAGEM_CANA_HORA) As Boolean Implements System.IEquatable(Of S5TUam.MOAGEM_CANA_HORA).Equals
            If (mOAGEM_CANA_HORA Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(mOAGEM_CANA_HORA)
            End If
            Return (Me.pId.Equals(mOAGEM_CANA_HORA.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                mOAGEM_CANA_HORA = CType(obj,S5TUam.MOAGEM_CANA_HORA)
            Catch icex As System.InvalidCastException
                mOAGEM_CANA_HORA = Nothing
            End Try
            Return Me.Equals(mOAGEM_CANA_HORA)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(mOAGEM_CANA_HORA)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal mOAGEM_CANA_HORA As S5TUam.MOAGEM_CANA_HORA) As Integer Implements System.IComparable(Of S5TUam.MOAGEM_CANA_HORA).CompareTo
            If (mOAGEM_CANA_HORA Is Nothing) Then
                Throw New System.ArgumentNullException("mOAGEM_CANA_HORA")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(mOAGEM_CANA_HORA.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5TUam.MOAGEM_CANA_HORA.ExternalValidate", "Type 'S5TUam.MOAGEM_CANA_HORA' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "MOAGEM_CANA_HORA", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5TUam.MOAGEM_CANA_HORA
            If (pId = -1) Then
                Return Nothing
            End If
            Dim mOAGEM_CANA_HORA As S5TUam.MOAGEM_CANA_HORA = New S5TUam.MOAGEM_CANA_HORA()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "MOAGEM_CANA_HORA", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    mOAGEM_CANA_HORA.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5TUam.MOAGEM_CANA_HORA
            If (pId = -1) Then
                Return Nothing
            End If
            Dim mOAGEM_CANA_HORA As S5TUam.MOAGEM_CANA_HORA = New S5TUam.MOAGEM_CANA_HORA()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "MOAGEM_CANA_HORA", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5TUam.MOAGEM_CANA_HORA.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "MOAGEM_CANA_HORA", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal mOAGEM_CANA_HORA As S5TUam.MOAGEM_CANA_HORA) As Boolean
            If (mOAGEM_CANA_HORA Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal mOAGEM_CANA_HORA As S5TUam.MOAGEM_CANA_HORA) As Boolean
            Dim ret As Boolean = S5TUam.MOAGEM_CANA_HORA.Save(mOAGEM_CANA_HORA)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal mOAGEM_CANA_HORA As S5TUam.MOAGEM_CANA_HORA) As Boolean
            If (mOAGEM_CANA_HORA Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5TUam.MOAGEM_CANA_HORA
            ...
            mOAGEM_CANA_HORA = S5TUam.MOAGEM_CANA_HORA.Load(var)
            Return mOAGEM_CANA_HORA
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5TUam.MOAGEM_CANA_HORA
            Dim mOAGEM_CANA_HORA As S5TUam.MOAGEM_CANA_HORA = New S5TUam.MOAGEM_CANA_HORA()
            Me.CopyTo(mOAGEM_CANA_HORA, deep)
            Return mOAGEM_CANA_HORA
        End Function
        
        Public Overloads Function Clone() As S5TUam.MOAGEM_CANA_HORA
            Dim localClone As S5TUam.MOAGEM_CANA_HORA = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal mOAGEM_CANA_HORA As S5TUam.MOAGEM_CANA_HORA, ByVal deep As Boolean)
            If (mOAGEM_CANA_HORA Is Nothing) Then
                Throw New System.ArgumentNullException("mOAGEM_CANA_HORA")
            End If
            mOAGEM_CANA_HORA.pId = Me.pId
            mOAGEM_CANA_HORA.VIAGEM = Me.VIAGEM
            mOAGEM_CANA_HORA.TONELADAS = Me.TONELADAS
            mOAGEM_CANA_HORA.METAFRENTE = Me.METAFRENTE
            mOAGEM_CANA_HORA.ID_NEGOCIOS = Me.ID_NEGOCIOS
            mOAGEM_CANA_HORA.DIA = Me.DIA
            mOAGEM_CANA_HORA.HORA = Me.HORA
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, mOAGEM_CANA_HORA))
        End Sub
