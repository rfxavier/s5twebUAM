...
Namespace S5TUam
    ...
    Partial Public Class ENTRADA_CANA_DETCollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of S5TUam.ENTRADA_CANA_DET), System.Collections.Generic.ICollection(Of S5TUam.ENTRADA_CANA_DET), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of S5TUam.ENTRADA_CANA_DET) = New System.Collections.Generic.List(Of S5TUam.ENTRADA_CANA_DET)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of Long, S5TUam.ENTRADA_CANA_DET) = New System.Collections.Generic.Dictionary(Of Long, S5TUam.ENTRADA_CANA_DET)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _blm856981948 As CodeFluent.Runtime.Utilities.BindingListManager(Of S5TUam.ENTRADA_CANA_DET)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm856981948 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5TUam.ENTRADA_CANA_DET)(Me)
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of S5TUam.ENTRADA_CANA_DET)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of Long, S5TUam.ENTRADA_CANA_DET)
            Get
        ...
        Public Overloads Default Property Item(ByVal index As Integer) As S5TUam.ENTRADA_CANA_DET Implements System.Collections.Generic.IList(Of S5TUam.ENTRADA_CANA_DET).Item
            Get
                Return CType(Me.BaseList(index),S5TUam.ENTRADA_CANA_DET)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,S5TUam.ENTRADA_CANA_DET)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal pId As Long) As S5TUam.ENTRADA_CANA_DET
            Get
                If (pId = -1) Then
                    Throw New System.ArgumentNullException("pId")
                End If
                Dim i As S5TUam.ENTRADA_CANA_DET = Me.TryGetValue(pId)
                Return i
            End Get
            Set
                If (pId = -1) Then
                ...
                If (value Is Nothing) Then
                    Dim eNTRADA_CANA_DET As S5TUam.ENTRADA_CANA_DET = Me.TryGetValue(pId)
                    If (Not (eNTRADA_CANA_DET) Is Nothing) Then
                        Me.Remove(eNTRADA_CANA_DET)
                    End If
                    Return
                End If
                Dim existing As S5TUam.ENTRADA_CANA_DET = Me.TryGetValue(value.pId)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of S5TUam.ENTRADA_CANA_DET).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of S5TUam.ENTRADA_CANA_DET).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm856981948.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm856981948.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As S5TUam.ENTRADA_CANA_DET, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal eNTRADA_CANA_DET As S5TUam.ENTRADA_CANA_DET) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(eNTRADA_CANA_DET)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal eNTRADA_CANA_DET As S5TUam.ENTRADA_CANA_DET) As Integer
            If (eNTRADA_CANA_DET Is Nothing) Then
                Throw New System.ArgumentNullException("eNTRADA_CANA_DET")
            End If
            If (eNTRADA_CANA_DET.pId = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "pId", "eNTRADA_CANA_DET", "S5TUam.ENTRADA_CANA_DET")
            End If
            Try 
                Me.BaseTable.Add(eNTRADA_CANA_DET.pId, eNTRADA_CANA_DET)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5TUam.ENTRADA_CANA_DETCollection", eNTRADA_CANA_DET.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5TUam.ENTRADA_CANA_DETCollection", eNTRADA_CANA_DET.pId), ae)
            End Try
            AddHandler eNTRADA_CANA_DET.KeyChanged, AddressOf Me.OnItemKeyChanged
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(eNTRADA_CANA_DET)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, eNTRADA_CANA_DET, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            ...
            If (eNTRADA_CANA_DET Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(eNTRADA_CANA_DET)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_S5TUam_ENTRADA_CANA_DET__Add(ByVal eNTRADA_CANA_DET As S5TUam.ENTRADA_CANA_DET) Implements System.Collections.Generic.ICollection(Of S5TUam.ENTRADA_CANA_DET).Add
            Me.BaseAdd(eNTRADA_CANA_DET)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As S5TUam.ENTRADA_CANA_DET
            Dim eNTRADA_CANA_DET As S5TUam.ENTRADA_CANA_DET = S5TUam.ENTRADA_CANA_DET.LoadByEntityKey(key)
            If ((Not (eNTRADA_CANA_DET) Is Nothing)  _
                        AndAlso (Me.Contains(eNTRADA_CANA_DET) = false)) Then
                Me.Add(eNTRADA_CANA_DET)
            End If
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of S5TUam.ENTRADA_CANA_DET))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As S5TUam.ENTRADA_CANA_DET, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of S5TUam.ENTRADA_CANA_DET).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As S5TUam.ENTRADA_CANA_DET, ByVal index As Integer)
        ...
        Public Function Contains(ByVal eNTRADA_CANA_DET As S5TUam.ENTRADA_CANA_DET) As Boolean Implements System.Collections.Generic.ICollection(Of S5TUam.ENTRADA_CANA_DET).Contains
            Dim localContains As Boolean = Me.BaseContains(eNTRADA_CANA_DET)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal eNTRADA_CANA_DET As S5TUam.ENTRADA_CANA_DET) As Boolean
            If (eNTRADA_CANA_DET Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(eNTRADA_CANA_DET.pId)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            ...
            Catch icex As System.InvalidCastException
                eNTRADA_CANA_DET = Nothing
            End Try
            Return Me.Contains(eNTRADA_CANA_DET)
        End Function
        
        Public Function IndexOf(ByVal eNTRADA_CANA_DET As S5TUam.ENTRADA_CANA_DET) As Integer Implements System.Collections.Generic.IList(Of S5TUam.ENTRADA_CANA_DET).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(eNTRADA_CANA_DET)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal eNTRADA_CANA_DET As S5TUam.ENTRADA_CANA_DET) As Integer
            If (eNTRADA_CANA_DET Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(eNTRADA_CANA_DET)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                eNTRADA_CANA_DET = Nothing
            End Try
            Return Me.IndexOf(eNTRADA_CANA_DET)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal eNTRADA_CANA_DET As S5TUam.ENTRADA_CANA_DET) Implements System.Collections.Generic.IList(Of S5TUam.ENTRADA_CANA_DET).Insert
            Me.BaseInsert(index, eNTRADA_CANA_DET)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal eNTRADA_CANA_DET As S5TUam.ENTRADA_CANA_DET)
            If (eNTRADA_CANA_DET Is Nothing) Then
                Throw New System.ArgumentNullException("eNTRADA_CANA_DET")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5TUam.ENTRADA_CANA_DETCollection", eNTRADA_CANA_DET.pId), ae)
            End Try
            Me.BaseList.Insert(index, eNTRADA_CANA_DET)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, eNTRADA_CANA_DET, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                eNTRADA_CANA_DET = Nothing
            End Try
            Me.Insert(index, eNTRADA_CANA_DET)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of S5TUam.ENTRADA_CANA_DET).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim ENTRADA_CANA_DET As S5TUam.ENTRADA_CANA_DET = Me(0)
                Me.BaseRemove(ENTRADA_CANA_DET)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal eNTRADA_CANA_DET As S5TUam.ENTRADA_CANA_DET) As Boolean Implements System.Collections.Generic.ICollection(Of S5TUam.ENTRADA_CANA_DET).Remove
            Return Me.BaseRemove(eNTRADA_CANA_DET)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal eNTRADA_CANA_DET As S5TUam.ENTRADA_CANA_DET) As Boolean
            If (eNTRADA_CANA_DET Is Nothing) Then
                Throw New System.ArgumentNullException("eNTRADA_CANA_DET")
            End If
            Dim index As Integer = Me.IndexOf(eNTRADA_CANA_DET)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5TUam.ENTRADA_CANA_DET).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(eNTRADA_CANA_DET)
            RemoveHandler eNTRADA_CANA_DET.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(eNTRADA_CANA_DET.pId)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, eNTRADA_CANA_DET, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of S5TUam.ENTRADA_CANA_DET).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5TUam.ENTRADA_CANA_DET).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim eNTRADA_CANA_DET As S5TUam.ENTRADA_CANA_DET = Me.BaseList(index)
            If (Not (eNTRADA_CANA_DET) Is Nothing) Then
                RemoveHandler eNTRADA_CANA_DET.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(eNTRADA_CANA_DET.pId)
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of S5TUam.ENTRADA_CANA_DET) Implements System.Collections.Generic.IEnumerable(Of S5TUam.ENTRADA_CANA_DET).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of S5TUam.ENTRADA_CANA_DET) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As Long) As S5TUam.ENTRADA_CANA_DET
            Dim eNTRADA_CANA_DET As S5TUam.ENTRADA_CANA_DET = Nothing
            If (Me.BaseTable.TryGetValue(key, eNTRADA_CANA_DET) = true) Then
                Return eNTRADA_CANA_DET
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim eNTRADA_CANA_DET As S5TUam.ENTRADA_CANA_DET = Me(index)
                eNTRADA_CANA_DET.Save
                If (eNTRADA_CANA_DET.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(eNTRADA_CANA_DET)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    ...
                    CType(eNTRADA_CANA_DET,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(eNTRADA_CANA_DET) = false) Then
                        Me.BaseAdd(eNTRADA_CANA_DET)
                        count = (count + 1)
                    End If
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As S5TUam.ENTRADA_CANA_DETCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As S5TUam.ENTRADA_CANA_DETCollection = New S5TUam.ENTRADA_CANA_DETCollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5TUam.ENTRADA_CANA_DETCollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As S5TUam.ENTRADA_CANA_DETCollection
            Dim ret As S5TUam.ENTRADA_CANA_DETCollection = S5TUam.ENTRADA_CANA_DETCollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "ENTRADA_CANA_DET", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5TUam.ENTRADA_CANA_DETCollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As S5TUam.ENTRADA_CANA_DETCollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(S5TUam.ENTRADA_CANA_DET)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of S5TUam.ENTRADA_CANA_DET) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,S5TUam.ENTRADA_CANA_DET))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As S5TUam.ENTRADA_CANA_DETCollection
            Dim ret As S5TUam.ENTRADA_CANA_DETCollection = New S5TUam.ENTRADA_CANA_DETCollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm856981948.AddIndex([property])
        End Sub
        ...
        Private Function AddNew() As Object Implements System.ComponentModel.IBindingList.AddNew
            Dim add As S5TUam.ENTRADA_CANA_DET = New S5TUam.ENTRADA_CANA_DET()
            Dim e As System.ComponentModel.AddingNewEventArgs = New System.ComponentModel.AddingNewEventArgs(add)
            Me.OnAddingNew(e)
            add = CType(e.NewObject,S5TUam.ENTRADA_CANA_DET)
            If (add Is Nothing) Then
                add = New S5TUam.ENTRADA_CANA_DET()
            End If
            add.pId = 0
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm856981948.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm856981948.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of S5TUam.ENTRADA_CANA_DET))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of Long))
            If (e Is Nothing) Then
                Throw New System.ArgumentNullException("e")
            End If
            Dim existing As S5TUam.ENTRADA_CANA_DET = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5TUam.ENTRADA_CANA_DETCollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5TUam.ENTRADA_CANA_DETCollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As S5TUam.ENTRADA_CANA_DETCollection
            Return S5TUam.ENTRADA_CANA_DETCollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal eNTRADA_CANA_DET As S5TUam.ENTRADA_CANA_DET) As Boolean
            If (eNTRADA_CANA_DET Is Nothing) Then
                Return false
            End If
        ...
        Public Overloads Shared Function Insert(ByVal eNTRADA_CANA_DET As S5TUam.ENTRADA_CANA_DET) As Boolean
            Dim ret As Boolean = S5TUam.ENTRADA_CANA_DET.Save(eNTRADA_CANA_DET)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal eNTRADA_CANA_DET As S5TUam.ENTRADA_CANA_DET) As Boolean
            If (eNTRADA_CANA_DET Is Nothing) Then
                Return false
            End If
