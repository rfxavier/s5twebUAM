...
Namespace S5TUam
    ...
    Partial Public Class PROPRIEDADES
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5TUam.PROPRIEDADES), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5TUam.PROPRIEDADES)
        ...
        Public Overloads Overridable Function Equals(ByVal pROPRIEDADES As S5TUam.PROPRIEDADES) As Boolean Implements System.IEquatable(Of S5TUam.PROPRIEDADES).Equals
            If (pROPRIEDADES Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(pROPRIEDADES)
            End If
            Return (Me.pId.Equals(pROPRIEDADES.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                pROPRIEDADES = CType(obj,S5TUam.PROPRIEDADES)
            Catch icex As System.InvalidCastException
                pROPRIEDADES = Nothing
            End Try
            Return Me.Equals(pROPRIEDADES)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(pROPRIEDADES)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal pROPRIEDADES As S5TUam.PROPRIEDADES) As Integer Implements System.IComparable(Of S5TUam.PROPRIEDADES).CompareTo
            If (pROPRIEDADES Is Nothing) Then
                Throw New System.ArgumentNullException("pROPRIEDADES")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(pROPRIEDADES.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5TUam.PROPRIEDADES.ExternalValidate", "Type 'S5TUam.PROPRIEDADES' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "PROPRIEDADES", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5TUam.PROPRIEDADES
            If (pId = -1) Then
                Return Nothing
            End If
            Dim pROPRIEDADES As S5TUam.PROPRIEDADES = New S5TUam.PROPRIEDADES()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "PROPRIEDADES", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    pROPRIEDADES.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5TUam.PROPRIEDADES
            If (pId = -1) Then
                Return Nothing
            End If
            Dim pROPRIEDADES As S5TUam.PROPRIEDADES = New S5TUam.PROPRIEDADES()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "PROPRIEDADES", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Shared Function LoadByCOD_PROPRIEDADE(ByVal parSAFRA As Integer, ByVal parCOD_PROPRIEDADE As Integer) As S5TUam.PROPRIEDADES
            ...
            Dim pROPRIEDADES As S5TUam.PROPRIEDADES = New S5TUam.PROPRIEDADES()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "PROPRIEDADES", "LoadByCOD_PROPRIEDADE")
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "PROPRIEDADES", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal pROPRIEDADES As S5TUam.PROPRIEDADES) As Boolean
            If (pROPRIEDADES Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal pROPRIEDADES As S5TUam.PROPRIEDADES) As Boolean
            Dim ret As Boolean = S5TUam.PROPRIEDADES.Save(pROPRIEDADES)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal pROPRIEDADES As S5TUam.PROPRIEDADES) As Boolean
            If (pROPRIEDADES Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5TUam.PROPRIEDADES
            ...
            pROPRIEDADES = S5TUam.PROPRIEDADES.Load(var)
            Return pROPRIEDADES
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5TUam.PROPRIEDADES
            Dim pROPRIEDADES As S5TUam.PROPRIEDADES = New S5TUam.PROPRIEDADES()
            Me.CopyTo(pROPRIEDADES, deep)
            Return pROPRIEDADES
        End Function
        
        Public Overloads Function Clone() As S5TUam.PROPRIEDADES
            Dim localClone As S5TUam.PROPRIEDADES = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal pROPRIEDADES As S5TUam.PROPRIEDADES, ByVal deep As Boolean)
            If (pROPRIEDADES Is Nothing) Then
                Throw New System.ArgumentNullException("pROPRIEDADES")
            End If
            pROPRIEDADES.pId = Me.pId
            pROPRIEDADES.DSC_PROPRIEDADE = Me.DSC_PROPRIEDADE
            pROPRIEDADES.COD_PROPRIEDADE = Me.COD_PROPRIEDADE
            pROPRIEDADES.SAFRA = Me.SAFRA
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, pROPRIEDADES))
        End Sub
