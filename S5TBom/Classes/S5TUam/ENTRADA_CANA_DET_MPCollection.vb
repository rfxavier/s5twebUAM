...
Namespace S5TUam
    ...
    Partial Public Class ENTRADA_CANA_DET_MPCollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of S5TUam.ENTRADA_CANA_DET_MP), System.Collections.Generic.ICollection(Of S5TUam.ENTRADA_CANA_DET_MP), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of S5TUam.ENTRADA_CANA_DET_MP) = New System.Collections.Generic.List(Of S5TUam.ENTRADA_CANA_DET_MP)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of Long, S5TUam.ENTRADA_CANA_DET_MP) = New System.Collections.Generic.Dictionary(Of Long, S5TUam.ENTRADA_CANA_DET_MP)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _blm2641860000 As CodeFluent.Runtime.Utilities.BindingListManager(Of S5TUam.ENTRADA_CANA_DET_MP)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm2641860000 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5TUam.ENTRADA_CANA_DET_MP)(Me)
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of S5TUam.ENTRADA_CANA_DET_MP)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of Long, S5TUam.ENTRADA_CANA_DET_MP)
            Get
        ...
        Public Overloads Default Property Item(ByVal index As Integer) As S5TUam.ENTRADA_CANA_DET_MP Implements System.Collections.Generic.IList(Of S5TUam.ENTRADA_CANA_DET_MP).Item
            Get
                Return CType(Me.BaseList(index),S5TUam.ENTRADA_CANA_DET_MP)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,S5TUam.ENTRADA_CANA_DET_MP)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal pId As Long) As S5TUam.ENTRADA_CANA_DET_MP
            Get
                If (pId = -1) Then
                    Throw New System.ArgumentNullException("pId")
                End If
                Dim i As S5TUam.ENTRADA_CANA_DET_MP = Me.TryGetValue(pId)
                Return i
            End Get
            Set
                If (pId = -1) Then
                ...
                If (value Is Nothing) Then
                    Dim eNTRADA_CANA_DET_MP As S5TUam.ENTRADA_CANA_DET_MP = Me.TryGetValue(pId)
                    If (Not (eNTRADA_CANA_DET_MP) Is Nothing) Then
                        Me.Remove(eNTRADA_CANA_DET_MP)
                    End If
                    Return
                End If
                Dim existing As S5TUam.ENTRADA_CANA_DET_MP = Me.TryGetValue(value.pId)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of S5TUam.ENTRADA_CANA_DET_MP).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of S5TUam.ENTRADA_CANA_DET_MP).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm2641860000.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm2641860000.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As S5TUam.ENTRADA_CANA_DET_MP, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal eNTRADA_CANA_DET_MP As S5TUam.ENTRADA_CANA_DET_MP) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(eNTRADA_CANA_DET_MP)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal eNTRADA_CANA_DET_MP As S5TUam.ENTRADA_CANA_DET_MP) As Integer
            If (eNTRADA_CANA_DET_MP Is Nothing) Then
                Throw New System.ArgumentNullException("eNTRADA_CANA_DET_MP")
            End If
            If (eNTRADA_CANA_DET_MP.pId = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "pId", "eNTRADA_CANA_DET_MP", "S5TUam.ENTRADA_CANA_DET_MP")
            End If
            Try 
                Me.BaseTable.Add(eNTRADA_CANA_DET_MP.pId, eNTRADA_CANA_DET_MP)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5TUam.ENTRADA_CANA_DET_MPCollection", eNTRADA_CANA_DET_MP.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5TUam.ENTRADA_CANA_DET_MPCollection", eNTRADA_CANA_DET_MP.pId), ae)
            End Try
            AddHandler eNTRADA_CANA_DET_MP.KeyChanged, AddressOf Me.OnItemKeyChanged
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(eNTRADA_CANA_DET_MP)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, eNTRADA_CANA_DET_MP, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            ...
            If (eNTRADA_CANA_DET_MP Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(eNTRADA_CANA_DET_MP)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_S5TUam_ENTRADA_CANA_DET_MP__Add(ByVal eNTRADA_CANA_DET_MP As S5TUam.ENTRADA_CANA_DET_MP) Implements System.Collections.Generic.ICollection(Of S5TUam.ENTRADA_CANA_DET_MP).Add
            Me.BaseAdd(eNTRADA_CANA_DET_MP)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As S5TUam.ENTRADA_CANA_DET_MP
            Dim eNTRADA_CANA_DET_MP As S5TUam.ENTRADA_CANA_DET_MP = S5TUam.ENTRADA_CANA_DET_MP.LoadByEntityKey(key)
            If ((Not (eNTRADA_CANA_DET_MP) Is Nothing)  _
                        AndAlso (Me.Contains(eNTRADA_CANA_DET_MP) = false)) Then
                Me.Add(eNTRADA_CANA_DET_MP)
            End If
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of S5TUam.ENTRADA_CANA_DET_MP))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As S5TUam.ENTRADA_CANA_DET_MP, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of S5TUam.ENTRADA_CANA_DET_MP).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As S5TUam.ENTRADA_CANA_DET_MP, ByVal index As Integer)
        ...
        Public Function Contains(ByVal eNTRADA_CANA_DET_MP As S5TUam.ENTRADA_CANA_DET_MP) As Boolean Implements System.Collections.Generic.ICollection(Of S5TUam.ENTRADA_CANA_DET_MP).Contains
            Dim localContains As Boolean = Me.BaseContains(eNTRADA_CANA_DET_MP)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal eNTRADA_CANA_DET_MP As S5TUam.ENTRADA_CANA_DET_MP) As Boolean
            If (eNTRADA_CANA_DET_MP Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(eNTRADA_CANA_DET_MP.pId)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            ...
            Catch icex As System.InvalidCastException
                eNTRADA_CANA_DET_MP = Nothing
            End Try
            Return Me.Contains(eNTRADA_CANA_DET_MP)
        End Function
        
        Public Function IndexOf(ByVal eNTRADA_CANA_DET_MP As S5TUam.ENTRADA_CANA_DET_MP) As Integer Implements System.Collections.Generic.IList(Of S5TUam.ENTRADA_CANA_DET_MP).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(eNTRADA_CANA_DET_MP)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal eNTRADA_CANA_DET_MP As S5TUam.ENTRADA_CANA_DET_MP) As Integer
            If (eNTRADA_CANA_DET_MP Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(eNTRADA_CANA_DET_MP)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                eNTRADA_CANA_DET_MP = Nothing
            End Try
            Return Me.IndexOf(eNTRADA_CANA_DET_MP)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal eNTRADA_CANA_DET_MP As S5TUam.ENTRADA_CANA_DET_MP) Implements System.Collections.Generic.IList(Of S5TUam.ENTRADA_CANA_DET_MP).Insert
            Me.BaseInsert(index, eNTRADA_CANA_DET_MP)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal eNTRADA_CANA_DET_MP As S5TUam.ENTRADA_CANA_DET_MP)
            If (eNTRADA_CANA_DET_MP Is Nothing) Then
                Throw New System.ArgumentNullException("eNTRADA_CANA_DET_MP")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5TUam.ENTRADA_CANA_DET_MPCollection", eNTRADA_CANA_DET_MP.pId), ae)
            End Try
            Me.BaseList.Insert(index, eNTRADA_CANA_DET_MP)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, eNTRADA_CANA_DET_MP, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                eNTRADA_CANA_DET_MP = Nothing
            End Try
            Me.Insert(index, eNTRADA_CANA_DET_MP)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of S5TUam.ENTRADA_CANA_DET_MP).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim ENTRADA_CANA_DET_MP As S5TUam.ENTRADA_CANA_DET_MP = Me(0)
                Me.BaseRemove(ENTRADA_CANA_DET_MP)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal eNTRADA_CANA_DET_MP As S5TUam.ENTRADA_CANA_DET_MP) As Boolean Implements System.Collections.Generic.ICollection(Of S5TUam.ENTRADA_CANA_DET_MP).Remove
            Return Me.BaseRemove(eNTRADA_CANA_DET_MP)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal eNTRADA_CANA_DET_MP As S5TUam.ENTRADA_CANA_DET_MP) As Boolean
            If (eNTRADA_CANA_DET_MP Is Nothing) Then
                Throw New System.ArgumentNullException("eNTRADA_CANA_DET_MP")
            End If
            Dim index As Integer = Me.IndexOf(eNTRADA_CANA_DET_MP)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5TUam.ENTRADA_CANA_DET_MP).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(eNTRADA_CANA_DET_MP)
            RemoveHandler eNTRADA_CANA_DET_MP.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(eNTRADA_CANA_DET_MP.pId)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, eNTRADA_CANA_DET_MP, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of S5TUam.ENTRADA_CANA_DET_MP).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5TUam.ENTRADA_CANA_DET_MP).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim eNTRADA_CANA_DET_MP As S5TUam.ENTRADA_CANA_DET_MP = Me.BaseList(index)
            If (Not (eNTRADA_CANA_DET_MP) Is Nothing) Then
                RemoveHandler eNTRADA_CANA_DET_MP.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(eNTRADA_CANA_DET_MP.pId)
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of S5TUam.ENTRADA_CANA_DET_MP) Implements System.Collections.Generic.IEnumerable(Of S5TUam.ENTRADA_CANA_DET_MP).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of S5TUam.ENTRADA_CANA_DET_MP) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As Long) As S5TUam.ENTRADA_CANA_DET_MP
            Dim eNTRADA_CANA_DET_MP As S5TUam.ENTRADA_CANA_DET_MP = Nothing
            If (Me.BaseTable.TryGetValue(key, eNTRADA_CANA_DET_MP) = true) Then
                Return eNTRADA_CANA_DET_MP
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim eNTRADA_CANA_DET_MP As S5TUam.ENTRADA_CANA_DET_MP = Me(index)
                eNTRADA_CANA_DET_MP.Save
                If (eNTRADA_CANA_DET_MP.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(eNTRADA_CANA_DET_MP)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    ...
                    CType(eNTRADA_CANA_DET_MP,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(eNTRADA_CANA_DET_MP) = false) Then
                        Me.BaseAdd(eNTRADA_CANA_DET_MP)
                        count = (count + 1)
                    End If
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As S5TUam.ENTRADA_CANA_DET_MPCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As S5TUam.ENTRADA_CANA_DET_MPCollection = New S5TUam.ENTRADA_CANA_DET_MPCollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5TUam.ENTRADA_CANA_DET_MPCollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As S5TUam.ENTRADA_CANA_DET_MPCollection
            Dim ret As S5TUam.ENTRADA_CANA_DET_MPCollection = S5TUam.ENTRADA_CANA_DET_MPCollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "ENTRADA_CANA_DET_MP", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5TUam.ENTRADA_CANA_DET_MPCollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As S5TUam.ENTRADA_CANA_DET_MPCollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(S5TUam.ENTRADA_CANA_DET_MP)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of S5TUam.ENTRADA_CANA_DET_MP) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,S5TUam.ENTRADA_CANA_DET_MP))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As S5TUam.ENTRADA_CANA_DET_MPCollection
            Dim ret As S5TUam.ENTRADA_CANA_DET_MPCollection = New S5TUam.ENTRADA_CANA_DET_MPCollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm2641860000.AddIndex([property])
        End Sub
        ...
        Private Function AddNew() As Object Implements System.ComponentModel.IBindingList.AddNew
            Dim add As S5TUam.ENTRADA_CANA_DET_MP = New S5TUam.ENTRADA_CANA_DET_MP()
            Dim e As System.ComponentModel.AddingNewEventArgs = New System.ComponentModel.AddingNewEventArgs(add)
            Me.OnAddingNew(e)
            add = CType(e.NewObject,S5TUam.ENTRADA_CANA_DET_MP)
            If (add Is Nothing) Then
                add = New S5TUam.ENTRADA_CANA_DET_MP()
            End If
            add.pId = 0
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm2641860000.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm2641860000.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of S5TUam.ENTRADA_CANA_DET_MP))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of Long))
            If (e Is Nothing) Then
                Throw New System.ArgumentNullException("e")
            End If
            Dim existing As S5TUam.ENTRADA_CANA_DET_MP = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5TUam.ENTRADA_CANA_DET_MPCollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5TUam.ENTRADA_CANA_DET_MPCollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As S5TUam.ENTRADA_CANA_DET_MPCollection
            Return S5TUam.ENTRADA_CANA_DET_MPCollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal eNTRADA_CANA_DET_MP As S5TUam.ENTRADA_CANA_DET_MP) As Boolean
            If (eNTRADA_CANA_DET_MP Is Nothing) Then
                Return false
            End If
        ...
        Public Overloads Shared Function Insert(ByVal eNTRADA_CANA_DET_MP As S5TUam.ENTRADA_CANA_DET_MP) As Boolean
            Dim ret As Boolean = S5TUam.ENTRADA_CANA_DET_MP.Save(eNTRADA_CANA_DET_MP)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal eNTRADA_CANA_DET_MP As S5TUam.ENTRADA_CANA_DET_MP) As Boolean
            If (eNTRADA_CANA_DET_MP Is Nothing) Then
                Return false
            End If
