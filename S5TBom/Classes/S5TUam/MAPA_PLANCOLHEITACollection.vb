...
Namespace S5TUam
    ...
    Partial Public Class MAPA_PLANCOLHEITACollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of S5TUam.MAPA_PLANCOLHEITA), System.Collections.Generic.ICollection(Of S5TUam.MAPA_PLANCOLHEITA), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of S5TUam.MAPA_PLANCOLHEITA) = New System.Collections.Generic.List(Of S5TUam.MAPA_PLANCOLHEITA)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of Long, S5TUam.MAPA_PLANCOLHEITA) = New System.Collections.Generic.Dictionary(Of Long, S5TUam.MAPA_PLANCOLHEITA)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _blm1813865059 As CodeFluent.Runtime.Utilities.BindingListManager(Of S5TUam.MAPA_PLANCOLHEITA)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm1813865059 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5TUam.MAPA_PLANCOLHEITA)(Me)
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of S5TUam.MAPA_PLANCOLHEITA)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of Long, S5TUam.MAPA_PLANCOLHEITA)
            Get
        ...
        Public Overloads Default Property Item(ByVal index As Integer) As S5TUam.MAPA_PLANCOLHEITA Implements System.Collections.Generic.IList(Of S5TUam.MAPA_PLANCOLHEITA).Item
            Get
                Return CType(Me.BaseList(index),S5TUam.MAPA_PLANCOLHEITA)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,S5TUam.MAPA_PLANCOLHEITA)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal pId As Long) As S5TUam.MAPA_PLANCOLHEITA
            Get
                If (pId = -1) Then
                    Throw New System.ArgumentNullException("pId")
                End If
                Dim i As S5TUam.MAPA_PLANCOLHEITA = Me.TryGetValue(pId)
                Return i
            End Get
            Set
                If (pId = -1) Then
                ...
                If (value Is Nothing) Then
                    Dim mAPA_PLANCOLHEITA As S5TUam.MAPA_PLANCOLHEITA = Me.TryGetValue(pId)
                    If (Not (mAPA_PLANCOLHEITA) Is Nothing) Then
                        Me.Remove(mAPA_PLANCOLHEITA)
                    End If
                    Return
                End If
                Dim existing As S5TUam.MAPA_PLANCOLHEITA = Me.TryGetValue(value.pId)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of S5TUam.MAPA_PLANCOLHEITA).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of S5TUam.MAPA_PLANCOLHEITA).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm1813865059.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm1813865059.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As S5TUam.MAPA_PLANCOLHEITA, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal mAPA_PLANCOLHEITA As S5TUam.MAPA_PLANCOLHEITA) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(mAPA_PLANCOLHEITA)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal mAPA_PLANCOLHEITA As S5TUam.MAPA_PLANCOLHEITA) As Integer
            If (mAPA_PLANCOLHEITA Is Nothing) Then
                Throw New System.ArgumentNullException("mAPA_PLANCOLHEITA")
            End If
            If (mAPA_PLANCOLHEITA.pId = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "pId", "mAPA_PLANCOLHEITA", "S5TUam.MAPA_PLANCOLHEITA")
            End If
            Try 
                Me.BaseTable.Add(mAPA_PLANCOLHEITA.pId, mAPA_PLANCOLHEITA)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5TUam.MAPA_PLANCOLHEITACollection", mAPA_PLANCOLHEITA.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5TUam.MAPA_PLANCOLHEITACollection", mAPA_PLANCOLHEITA.pId), ae)
            End Try
            AddHandler mAPA_PLANCOLHEITA.KeyChanged, AddressOf Me.OnItemKeyChanged
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(mAPA_PLANCOLHEITA)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, mAPA_PLANCOLHEITA, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            ...
            If (mAPA_PLANCOLHEITA Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(mAPA_PLANCOLHEITA)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_S5TUam_MAPA_PLANCOLHEITA__Add(ByVal mAPA_PLANCOLHEITA As S5TUam.MAPA_PLANCOLHEITA) Implements System.Collections.Generic.ICollection(Of S5TUam.MAPA_PLANCOLHEITA).Add
            Me.BaseAdd(mAPA_PLANCOLHEITA)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As S5TUam.MAPA_PLANCOLHEITA
            Dim mAPA_PLANCOLHEITA As S5TUam.MAPA_PLANCOLHEITA = S5TUam.MAPA_PLANCOLHEITA.LoadByEntityKey(key)
            If ((Not (mAPA_PLANCOLHEITA) Is Nothing)  _
                        AndAlso (Me.Contains(mAPA_PLANCOLHEITA) = false)) Then
                Me.Add(mAPA_PLANCOLHEITA)
            End If
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of S5TUam.MAPA_PLANCOLHEITA))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As S5TUam.MAPA_PLANCOLHEITA, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of S5TUam.MAPA_PLANCOLHEITA).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As S5TUam.MAPA_PLANCOLHEITA, ByVal index As Integer)
        ...
        Public Function Contains(ByVal mAPA_PLANCOLHEITA As S5TUam.MAPA_PLANCOLHEITA) As Boolean Implements System.Collections.Generic.ICollection(Of S5TUam.MAPA_PLANCOLHEITA).Contains
            Dim localContains As Boolean = Me.BaseContains(mAPA_PLANCOLHEITA)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal mAPA_PLANCOLHEITA As S5TUam.MAPA_PLANCOLHEITA) As Boolean
            If (mAPA_PLANCOLHEITA Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(mAPA_PLANCOLHEITA.pId)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            ...
            Catch icex As System.InvalidCastException
                mAPA_PLANCOLHEITA = Nothing
            End Try
            Return Me.Contains(mAPA_PLANCOLHEITA)
        End Function
        
        Public Function IndexOf(ByVal mAPA_PLANCOLHEITA As S5TUam.MAPA_PLANCOLHEITA) As Integer Implements System.Collections.Generic.IList(Of S5TUam.MAPA_PLANCOLHEITA).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(mAPA_PLANCOLHEITA)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal mAPA_PLANCOLHEITA As S5TUam.MAPA_PLANCOLHEITA) As Integer
            If (mAPA_PLANCOLHEITA Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(mAPA_PLANCOLHEITA)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                mAPA_PLANCOLHEITA = Nothing
            End Try
            Return Me.IndexOf(mAPA_PLANCOLHEITA)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal mAPA_PLANCOLHEITA As S5TUam.MAPA_PLANCOLHEITA) Implements System.Collections.Generic.IList(Of S5TUam.MAPA_PLANCOLHEITA).Insert
            Me.BaseInsert(index, mAPA_PLANCOLHEITA)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal mAPA_PLANCOLHEITA As S5TUam.MAPA_PLANCOLHEITA)
            If (mAPA_PLANCOLHEITA Is Nothing) Then
                Throw New System.ArgumentNullException("mAPA_PLANCOLHEITA")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5TUam.MAPA_PLANCOLHEITACollection", mAPA_PLANCOLHEITA.pId), ae)
            End Try
            Me.BaseList.Insert(index, mAPA_PLANCOLHEITA)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, mAPA_PLANCOLHEITA, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                mAPA_PLANCOLHEITA = Nothing
            End Try
            Me.Insert(index, mAPA_PLANCOLHEITA)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of S5TUam.MAPA_PLANCOLHEITA).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim MAPA_PLANCOLHEITA As S5TUam.MAPA_PLANCOLHEITA = Me(0)
                Me.BaseRemove(MAPA_PLANCOLHEITA)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal mAPA_PLANCOLHEITA As S5TUam.MAPA_PLANCOLHEITA) As Boolean Implements System.Collections.Generic.ICollection(Of S5TUam.MAPA_PLANCOLHEITA).Remove
            Return Me.BaseRemove(mAPA_PLANCOLHEITA)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal mAPA_PLANCOLHEITA As S5TUam.MAPA_PLANCOLHEITA) As Boolean
            If (mAPA_PLANCOLHEITA Is Nothing) Then
                Throw New System.ArgumentNullException("mAPA_PLANCOLHEITA")
            End If
            Dim index As Integer = Me.IndexOf(mAPA_PLANCOLHEITA)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5TUam.MAPA_PLANCOLHEITA).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(mAPA_PLANCOLHEITA)
            RemoveHandler mAPA_PLANCOLHEITA.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(mAPA_PLANCOLHEITA.pId)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, mAPA_PLANCOLHEITA, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of S5TUam.MAPA_PLANCOLHEITA).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5TUam.MAPA_PLANCOLHEITA).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim mAPA_PLANCOLHEITA As S5TUam.MAPA_PLANCOLHEITA = Me.BaseList(index)
            If (Not (mAPA_PLANCOLHEITA) Is Nothing) Then
                RemoveHandler mAPA_PLANCOLHEITA.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(mAPA_PLANCOLHEITA.pId)
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of S5TUam.MAPA_PLANCOLHEITA) Implements System.Collections.Generic.IEnumerable(Of S5TUam.MAPA_PLANCOLHEITA).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of S5TUam.MAPA_PLANCOLHEITA) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As Long) As S5TUam.MAPA_PLANCOLHEITA
            Dim mAPA_PLANCOLHEITA As S5TUam.MAPA_PLANCOLHEITA = Nothing
            If (Me.BaseTable.TryGetValue(key, mAPA_PLANCOLHEITA) = true) Then
                Return mAPA_PLANCOLHEITA
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim mAPA_PLANCOLHEITA As S5TUam.MAPA_PLANCOLHEITA = Me(index)
                mAPA_PLANCOLHEITA.Save
                If (mAPA_PLANCOLHEITA.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(mAPA_PLANCOLHEITA)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    ...
                    CType(mAPA_PLANCOLHEITA,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(mAPA_PLANCOLHEITA) = false) Then
                        Me.BaseAdd(mAPA_PLANCOLHEITA)
                        count = (count + 1)
                    End If
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As S5TUam.MAPA_PLANCOLHEITACollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As S5TUam.MAPA_PLANCOLHEITACollection = New S5TUam.MAPA_PLANCOLHEITACollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5TUam.MAPA_PLANCOLHEITACollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As S5TUam.MAPA_PLANCOLHEITACollection
            Dim ret As S5TUam.MAPA_PLANCOLHEITACollection = S5TUam.MAPA_PLANCOLHEITACollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "MAPA_PLANCOLHEITA", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5TUam.MAPA_PLANCOLHEITACollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As S5TUam.MAPA_PLANCOLHEITACollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(S5TUam.MAPA_PLANCOLHEITA)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of S5TUam.MAPA_PLANCOLHEITA) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,S5TUam.MAPA_PLANCOLHEITA))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As S5TUam.MAPA_PLANCOLHEITACollection
            Dim ret As S5TUam.MAPA_PLANCOLHEITACollection = New S5TUam.MAPA_PLANCOLHEITACollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm1813865059.AddIndex([property])
        End Sub
        ...
        Private Function AddNew() As Object Implements System.ComponentModel.IBindingList.AddNew
            Dim add As S5TUam.MAPA_PLANCOLHEITA = New S5TUam.MAPA_PLANCOLHEITA()
            Dim e As System.ComponentModel.AddingNewEventArgs = New System.ComponentModel.AddingNewEventArgs(add)
            Me.OnAddingNew(e)
            add = CType(e.NewObject,S5TUam.MAPA_PLANCOLHEITA)
            If (add Is Nothing) Then
                add = New S5TUam.MAPA_PLANCOLHEITA()
            End If
            add.pId = 0
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm1813865059.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm1813865059.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of S5TUam.MAPA_PLANCOLHEITA))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of Long))
            If (e Is Nothing) Then
                Throw New System.ArgumentNullException("e")
            End If
            Dim existing As S5TUam.MAPA_PLANCOLHEITA = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5TUam.MAPA_PLANCOLHEITACollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5TUam.MAPA_PLANCOLHEITACollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As S5TUam.MAPA_PLANCOLHEITACollection
            Return S5TUam.MAPA_PLANCOLHEITACollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal mAPA_PLANCOLHEITA As S5TUam.MAPA_PLANCOLHEITA) As Boolean
            If (mAPA_PLANCOLHEITA Is Nothing) Then
                Return false
            End If
        ...
        Public Overloads Shared Function Insert(ByVal mAPA_PLANCOLHEITA As S5TUam.MAPA_PLANCOLHEITA) As Boolean
            Dim ret As Boolean = S5TUam.MAPA_PLANCOLHEITA.Save(mAPA_PLANCOLHEITA)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal mAPA_PLANCOLHEITA As S5TUam.MAPA_PLANCOLHEITA) As Boolean
            If (mAPA_PLANCOLHEITA Is Nothing) Then
                Return false
            End If
