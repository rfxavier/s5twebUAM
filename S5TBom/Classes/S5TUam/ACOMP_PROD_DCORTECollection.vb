...
Namespace S5TUam
    ...
    Partial Public Class ACOMP_PROD_DCORTECollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of S5TUam.ACOMP_PROD_DCORTE), System.Collections.Generic.ICollection(Of S5TUam.ACOMP_PROD_DCORTE), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of S5TUam.ACOMP_PROD_DCORTE) = New System.Collections.Generic.List(Of S5TUam.ACOMP_PROD_DCORTE)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of Long, S5TUam.ACOMP_PROD_DCORTE) = New System.Collections.Generic.Dictionary(Of Long, S5TUam.ACOMP_PROD_DCORTE)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _blm2472220608 As CodeFluent.Runtime.Utilities.BindingListManager(Of S5TUam.ACOMP_PROD_DCORTE)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm2472220608 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5TUam.ACOMP_PROD_DCORTE)(Me)
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of S5TUam.ACOMP_PROD_DCORTE)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of Long, S5TUam.ACOMP_PROD_DCORTE)
            Get
        ...
        Public Overloads Default Property Item(ByVal index As Integer) As S5TUam.ACOMP_PROD_DCORTE Implements System.Collections.Generic.IList(Of S5TUam.ACOMP_PROD_DCORTE).Item
            Get
                Return CType(Me.BaseList(index),S5TUam.ACOMP_PROD_DCORTE)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,S5TUam.ACOMP_PROD_DCORTE)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal pId As Long) As S5TUam.ACOMP_PROD_DCORTE
            Get
                If (pId = -1) Then
                    Throw New System.ArgumentNullException("pId")
                End If
                Dim i As S5TUam.ACOMP_PROD_DCORTE = Me.TryGetValue(pId)
                Return i
            End Get
            Set
                If (pId = -1) Then
                ...
                If (value Is Nothing) Then
                    Dim aCOMP_PROD_DCORTE As S5TUam.ACOMP_PROD_DCORTE = Me.TryGetValue(pId)
                    If (Not (aCOMP_PROD_DCORTE) Is Nothing) Then
                        Me.Remove(aCOMP_PROD_DCORTE)
                    End If
                    Return
                End If
                Dim existing As S5TUam.ACOMP_PROD_DCORTE = Me.TryGetValue(value.pId)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of S5TUam.ACOMP_PROD_DCORTE).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of S5TUam.ACOMP_PROD_DCORTE).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm2472220608.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm2472220608.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As S5TUam.ACOMP_PROD_DCORTE, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal aCOMP_PROD_DCORTE As S5TUam.ACOMP_PROD_DCORTE) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(aCOMP_PROD_DCORTE)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal aCOMP_PROD_DCORTE As S5TUam.ACOMP_PROD_DCORTE) As Integer
            If (aCOMP_PROD_DCORTE Is Nothing) Then
                Throw New System.ArgumentNullException("aCOMP_PROD_DCORTE")
            End If
            If (aCOMP_PROD_DCORTE.pId = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "pId", "aCOMP_PROD_DCORTE", "S5TUam.ACOMP_PROD_DCORTE")
            End If
            Try 
                Me.BaseTable.Add(aCOMP_PROD_DCORTE.pId, aCOMP_PROD_DCORTE)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5TUam.ACOMP_PROD_DCORTECollection", aCOMP_PROD_DCORTE.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5TUam.ACOMP_PROD_DCORTECollection", aCOMP_PROD_DCORTE.pId), ae)
            End Try
            AddHandler aCOMP_PROD_DCORTE.KeyChanged, AddressOf Me.OnItemKeyChanged
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(aCOMP_PROD_DCORTE)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, aCOMP_PROD_DCORTE, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            ...
            If (aCOMP_PROD_DCORTE Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(aCOMP_PROD_DCORTE)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_S5TUam_ACOMP_PROD_DCORTE__Add(ByVal aCOMP_PROD_DCORTE As S5TUam.ACOMP_PROD_DCORTE) Implements System.Collections.Generic.ICollection(Of S5TUam.ACOMP_PROD_DCORTE).Add
            Me.BaseAdd(aCOMP_PROD_DCORTE)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As S5TUam.ACOMP_PROD_DCORTE
            Dim aCOMP_PROD_DCORTE As S5TUam.ACOMP_PROD_DCORTE = S5TUam.ACOMP_PROD_DCORTE.LoadByEntityKey(key)
            If ((Not (aCOMP_PROD_DCORTE) Is Nothing)  _
                        AndAlso (Me.Contains(aCOMP_PROD_DCORTE) = false)) Then
                Me.Add(aCOMP_PROD_DCORTE)
            End If
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of S5TUam.ACOMP_PROD_DCORTE))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As S5TUam.ACOMP_PROD_DCORTE, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of S5TUam.ACOMP_PROD_DCORTE).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As S5TUam.ACOMP_PROD_DCORTE, ByVal index As Integer)
        ...
        Public Function Contains(ByVal aCOMP_PROD_DCORTE As S5TUam.ACOMP_PROD_DCORTE) As Boolean Implements System.Collections.Generic.ICollection(Of S5TUam.ACOMP_PROD_DCORTE).Contains
            Dim localContains As Boolean = Me.BaseContains(aCOMP_PROD_DCORTE)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal aCOMP_PROD_DCORTE As S5TUam.ACOMP_PROD_DCORTE) As Boolean
            If (aCOMP_PROD_DCORTE Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(aCOMP_PROD_DCORTE.pId)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            ...
            Catch icex As System.InvalidCastException
                aCOMP_PROD_DCORTE = Nothing
            End Try
            Return Me.Contains(aCOMP_PROD_DCORTE)
        End Function
        
        Public Function IndexOf(ByVal aCOMP_PROD_DCORTE As S5TUam.ACOMP_PROD_DCORTE) As Integer Implements System.Collections.Generic.IList(Of S5TUam.ACOMP_PROD_DCORTE).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(aCOMP_PROD_DCORTE)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal aCOMP_PROD_DCORTE As S5TUam.ACOMP_PROD_DCORTE) As Integer
            If (aCOMP_PROD_DCORTE Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(aCOMP_PROD_DCORTE)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                aCOMP_PROD_DCORTE = Nothing
            End Try
            Return Me.IndexOf(aCOMP_PROD_DCORTE)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal aCOMP_PROD_DCORTE As S5TUam.ACOMP_PROD_DCORTE) Implements System.Collections.Generic.IList(Of S5TUam.ACOMP_PROD_DCORTE).Insert
            Me.BaseInsert(index, aCOMP_PROD_DCORTE)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal aCOMP_PROD_DCORTE As S5TUam.ACOMP_PROD_DCORTE)
            If (aCOMP_PROD_DCORTE Is Nothing) Then
                Throw New System.ArgumentNullException("aCOMP_PROD_DCORTE")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5TUam.ACOMP_PROD_DCORTECollection", aCOMP_PROD_DCORTE.pId), ae)
            End Try
            Me.BaseList.Insert(index, aCOMP_PROD_DCORTE)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, aCOMP_PROD_DCORTE, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                aCOMP_PROD_DCORTE = Nothing
            End Try
            Me.Insert(index, aCOMP_PROD_DCORTE)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of S5TUam.ACOMP_PROD_DCORTE).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim ACOMP_PROD_DCORTE As S5TUam.ACOMP_PROD_DCORTE = Me(0)
                Me.BaseRemove(ACOMP_PROD_DCORTE)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal aCOMP_PROD_DCORTE As S5TUam.ACOMP_PROD_DCORTE) As Boolean Implements System.Collections.Generic.ICollection(Of S5TUam.ACOMP_PROD_DCORTE).Remove
            Return Me.BaseRemove(aCOMP_PROD_DCORTE)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal aCOMP_PROD_DCORTE As S5TUam.ACOMP_PROD_DCORTE) As Boolean
            If (aCOMP_PROD_DCORTE Is Nothing) Then
                Throw New System.ArgumentNullException("aCOMP_PROD_DCORTE")
            End If
            Dim index As Integer = Me.IndexOf(aCOMP_PROD_DCORTE)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5TUam.ACOMP_PROD_DCORTE).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(aCOMP_PROD_DCORTE)
            RemoveHandler aCOMP_PROD_DCORTE.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(aCOMP_PROD_DCORTE.pId)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, aCOMP_PROD_DCORTE, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of S5TUam.ACOMP_PROD_DCORTE).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5TUam.ACOMP_PROD_DCORTE).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim aCOMP_PROD_DCORTE As S5TUam.ACOMP_PROD_DCORTE = Me.BaseList(index)
            If (Not (aCOMP_PROD_DCORTE) Is Nothing) Then
                RemoveHandler aCOMP_PROD_DCORTE.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(aCOMP_PROD_DCORTE.pId)
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of S5TUam.ACOMP_PROD_DCORTE) Implements System.Collections.Generic.IEnumerable(Of S5TUam.ACOMP_PROD_DCORTE).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of S5TUam.ACOMP_PROD_DCORTE) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As Long) As S5TUam.ACOMP_PROD_DCORTE
            Dim aCOMP_PROD_DCORTE As S5TUam.ACOMP_PROD_DCORTE = Nothing
            If (Me.BaseTable.TryGetValue(key, aCOMP_PROD_DCORTE) = true) Then
                Return aCOMP_PROD_DCORTE
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim aCOMP_PROD_DCORTE As S5TUam.ACOMP_PROD_DCORTE = Me(index)
                aCOMP_PROD_DCORTE.Save
                If (aCOMP_PROD_DCORTE.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(aCOMP_PROD_DCORTE)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    ...
                    CType(aCOMP_PROD_DCORTE,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(aCOMP_PROD_DCORTE) = false) Then
                        Me.BaseAdd(aCOMP_PROD_DCORTE)
                        count = (count + 1)
                    End If
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As S5TUam.ACOMP_PROD_DCORTECollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As S5TUam.ACOMP_PROD_DCORTECollection = New S5TUam.ACOMP_PROD_DCORTECollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5TUam.ACOMP_PROD_DCORTECollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As S5TUam.ACOMP_PROD_DCORTECollection
            Dim ret As S5TUam.ACOMP_PROD_DCORTECollection = S5TUam.ACOMP_PROD_DCORTECollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "ACOMP_PROD_DCORTE", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5TUam.ACOMP_PROD_DCORTECollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As S5TUam.ACOMP_PROD_DCORTECollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(S5TUam.ACOMP_PROD_DCORTE)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of S5TUam.ACOMP_PROD_DCORTE) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,S5TUam.ACOMP_PROD_DCORTE))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As S5TUam.ACOMP_PROD_DCORTECollection
            Dim ret As S5TUam.ACOMP_PROD_DCORTECollection = New S5TUam.ACOMP_PROD_DCORTECollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm2472220608.AddIndex([property])
        End Sub
        ...
        Private Function AddNew() As Object Implements System.ComponentModel.IBindingList.AddNew
            Dim add As S5TUam.ACOMP_PROD_DCORTE = New S5TUam.ACOMP_PROD_DCORTE()
            Dim e As System.ComponentModel.AddingNewEventArgs = New System.ComponentModel.AddingNewEventArgs(add)
            Me.OnAddingNew(e)
            add = CType(e.NewObject,S5TUam.ACOMP_PROD_DCORTE)
            If (add Is Nothing) Then
                add = New S5TUam.ACOMP_PROD_DCORTE()
            End If
            add.pId = 0
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm2472220608.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm2472220608.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of S5TUam.ACOMP_PROD_DCORTE))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of Long))
            If (e Is Nothing) Then
                Throw New System.ArgumentNullException("e")
            End If
            Dim existing As S5TUam.ACOMP_PROD_DCORTE = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5TUam.ACOMP_PROD_DCORTECollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5TUam.ACOMP_PROD_DCORTECollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As S5TUam.ACOMP_PROD_DCORTECollection
            Return S5TUam.ACOMP_PROD_DCORTECollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal aCOMP_PROD_DCORTE As S5TUam.ACOMP_PROD_DCORTE) As Boolean
            If (aCOMP_PROD_DCORTE Is Nothing) Then
                Return false
            End If
        ...
        Public Overloads Shared Function Insert(ByVal aCOMP_PROD_DCORTE As S5TUam.ACOMP_PROD_DCORTE) As Boolean
            Dim ret As Boolean = S5TUam.ACOMP_PROD_DCORTE.Save(aCOMP_PROD_DCORTE)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal aCOMP_PROD_DCORTE As S5TUam.ACOMP_PROD_DCORTE) As Boolean
            If (aCOMP_PROD_DCORTE Is Nothing) Then
                Return false
            End If
