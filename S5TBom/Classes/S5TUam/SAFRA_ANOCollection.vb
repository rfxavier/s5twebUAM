...
Namespace S5TUam
    ...
    Partial Public Class SAFRA_ANOCollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of S5TUam.SAFRA_ANO), System.Collections.Generic.ICollection(Of S5TUam.SAFRA_ANO), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of S5TUam.SAFRA_ANO) = New System.Collections.Generic.List(Of S5TUam.SAFRA_ANO)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of Long, S5TUam.SAFRA_ANO) = New System.Collections.Generic.Dictionary(Of Long, S5TUam.SAFRA_ANO)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _blm3211644336 As CodeFluent.Runtime.Utilities.BindingListManager(Of S5TUam.SAFRA_ANO)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm3211644336 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5TUam.SAFRA_ANO)(Me)
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of S5TUam.SAFRA_ANO)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of Long, S5TUam.SAFRA_ANO)
            Get
        ...
        Public Overloads Default Property Item(ByVal index As Integer) As S5TUam.SAFRA_ANO Implements System.Collections.Generic.IList(Of S5TUam.SAFRA_ANO).Item
            Get
                Return CType(Me.BaseList(index),S5TUam.SAFRA_ANO)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,S5TUam.SAFRA_ANO)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal pId As Long) As S5TUam.SAFRA_ANO
            Get
                If (pId = -1) Then
                    Throw New System.ArgumentNullException("pId")
                End If
                Dim i As S5TUam.SAFRA_ANO = Me.TryGetValue(pId)
                Return i
            End Get
            Set
                If (pId = -1) Then
                ...
                If (value Is Nothing) Then
                    Dim sAFRA_ANO As S5TUam.SAFRA_ANO = Me.TryGetValue(pId)
                    If (Not (sAFRA_ANO) Is Nothing) Then
                        Me.Remove(sAFRA_ANO)
                    End If
                    Return
                End If
                Dim existing As S5TUam.SAFRA_ANO = Me.TryGetValue(value.pId)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of S5TUam.SAFRA_ANO).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of S5TUam.SAFRA_ANO).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm3211644336.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm3211644336.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As S5TUam.SAFRA_ANO, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal sAFRA_ANO As S5TUam.SAFRA_ANO) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(sAFRA_ANO)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal sAFRA_ANO As S5TUam.SAFRA_ANO) As Integer
            If (sAFRA_ANO Is Nothing) Then
                Throw New System.ArgumentNullException("sAFRA_ANO")
            End If
            If (sAFRA_ANO.pId = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "pId", "sAFRA_ANO", "S5TUam.SAFRA_ANO")
            End If
            Try 
                Me.BaseTable.Add(sAFRA_ANO.pId, sAFRA_ANO)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5TUam.SAFRA_ANOCollection", sAFRA_ANO.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5TUam.SAFRA_ANOCollection", sAFRA_ANO.pId), ae)
            End Try
            AddHandler sAFRA_ANO.KeyChanged, AddressOf Me.OnItemKeyChanged
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(sAFRA_ANO)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, sAFRA_ANO, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            Dim sAFRA_ANO As S5TUam.SAFRA_ANO = Nothing
            Try 
                sAFRA_ANO = CType(value,S5TUam.SAFRA_ANO)
            ...
            If (sAFRA_ANO Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(sAFRA_ANO)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_S5TUam_SAFRA_ANO__Add(ByVal sAFRA_ANO As S5TUam.SAFRA_ANO) Implements System.Collections.Generic.ICollection(Of S5TUam.SAFRA_ANO).Add
            Me.BaseAdd(sAFRA_ANO)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As S5TUam.SAFRA_ANO
            Dim sAFRA_ANO As S5TUam.SAFRA_ANO = S5TUam.SAFRA_ANO.LoadByEntityKey(key)
            If ((Not (sAFRA_ANO) Is Nothing)  _
                        AndAlso (Me.Contains(sAFRA_ANO) = false)) Then
                Me.Add(sAFRA_ANO)
            End If
            Return sAFRA_ANO
        End Function
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of S5TUam.SAFRA_ANO))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As S5TUam.SAFRA_ANO, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of S5TUam.SAFRA_ANO).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As S5TUam.SAFRA_ANO, ByVal index As Integer)
        ...
        Public Function Contains(ByVal sAFRA_ANO As S5TUam.SAFRA_ANO) As Boolean Implements System.Collections.Generic.ICollection(Of S5TUam.SAFRA_ANO).Contains
            Dim localContains As Boolean = Me.BaseContains(sAFRA_ANO)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal sAFRA_ANO As S5TUam.SAFRA_ANO) As Boolean
            If (sAFRA_ANO Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(sAFRA_ANO.pId)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            Dim sAFRA_ANO As S5TUam.SAFRA_ANO
            Try 
                sAFRA_ANO = CType(value,S5TUam.SAFRA_ANO)
            Catch icex As System.InvalidCastException
                sAFRA_ANO = Nothing
            End Try
            Return Me.Contains(sAFRA_ANO)
        End Function
        
        Public Function IndexOf(ByVal sAFRA_ANO As S5TUam.SAFRA_ANO) As Integer Implements System.Collections.Generic.IList(Of S5TUam.SAFRA_ANO).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(sAFRA_ANO)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal sAFRA_ANO As S5TUam.SAFRA_ANO) As Integer
            If (sAFRA_ANO Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(sAFRA_ANO)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                sAFRA_ANO = Nothing
            End Try
            Return Me.IndexOf(sAFRA_ANO)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal sAFRA_ANO As S5TUam.SAFRA_ANO) Implements System.Collections.Generic.IList(Of S5TUam.SAFRA_ANO).Insert
            Me.BaseInsert(index, sAFRA_ANO)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal sAFRA_ANO As S5TUam.SAFRA_ANO)
            If (sAFRA_ANO Is Nothing) Then
                Throw New System.ArgumentNullException("sAFRA_ANO")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5TUam.SAFRA_ANOCollection", sAFRA_ANO.pId), ae)
            End Try
            Me.BaseList.Insert(index, sAFRA_ANO)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, sAFRA_ANO, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                sAFRA_ANO = Nothing
            End Try
            Me.Insert(index, sAFRA_ANO)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of S5TUam.SAFRA_ANO).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim SAFRA_ANO As S5TUam.SAFRA_ANO = Me(0)
                Me.BaseRemove(SAFRA_ANO)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal sAFRA_ANO As S5TUam.SAFRA_ANO) As Boolean Implements System.Collections.Generic.ICollection(Of S5TUam.SAFRA_ANO).Remove
            Return Me.BaseRemove(sAFRA_ANO)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal sAFRA_ANO As S5TUam.SAFRA_ANO) As Boolean
            If (sAFRA_ANO Is Nothing) Then
                Throw New System.ArgumentNullException("sAFRA_ANO")
            End If
            Dim index As Integer = Me.IndexOf(sAFRA_ANO)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5TUam.SAFRA_ANO).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(sAFRA_ANO)
            RemoveHandler sAFRA_ANO.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(sAFRA_ANO.pId)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, sAFRA_ANO, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of S5TUam.SAFRA_ANO).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5TUam.SAFRA_ANO).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim sAFRA_ANO As S5TUam.SAFRA_ANO = Me.BaseList(index)
            If (Not (sAFRA_ANO) Is Nothing) Then
                RemoveHandler sAFRA_ANO.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(sAFRA_ANO.pId)
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of S5TUam.SAFRA_ANO) Implements System.Collections.Generic.IEnumerable(Of S5TUam.SAFRA_ANO).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of S5TUam.SAFRA_ANO) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As Long) As S5TUam.SAFRA_ANO
            Dim sAFRA_ANO As S5TUam.SAFRA_ANO = Nothing
            If (Me.BaseTable.TryGetValue(key, sAFRA_ANO) = true) Then
                Return sAFRA_ANO
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim sAFRA_ANO As S5TUam.SAFRA_ANO = Me(index)
                sAFRA_ANO.Save
                If (sAFRA_ANO.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(sAFRA_ANO)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    Dim sAFRA_ANO As S5TUam.SAFRA_ANO = New S5TUam.SAFRA_ANO()
                    CType(sAFRA_ANO,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(sAFRA_ANO) = false) Then
                        Me.BaseAdd(sAFRA_ANO)
                        count = (count + 1)
                    End If
                    sAFRA_ANO.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Unchanged
                End If
                readerRead = reader.Read
            Loop
        End Sub
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As S5TUam.SAFRA_ANOCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As S5TUam.SAFRA_ANOCollection = New S5TUam.SAFRA_ANOCollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5TUam.SAFRA_ANOCollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As S5TUam.SAFRA_ANOCollection
            Dim ret As S5TUam.SAFRA_ANOCollection = S5TUam.SAFRA_ANOCollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "SAFRA_ANO", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5TUam.SAFRA_ANOCollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As S5TUam.SAFRA_ANOCollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(S5TUam.SAFRA_ANO)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of S5TUam.SAFRA_ANO) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,S5TUam.SAFRA_ANO))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As S5TUam.SAFRA_ANOCollection
            Dim ret As S5TUam.SAFRA_ANOCollection = New S5TUam.SAFRA_ANOCollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm3211644336.AddIndex([property])
        End Sub
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm3211644336.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm3211644336.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of S5TUam.SAFRA_ANO))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of Long))
            If (e Is Nothing) Then
                Throw New System.ArgumentNullException("e")
            End If
            Dim existing As S5TUam.SAFRA_ANO = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5TUam.SAFRA_ANOCollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5TUam.SAFRA_ANOCollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As S5TUam.SAFRA_ANOCollection
            Return S5TUam.SAFRA_ANOCollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal sAFRA_ANO As S5TUam.SAFRA_ANO) As Boolean
            If (sAFRA_ANO Is Nothing) Then
                Return false
            End If
            Dim ret As Boolean = sAFRA_ANO.Save
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Shared Function Insert(ByVal sAFRA_ANO As S5TUam.SAFRA_ANO) As Boolean
            Dim ret As Boolean = S5TUam.SAFRA_ANO.Save(sAFRA_ANO)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal sAFRA_ANO As S5TUam.SAFRA_ANO) As Boolean
            If (sAFRA_ANO Is Nothing) Then
                Return false
            End If
            Dim ret As Boolean = sAFRA_ANO.Delete
            Return ret
        End Function
    End Class
End Namespace
