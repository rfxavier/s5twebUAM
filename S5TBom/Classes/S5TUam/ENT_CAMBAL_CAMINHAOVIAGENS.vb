...
Namespace S5TUam
    ...
    Partial Public Class ENT_CAMBAL_CAMINHAOVIAGENS
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS)
        ...
        Private _cOD_PROP As Integer = CodeFluentPersistence.DefaultInt32Value
        
        Private _cAMINHAO As Integer = CodeFluentPersistence.DefaultInt32Value
        ...
        Public Property COD_PROP() As Integer
            ...
            Set
                Me._cOD_PROP = value
                Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Modified
                Me.OnPropertyChanged(New System.ComponentModel.PropertyChangedEventArgs("COD_PROP"))
            End Set
        End Property
        
        <System.ComponentModel.DefaultValueAttribute(CodeFluentPersistence.DefaultInt32Value),  _
         System.Xml.Serialization.XmlElementAttribute(IsNullable:=false, Type:=GetType(Integer))>  _
        Public Property CAMINHAO() As Integer
            Get
                Return Me._cAMINHAO
            End Get
            Set
                Me._cAMINHAO = value
                Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Modified
                Me.OnPropertyChanged(New System.ComponentModel.PropertyChangedEventArgs("CAMINHAO"))
            End Set
        End Property
        ...
        Public Overloads Overridable Function Equals(ByVal eNT_CAMBAL_CAMINHAOVIAGENS As S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS) As Boolean Implements System.IEquatable(Of S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS).Equals
            If (eNT_CAMBAL_CAMINHAOVIAGENS Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(eNT_CAMBAL_CAMINHAOVIAGENS)
            End If
            Return (Me.pId.Equals(eNT_CAMBAL_CAMINHAOVIAGENS.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                eNT_CAMBAL_CAMINHAOVIAGENS = CType(obj,S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS)
            Catch icex As System.InvalidCastException
                eNT_CAMBAL_CAMINHAOVIAGENS = Nothing
            End Try
            Return Me.Equals(eNT_CAMBAL_CAMINHAOVIAGENS)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(eNT_CAMBAL_CAMINHAOVIAGENS)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal eNT_CAMBAL_CAMINHAOVIAGENS As S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS) As Integer Implements System.IComparable(Of S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS).CompareTo
            If (eNT_CAMBAL_CAMINHAOVIAGENS Is Nothing) Then
                Throw New System.ArgumentNullException("eNT_CAMBAL_CAMINHAOVIAGENS")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(eNT_CAMBAL_CAMINHAOVIAGENS.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS.ExternalValidate", "Type 'S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "ENT_CAMBAL_CAMINHAOVIAGENS", "Delete")
        ...
        Protected Overridable Sub ReadRecord(ByVal reader As System.Data.IDataReader, ByVal options As CodeFluent.Runtime.CodeFluentReloadOptions)
            ...
            If (((options And CodeFluent.Runtime.CodeFluentReloadOptions.Properties)  _
                ...
                Me._cOD_PROP = CodeFluentPersistence.GetReaderValue(reader, "COD_PROP", CType(CodeFluentPersistence.DefaultInt32Value,Integer))
                Me._cAMINHAO = CodeFluentPersistence.GetReaderValue(reader, "CAMINHAO", CType(CodeFluentPersistence.DefaultInt32Value,Integer))
        ...
        Public Shared Function Load(ByVal pId As Long) As S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS
            If (pId = -1) Then
                Return Nothing
            End If
            Dim eNT_CAMBAL_CAMINHAOVIAGENS As S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS = New S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "ENT_CAMBAL_CAMINHAOVIAGENS", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    eNT_CAMBAL_CAMINHAOVIAGENS.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS
            If (pId = -1) Then
                Return Nothing
            End If
            Dim eNT_CAMBAL_CAMINHAOVIAGENS As S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS = New S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "ENT_CAMBAL_CAMINHAOVIAGENS", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "ENT_CAMBAL_CAMINHAOVIAGENS", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
            ...
            persistence.AddParameter("@COD_PROP", Me.COD_PROP, CodeFluentPersistence.DefaultInt32Value)
            persistence.AddParameter("@CAMINHAO", Me.CAMINHAO, CodeFluentPersistence.DefaultInt32Value)
        ...
        Public Overloads Shared Function Save(ByVal eNT_CAMBAL_CAMINHAOVIAGENS As S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS) As Boolean
            If (eNT_CAMBAL_CAMINHAOVIAGENS Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal eNT_CAMBAL_CAMINHAOVIAGENS As S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS) As Boolean
            Dim ret As Boolean = S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS.Save(eNT_CAMBAL_CAMINHAOVIAGENS)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal eNT_CAMBAL_CAMINHAOVIAGENS As S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS) As Boolean
            If (eNT_CAMBAL_CAMINHAOVIAGENS Is Nothing) Then
                Return false
            End If
        ...
        Protected Overridable Sub BaseTrace(ByVal writer As System.CodeDom.Compiler.IndentedTextWriter)
            ...
            writer.Write(",")
            writer.Write("COD_PROP=")
            writer.Write(Me.COD_PROP)
            writer.Write(",")
            writer.Write("CAMINHAO=")
            writer.Write(Me.CAMINHAO)
            writer.Write(",")
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS
            ...
            eNT_CAMBAL_CAMINHAOVIAGENS = S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS.Load(var)
            Return eNT_CAMBAL_CAMINHAOVIAGENS
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS
            Dim eNT_CAMBAL_CAMINHAOVIAGENS As S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS = New S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS()
            Me.CopyTo(eNT_CAMBAL_CAMINHAOVIAGENS, deep)
            Return eNT_CAMBAL_CAMINHAOVIAGENS
        End Function
        
        Public Overloads Function Clone() As S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS
            Dim localClone As S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overridable Sub CopyFrom(ByVal dict As System.Collections.IDictionary, ByVal deep As Boolean)
            ...
            End If
            If (dict.Contains("CAMINHAO") = true) Then
                Me.CAMINHAO = CType(ConvertUtilities.ChangeType(dict("CAMINHAO"), GetType(Integer), CodeFluentPersistence.DefaultInt32Value),Integer)
            End If
            ...
            End If
            If (dict.Contains("COD_PROP") = true) Then
                Me.COD_PROP = CType(ConvertUtilities.ChangeType(dict("COD_PROP"), GetType(Integer), CodeFluentPersistence.DefaultInt32Value),Integer)
            End If
        ...
        Public Overloads Overridable Sub CopyTo(ByVal eNT_CAMBAL_CAMINHAOVIAGENS As S5TUam.ENT_CAMBAL_CAMINHAOVIAGENS, ByVal deep As Boolean)
            If (eNT_CAMBAL_CAMINHAOVIAGENS Is Nothing) Then
                Throw New System.ArgumentNullException("eNT_CAMBAL_CAMINHAOVIAGENS")
            End If
            eNT_CAMBAL_CAMINHAOVIAGENS.pId = Me.pId
            eNT_CAMBAL_CAMINHAOVIAGENS.CAMINHAO = Me.CAMINHAO
            eNT_CAMBAL_CAMINHAOVIAGENS.QTD_VIAGENS = Me.QTD_VIAGENS
            eNT_CAMBAL_CAMINHAOVIAGENS.COD_PROP = Me.COD_PROP
            eNT_CAMBAL_CAMINHAOVIAGENS.ROWNUM = Me.ROWNUM
            eNT_CAMBAL_CAMINHAOVIAGENS.FRENTE = Me.FRENTE
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, eNT_CAMBAL_CAMINHAOVIAGENS))
        End Sub
        ...
        Public Overloads Overridable Sub CopyTo(ByVal dict As System.Collections.IDictionary, ByVal deep As Boolean)
            ...
            End If
            dict("pId") = Me.pId
            dict("CAMINHAO") = Me.CAMINHAO
            dict("QTD_VIAGENS") = Me.QTD_VIAGENS
            dict("COD_PROP") = Me.COD_PROP
