...
Namespace S5TUam
    ...
    Partial Public Class RES_MENSAL_SAFRA_ACUMULADA
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5TUam.RES_MENSAL_SAFRA_ACUMULADA), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5TUam.RES_MENSAL_SAFRA_ACUMULADA)
        ...
        Private _tONELADA_PLAN_AC As Double = CodeFluentPersistence.DefaultDoubleValue
        
        Private _tONELADA_REAL As Double = CodeFluentPersistence.DefaultDoubleValue
        
        Private _tONELADA_REAL_AC As Double = CodeFluentPersistence.DefaultDoubleValue
        ...
        <System.ComponentModel.DefaultValueAttribute(CodeFluentPersistence.DefaultDoubleValue),  _
         System.Xml.Serialization.XmlElementAttribute(IsNullable:=false, Type:=GetType(Double))>  _
        Public Property TONELADA_PLAN_AC() As Double
            Get
                Return Me._tONELADA_PLAN_AC
            End Get
            Set
                Me._tONELADA_PLAN_AC = value
                Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Modified
                Me.OnPropertyChanged(New System.ComponentModel.PropertyChangedEventArgs("TONELADA_PLAN_AC"))
            End Set
        End Property
        ...
        <System.ComponentModel.DefaultValueAttribute(CodeFluentPersistence.DefaultDoubleValue),  _
         System.Xml.Serialization.XmlElementAttribute(IsNullable:=false, Type:=GetType(Double))>  _
        Public Property TONELADA_REAL_AC() As Double
            Get
                Return Me._tONELADA_REAL_AC
            End Get
            Set
                Me._tONELADA_REAL_AC = value
                Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Modified
                Me.OnPropertyChanged(New System.ComponentModel.PropertyChangedEventArgs("TONELADA_REAL_AC"))
            End Set
        End Property
        ...
        Public Overloads Overridable Function Equals(ByVal rES_MENSAL_SAFRA_ACUMULADA As S5TUam.RES_MENSAL_SAFRA_ACUMULADA) As Boolean Implements System.IEquatable(Of S5TUam.RES_MENSAL_SAFRA_ACUMULADA).Equals
            If (rES_MENSAL_SAFRA_ACUMULADA Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(rES_MENSAL_SAFRA_ACUMULADA)
            End If
            Return (Me.pId.Equals(rES_MENSAL_SAFRA_ACUMULADA.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                rES_MENSAL_SAFRA_ACUMULADA = CType(obj,S5TUam.RES_MENSAL_SAFRA_ACUMULADA)
            Catch icex As System.InvalidCastException
                rES_MENSAL_SAFRA_ACUMULADA = Nothing
            End Try
            Return Me.Equals(rES_MENSAL_SAFRA_ACUMULADA)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(rES_MENSAL_SAFRA_ACUMULADA)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal rES_MENSAL_SAFRA_ACUMULADA As S5TUam.RES_MENSAL_SAFRA_ACUMULADA) As Integer Implements System.IComparable(Of S5TUam.RES_MENSAL_SAFRA_ACUMULADA).CompareTo
            If (rES_MENSAL_SAFRA_ACUMULADA Is Nothing) Then
                Throw New System.ArgumentNullException("rES_MENSAL_SAFRA_ACUMULADA")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(rES_MENSAL_SAFRA_ACUMULADA.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5TUam.RES_MENSAL_SAFRA_ACUMULADA.ExternalValidate", "Type 'S5TUam.RES_MENSAL_SAFRA_ACUMULADA' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "RES_MENSAL_SAFRA_ACUMULADA", "Delete")
        ...
        Protected Overridable Sub ReadRecord(ByVal reader As System.Data.IDataReader, ByVal options As CodeFluent.Runtime.CodeFluentReloadOptions)
            ...
            If (((options And CodeFluent.Runtime.CodeFluentReloadOptions.Properties)  _
                ...
                Me._tONELADA_PLAN_AC = CodeFluentPersistence.GetReaderValue(reader, "TONELADA_PLAN_AC", CType(CodeFluentPersistence.DefaultDoubleValue,Double))
                ...
                Me._tONELADA_REAL_AC = CodeFluentPersistence.GetReaderValue(reader, "TONELADA_REAL_AC", CType(CodeFluentPersistence.DefaultDoubleValue,Double))
            End If
        ...
        Public Shared Function Load(ByVal pId As Long) As S5TUam.RES_MENSAL_SAFRA_ACUMULADA
            If (pId = -1) Then
                Return Nothing
            End If
            Dim rES_MENSAL_SAFRA_ACUMULADA As S5TUam.RES_MENSAL_SAFRA_ACUMULADA = New S5TUam.RES_MENSAL_SAFRA_ACUMULADA()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "RES_MENSAL_SAFRA_ACUMULADA", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    rES_MENSAL_SAFRA_ACUMULADA.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5TUam.RES_MENSAL_SAFRA_ACUMULADA
            If (pId = -1) Then
                Return Nothing
            End If
            Dim rES_MENSAL_SAFRA_ACUMULADA As S5TUam.RES_MENSAL_SAFRA_ACUMULADA = New S5TUam.RES_MENSAL_SAFRA_ACUMULADA()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "RES_MENSAL_SAFRA_ACUMULADA", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5TUam.RES_MENSAL_SAFRA_ACUMULADA.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "RES_MENSAL_SAFRA_ACUMULADA", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
            ...
            persistence.AddParameter("@TONELADA_PLAN_AC", Me.TONELADA_PLAN_AC, CodeFluentPersistence.DefaultDoubleValue)
            persistence.AddParameter("@TONELADA_REAL", Me.TONELADA_REAL, CodeFluentPersistence.DefaultDoubleValue)
            persistence.AddParameter("@TONELADA_REAL_AC", Me.TONELADA_REAL_AC, CodeFluentPersistence.DefaultDoubleValue)
        ...
        Public Overloads Shared Function Save(ByVal rES_MENSAL_SAFRA_ACUMULADA As S5TUam.RES_MENSAL_SAFRA_ACUMULADA) As Boolean
            If (rES_MENSAL_SAFRA_ACUMULADA Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal rES_MENSAL_SAFRA_ACUMULADA As S5TUam.RES_MENSAL_SAFRA_ACUMULADA) As Boolean
            Dim ret As Boolean = S5TUam.RES_MENSAL_SAFRA_ACUMULADA.Save(rES_MENSAL_SAFRA_ACUMULADA)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal rES_MENSAL_SAFRA_ACUMULADA As S5TUam.RES_MENSAL_SAFRA_ACUMULADA) As Boolean
            If (rES_MENSAL_SAFRA_ACUMULADA Is Nothing) Then
                Return false
            End If
        ...
        Protected Overridable Sub BaseTrace(ByVal writer As System.CodeDom.Compiler.IndentedTextWriter)
            ...
            writer.Write(",")
            writer.Write("TONELADA_PLAN_AC=")
            writer.Write(Me.TONELADA_PLAN_AC)
            writer.Write(",")
            writer.Write("TONELADA_REAL=")
            writer.Write(Me.TONELADA_REAL)
            writer.Write(",")
            writer.Write("TONELADA_REAL_AC=")
            writer.Write(Me.TONELADA_REAL_AC)
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5TUam.RES_MENSAL_SAFRA_ACUMULADA
            ...
            rES_MENSAL_SAFRA_ACUMULADA = S5TUam.RES_MENSAL_SAFRA_ACUMULADA.Load(var)
            Return rES_MENSAL_SAFRA_ACUMULADA
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5TUam.RES_MENSAL_SAFRA_ACUMULADA
            Dim rES_MENSAL_SAFRA_ACUMULADA As S5TUam.RES_MENSAL_SAFRA_ACUMULADA = New S5TUam.RES_MENSAL_SAFRA_ACUMULADA()
            Me.CopyTo(rES_MENSAL_SAFRA_ACUMULADA, deep)
            Return rES_MENSAL_SAFRA_ACUMULADA
        End Function
        
        Public Overloads Function Clone() As S5TUam.RES_MENSAL_SAFRA_ACUMULADA
            Dim localClone As S5TUam.RES_MENSAL_SAFRA_ACUMULADA = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overridable Sub CopyFrom(ByVal dict As System.Collections.IDictionary, ByVal deep As Boolean)
            ...
            End If
            If (dict.Contains("TONELADA_PLAN_AC") = true) Then
                Me.TONELADA_PLAN_AC = CType(ConvertUtilities.ChangeType(dict("TONELADA_PLAN_AC"), GetType(Double), CodeFluentPersistence.DefaultDoubleValue),Double)
            End If
            ...
            End If
            If (dict.Contains("TONELADA_REAL_AC") = true) Then
                Me.TONELADA_REAL_AC = CType(ConvertUtilities.ChangeType(dict("TONELADA_REAL_AC"), GetType(Double), CodeFluentPersistence.DefaultDoubleValue),Double)
            End If
        ...
        Public Overloads Overridable Sub CopyTo(ByVal rES_MENSAL_SAFRA_ACUMULADA As S5TUam.RES_MENSAL_SAFRA_ACUMULADA, ByVal deep As Boolean)
            If (rES_MENSAL_SAFRA_ACUMULADA Is Nothing) Then
                Throw New System.ArgumentNullException("rES_MENSAL_SAFRA_ACUMULADA")
            End If
            rES_MENSAL_SAFRA_ACUMULADA.pId = Me.pId
            rES_MENSAL_SAFRA_ACUMULADA.TONELADA_PLAN_AC = Me.TONELADA_PLAN_AC
            rES_MENSAL_SAFRA_ACUMULADA.TONELADA_PLAN = Me.TONELADA_PLAN
            rES_MENSAL_SAFRA_ACUMULADA.TONELADA_REAL_AC = Me.TONELADA_REAL_AC
            rES_MENSAL_SAFRA_ACUMULADA.TONELADA_REAL = Me.TONELADA_REAL
            rES_MENSAL_SAFRA_ACUMULADA.NRO_ANO_SAFRA = Me.NRO_ANO_SAFRA
            rES_MENSAL_SAFRA_ACUMULADA.ID_NEGOCIOS = Me.ID_NEGOCIOS
            rES_MENSAL_SAFRA_ACUMULADA.DIA = Me.DIA
            rES_MENSAL_SAFRA_ACUMULADA.MES = Me.MES
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, rES_MENSAL_SAFRA_ACUMULADA))
        End Sub
        ...
        Public Overloads Overridable Sub CopyTo(ByVal dict As System.Collections.IDictionary, ByVal deep As Boolean)
            ...
            End If
            dict("pId") = Me.pId
            dict("TONELADA_PLAN_AC") = Me.TONELADA_PLAN_AC
            dict("TONELADA_PLAN") = Me.TONELADA_PLAN
            dict("TONELADA_REAL_AC") = Me.TONELADA_REAL_AC
